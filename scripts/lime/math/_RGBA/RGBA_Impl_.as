package lime.math._RGBA
{
   ...
   public final class RGBA_Impl_
   {
      ...
      public static var __alpha16:ArrayBufferView = new ArrayBufferView(256,7);
      
      public static var __clamp:ArrayBufferView = new ArrayBufferView(511,4);
      ...
      public static function multiplyAlpha(param1:int) : void
      {
         ...
         else if((param1 & 0xFF) != 255)
         {
            ...
            RGBA_Impl_.a16 = _loc5_ | _loc6_ << 8 | _loc7_ << 16 | _loc8_ << 24;
      ...
      public static function writeUInt8(param1:int, param2:ArrayBufferView, param3:int, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         if(param5)
         {
            ...
            else if((param1 & 0xFF) != 255)
            {
               ...
               RGBA_Impl_.a16 = _loc9_ | _loc10_ << 8 | _loc11_ << 16 | _loc12_ << 24;
               param1 = ((param1 >> 24 & 0xFF) * RGBA_Impl_.a16 >> 16 & 0xFF) << 24 | ((param1 >> 16 & 0xFF) * RGBA_Impl_.a16 >> 16 & 0xFF) << 16 | ((param1 >> 8 & 0xFF) * RGBA_Impl_.a16 >> 16 & 0xFF) << 8 | param1 & 0xFF & 0xFF;
            }
         }
         switch(param4)
...
while(_loc6_ < 256)
{
   ...
   uint(int(Math.ceil(_loc7_ * 257.00392156862745)));
   int(_loc8_.byteOffset + _loc7_ * 4);
   _loc8_.buffer;
   _loc11_.b[_loc10_] = _loc9_;
   _loc11_.b[_loc10_ + 1] = uint(_loc9_ >> 8);
   _loc11_.b[_loc10_ + 2] = uint(_loc9_ >> 16);
   _loc11_.b[_loc10_ + 3] = uint(_loc9_ >>> 24);
}
null;
null;
null;
...
while(_loc6_ < 255)
{
   _loc6_++;
   RGBA_Impl_.__clamp;
   _loc15_.buffer.b[_loc15_.byteOffset + _loc7_] = _loc7_;
}
255;
511;
while(_loc6_ < _loc7_)
{
   _loc6_++;
   RGBA_Impl_.__clamp;
   _loc15_.buffer.b[_loc15_.byteOffset + _loc10_] = 255;
}
