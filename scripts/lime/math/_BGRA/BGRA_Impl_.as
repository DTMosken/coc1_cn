   ...
   public final class BGRA_Impl_
   {
      ...
      public static function multiplyAlpha(param1:int) : void
      {
         ...
         else if((param1 & 0xFF) != 255)
         {
            ...
            BGRA_Impl_.a16 = _loc5_ | _loc6_ << 8 | _loc7_ << 16 | _loc8_ << 24;
            param1 = ((param1 >> 24 & 0xFF) * BGRA_Impl_.a16 >> 16 & 0xFF) << 24 | ((param1 >> 16 & 0xFF) * BGRA_Impl_.a16 >> 16 & 0xFF) << 16 | ((param1 >> 8 & 0xFF) * BGRA_Impl_.a16 >> 16 & 0xFF) << 8 | param1 & 0xFF & 0xFF;
         }
      }
      ...
      public static function readUInt8(param1:int, param2:ArrayBufferView, param3:int, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         switch(param4)
         {
            case 0:
               ...
               break;
            case 1:
               param1 = (int(int(param2.buffer.b[param2.byteOffset + (param3 + 3)])) & 0xFF) << 24 | (int(int(param2.buffer.b[param2.byteOffset + (param3 + 2)])) & 0xFF) << 16 | (int(int(param2.buffer.b[param2.byteOffset + (param3 + 1)])) & 0xFF) << 8 | int(int(param2.buffer.b[param2.byteOffset + param3])) & 0xFF;
               break;
            case 2:
         ...
         if(param5)
         {
            ...
            {
               BGRA_Impl_.unmult = 255 / (param1 & 0xFF);
               _loc6_ = RGBA_Impl_.__clamp;
               _loc7_ = RGBA_Impl_.__clamp;
               _loc8_ = RGBA_Impl_.__clamp;
               param1 = (int(int(_loc6_.buffer.b[_loc6_.byteOffset + int(Math.floor((param1 >> 24 & 0xFF) * BGRA_Impl_.unmult))])) & 0xFF) << 24 | (int(int(_loc7_.buffer.b[_loc7_.byteOffset + int(Math.floor((param1 >> 16 & 0xFF) * BGRA_Impl_.unmult))])) & 0xFF) << 16 | (int(int(_loc8_.buffer.b[_loc8_.byteOffset + int(Math.floor((param1 >> 8 & 0xFF) * BGRA_Impl_.unmult))])) & 0xFF) << 8 | param1 & 0xFF & 0xFF;
            }
         }
      }
      ...
      public static function unmultiplyAlpha(param1:int) : void
      {
         ...
         if((param1 & 0xFF) != 0 && (param1 & 0xFF) != 255)
         {
            ...
            param1 = (int(int(_loc2_.buffer.b[_loc2_.byteOffset + int(Math.floor((param1 >> 24 & 0xFF) * BGRA_Impl_.unmult))])) & 0xFF) << 24 | (int(int(_loc3_.buffer.b[_loc3_.byteOffset + int(Math.floor((param1 >> 16 & 0xFF) * BGRA_Impl_.unmult))])) & 0xFF) << 16 | (int(int(_loc4_.buffer.b[_loc4_.byteOffset + int(Math.floor((param1 >> 8 & 0xFF) * BGRA_Impl_.unmult))])) & 0xFF) << 8 | param1 & 0xFF & 0xFF;
         }
      }
      ...
      public static function writeUInt8(param1:int, param2:ArrayBufferView, param3:int, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         if(param5)
         {
            ...
            else if((param1 & 0xFF) != 255)
            {
               ...
               BGRA_Impl_.a16 = _loc9_ | _loc10_ << 8 | _loc11_ << 16 | _loc12_ << 24;
               param1 = ((param1 >> 24 & 0xFF) * BGRA_Impl_.a16 >> 16 & 0xFF) << 24 | ((param1 >> 16 & 0xFF) * BGRA_Impl_.a16 >> 16 & 0xFF) << 16 | ((param1 >> 8 & 0xFF) * BGRA_Impl_.a16 >> 16 & 0xFF) << 8 | param1 & 0xFF & 0xFF;
            }
         }
         switch(param4)
