      ...
      public static function fromBytes(param1:Bytes, param2:Object = undefined, param3:Object = undefined) : ArrayBufferView
      {
         ...
         if(param2 == null)
         {
            ...
            else if(_loc6_ != null)
            {
               ...
               _loc11_.buffer = Bytes.alloc(_loc11_.byteLength);
            ...
            {
               _loc11_ = new ArrayBufferView(0,1);
               _loc12_ = _loc7_.__array;
               _loc11_.byteOffset = 0;
               _loc11_.length = int(_loc12_.length);
               _loc11_.byteLength = _loc11_.length * _loc11_.bytesPerElement;
               _loc11_.buffer = Bytes.alloc(_loc11_.byteLength);
               _loc11_.copyFromArray(_loc12_);
               _loc10_ = _loc11_;
            }
            else if(_loc8_ != null)
            {
               _loc11_ = new ArrayBufferView(0,1);
               _loc13_ = _loc8_.buffer;
               ...
               _loc11_.buffer = Bytes.alloc(_loc19_);
               _loc11_.buffer.blit(0,_loc13_,_loc15_,_loc19_);
         ...
         if(param3 == null)
         {
            ...
            else
            {
               ...
               {
                  _loc17_ = _loc20_ * _loc11_.bytesPerElement;
                  _loc18_ = _loc14_ + _loc17_;
                  if(_loc18_ > _loc15_)
                  {
                     throw Exception.thrown(TAError.RangeError);
