package motion.easing._Elastic
{
   ...
   public class ElasticEaseOut implements IEasing
   {
      ...
      public function ElasticEaseOut(param1:Number = 0, param2:Number = 0)
      {
      ...
      public function ease(param1:Number, param2:Number, param3:Number, param4:Number) : Number
      {
         ...
         return a * Math.exp(-6.931471805599453 * param1) * Math.sin((param1 * param4 - _loc5_) * (2 * Math.PI) / p) + param3 + param2;
      }
      ...
      public function calculate(param1:Number) : Number
      {
         ...
         return a * Math.exp(-6.931471805599453 * param1) * Math.sin((param1 - _loc2_) * (2 * Math.PI) / p) + 1;
      }
   }
}
