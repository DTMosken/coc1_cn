   ...
   public class Lumi extends BaseContent
   {
      ...
      public function lumiLabChoices() : void
      {
         ...
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,53) == 0)
         {
            ...
            outputText("她大约[if (metric) {90厘米|3英尺}]高，有着黄绿色的皮肤，橙色的头发扎成一条长长的马尾辫，一直垂到膝盖。她的乳房大约是B罩杯，普通的乳头被染成了橙色。她所有的指甲也都涂成了橙色以相配。她似乎永远停不下来，虽然她的大部分脸看起来很可爱，但戴着那副厚厚的护目镜实在很难确定。她护目镜上纯黑色的镜片让她看起来相当令人不安，扼杀了她的身形可能激发你的任何吸引力。[pg]");
