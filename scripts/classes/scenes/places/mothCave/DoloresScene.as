package classes.scenes.places.mothCave
{
   ...
   public class DoloresScene extends NPCAwareContent implements TimeAwareInterface, SelfDebug, SelfSaving
   {
      ...
      public function hikkiMenu() : void
      {
         ...
         {
            addButton(1,"玛丽埃尔",hikkiMarielle).hint("你可以去拜访那位亡灵裁缝。").disableIf(!get_game().bog.marielle.marielleAvailable(true),"你觉得现在去不太合适。").disableIf((saveContent.hikkiQuest & HQMARI) > 0,"你已经做过这个了。");
         }
      ...
      public function hikkiMarielleAnswer(param1:int) : void
      {
         ...
         {
            case 0:
               outputText("你轻声建议多洛雷斯谈谈她自己的兴趣——也就是阅读。毕竟，玛丽埃尔看起来像个有教养的年轻女士，她肯定也喜欢书。");
               ...
               outputText("[pg][say:我……]玛丽埃尔似乎有很长一段时间不知道该如何回应，她凝视着年轻的蛾女，直到最后说道：[say:我看得出，你确实是个……读书人。而且非常热忱。]然后她双手交叠，凝视着远方思考。[say:嗯，距离我上次拿起一本值得一提的书，也许已经过了太久了，但我确实对，啊，诗歌有些兴趣。不过我从未完全……被其“迷住”过。]");
               outputText("[pg][say:啊，所以，那些词……它们不是……]多洛雷斯看起来比你想象的要崩溃得多，她的眼神完全空洞了，而玛丽埃尔则在一旁默默担忧地看着。不知过了多久，但令人窒息的气氛似乎没有任何改变。");
               outputText("[pg]看着你那近乎呆滞的女儿，你想知道自己到底哪里做错了。");
               break;
            case 1:
               outputText("你提起了缝纫这个话题——你至少知道玛丽埃尔对这个话题很自在——希望能重新点燃对话。");
               ...
               outputText("[pg][say:哦，嗯，好吧……呃……]玛丽埃尔摆弄着她的许多根手指。[say:那么，你，啊……对制衣了解多少？我必须承认，我并不适合当老师。]");
               ...
               break;
            case 2:
               outputText("当你提起死灵法术的话题时，多洛雷斯的眼睛亮了起来，但玛丽埃尔似乎对这个提议不太高兴。");
               ...
               outputText("[pg][say:没……没关系，我没有被冒犯到，]玛丽埃尔向你的女儿保证，推了推眼镜，然后交叉起她那许多只手。[say:我无论如何也施展不了魔法。去，呃，探究它的深奥对我来说毫无益处。]");
            ...
            case 3:
               ...
               outputText("[pg][say:确实如此。]连玛丽埃尔似乎也意识到了蛾女有多紧张，尽管这种洞察力对她帮助甚微。[say:幸好，我的……体质允许我将它们脱臼。]她张开下面那对手臂，但并没有像你们第二次见面时那样表演那个特技。多洛雷斯的眼睛睁大了一点，看起来确实很感兴趣，但她没有做出任何实质性的回应，于是，对话再次陷入了停滞。");
         ...
         outputText("[pg]然而，就在你快要失去希望的时候，你注意到玛丽埃尔的目光在年轻蛾女的衣服上游移，她发出一声小小的[say:嗯]，脸上浮现出轻微的皱眉。显然是被她在那里发现的什么东西吸引了，她开始慢慢地绕到多洛雷斯身边，检查着布料，而蛾女则尴尬地僵立在原地。");
         ...
         outputText("[pg][say:我-我明白了，那个嗯……]她咽了口唾沫。[say:我完全明白你的意思了，所以……]她似乎不知道该怎么开口提出自己的要求，但玛丽埃尔最终注意到了自己的手放在哪里，脸一红，猛地抽回手，好让她保留一点尊严。");
         outputText("[pg][say:哦！我，啊……抱歉，[if (silly) {我-我不是同性恋|我不是故意的]……]");
         outputText("[pg]一阵短暂的沉默，你有些担心对话又会冷场。然而，多洛雷斯还是克服了尴尬，问道：[say:那么……你能，嗯……帮我改改吗？]");
         outputText("[pg][say:当然！]玛丽埃尔答应得有些太快了，声音都劈叉了。[say:我是说，当然。这不过是举手之劳。我只需要，啊……]");
         ...
         outputText("[pg]你们俩给了她一些私人空间，很快她就换下了旧裙子，把它递给了玛丽埃尔。裁缝已经挑好了合适的线，并测量了你女儿的尺寸，这让她更加尴尬了，然后才开始工作。");
      ...
      {
         clearOutput();
         outputText("没过多久，玛丽埃尔似乎就改好了裙子，把它递回给多洛雷斯，多洛雷斯再次让你们俩转过身去，好让她重新穿上。");
         outputText("[pg][say:怎么样？]你听到亡灵女孩问道，你转过身，看到多洛雷斯正用手撑开裙摆。[say:有什么不妥吗？如果有的话，请告诉我。]");
         outputText("[pg]她一言不发地松开手，快速转了个圈，展示着现在合身的裙子。[say:感觉……太棒了。比以前好多了。]她温柔地低头看着裙子，轻轻抚摸着布料。[say:我从来不知道合适的剪裁能带来这么大的改变。]她抬起头，微笑着说。[say:谢谢你，玛丽埃尔。]");
         outputText("[pg]裁缝微微屈膝行礼，说道：[say:我的荣幸。一切都好吗？很好，很好……]她又仔细打量了一会儿裙子，绕着多洛雷斯走了几步，显然对自己的成果很满意。");
         outputText("[pg][say:嗯，]蛾女开口了，虽然还有些犹豫，但比之前少了几分胆怯，[say:有没有可能，啊……向你订购一件裙子？我以前没怎么关注过我的衣服，但看到这里的这一切，它……]她没有说完，而是用恳求的眼神看着玛丽埃尔。");
         outputText("[pg][say:哦，当然，]玛丽埃尔高兴地[if (silly) {搓着|握着}]双手说道。[say:我制作各种款式的女装，无论是定制的还是现成的，如果你有什么需要，尽管开口。]她停顿了一下。[say:不过，唉，这不会是，啊……免费的。]");
         outputText("[pg]多洛雷斯自信地回答：[say:哦，那不是问题。我母亲给了我一些宝石，我一直没机会用。]她停顿了一下，眨了眨眼。[say:那么，啊，我还能再见到你吗？]她说完，有些慌乱。你意识到这可能是她第一次问这样的问题。");
         outputText("[pg]玛丽埃尔自己也花了一秒钟才回答，她看了看你，眨眼的频率有点太高了。[say:我……如果你愿意的话。你将，啊，非常受欢迎。多洛雷斯。]");
         outputText("[pg][say:太好了。[i:玛丽埃尔]。]她在这里咯咯地笑了起来，知道她们终于合得来了，让你放下了许多担忧。你们三人互相道别，然后你终于带着女儿走出了神庙。");
      ...
      public function hikkiMarielle2() : void
      {
         ...
         var _g:DoloresScene;
         clearOutput();
         outputText("你到达了神庙的内部，看到玛丽埃尔坐在她的桌子前，弓着身子看着铺在桌面上的一件衣服，显然没有注意到你们的进入，因为她正在一丝不苟地处理衣服的下摆。");
         outputText("[pg]多洛雷斯似乎对她不寻常的外表很感兴趣，但她也没有采取任何行动，所以看来你必须打破僵局。你牵着女儿的手，把她带到裁缝面前，直到你清了清嗓子，裁缝才抬起头来。");
         outputText("[pg][say:嗯？] 她猛地从工作中抬起头来，手里紧紧抓着针一秒钟，然后放松下来把它放下。[say:哦，是你啊，[name]。啊……欢迎，] 玛丽埃尔带着一丝不确定说道，她的目光落在了你身边的年轻蛾女身上。");
         outputText("[pg]你迅速介绍了多洛雷斯，解释说她是你的女儿，" + (!get_player().hasKeyItem("Bundle of Moth Silk") ? "就是你曾经把她的丝带给玛丽埃尔的那个" : "即使你们俩看起来不太像") + "。就多洛雷斯而言，她并没有对你的描述补充太多，你觉得你能从她身上捕捉到一丝紧张。当你讲完后，她走上前，微微低头，说道：[say: [day]好。你好，嗯……玛丽埃尔？]");
         outputText("[pg]这位裁缝似乎有些困惑，但很快就想起来从凳子上跳起来，行了一个利落的屈膝礼。[say:很，嗯，荣幸……多洛雷斯。] 她重新站直，把一缕掉落的头发别在耳后。[say:所以这是你的女儿，[name]？什么风把你们吹来了？]");
         outputText("[pg]令人惊喜的是，多洛雷斯在你被迫开口之前就说话了。[say:我们，啊，正在旅行。[Father]带我四处看看，因为我觉得是时候让我变得更见多识广了。] 多洛雷斯高傲地吸了吸鼻子，扬起下巴，但玛丽埃尔只是给了她一个试探性的微笑并点了点头。[say:[He]建议我们来这里。来看看你。] 她停顿了一下，显然不知道该怎么继续。[say:所以你……住在这里？]");
         outputText("[pg][say:我明白了。我，啊……确实，是的。]玛丽埃尔尴尬地动了动。[say:目前这确实是我的居所。]");
      ...
      public function hikkiMarielle() : void
      {
         ...
         outputText("[pg]无论如何，你设法告诉了她关于玛丽埃尔的职业和凡人身份。你的女儿在听到死灵法术时精神一振。");
      ...
      public function doloresJustChat() : void
      {
         ...
         switch(int(_loc2_[Utils.rand(int(_loc2_.length))]))
         {
            ...
            case 6:
               ...
               if((saveContent.hikkiQuest & HQMARI) != 0)
               {
                  outputText("[pg]然而，就在你以为这个话题已经过去时，她又开口了。[say:不过我想，玛丽埃尔的住处离这里也不算太远……] 她的脸上露出了沉思的表情，但没有再继续说下去。");
               }
               break;
            case 7:
