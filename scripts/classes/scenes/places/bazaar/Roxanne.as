package classes.scenes.places.bazaar
{
   ...
   public class Roxanne extends BazaarAbstractContent implements TimeAwareInterface
   {
      ...
      public function bigBootyRoxanneContestLoss() : void
      {
         ...
         outputText("[pg]当你被推到门上时，木板发出嘎嘎的响声，你柔软的脸颊向两侧挤压，撑开了你的[armor]。这位胸部丰满的胜利者用鼻子蹭着你的脖子，一路留下淫荡、醉醺醺的舔舐，直到你的下巴。她湿润的叹息声席卷了你，她开始喘息得越来越快，她不断加快的性唤起几乎夺走了你们俩口中的呼吸。蜥蜴人半软的阴茎挤压着你的大腿，慢慢地充血，随着不断膨胀的激情而变得越来越硬。在某个时刻，它挣脱了海盗皮裤的束缚，你醉醺醺地低头看着它。");
