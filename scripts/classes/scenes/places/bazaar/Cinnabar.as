package classes.scenes.places.bazaar
{
   ...
   public class Cinnabar extends BazaarAbstractContent
   {
      ...
      public function cinnabarMultiCockPortalFuckFest() : void
      {
         ...
         outputText("你用你的" + get_player().cockDescript(_loc2_) + "拍打她的脸，把她的淫水抹在她的脸颊上，并混合了一点你的先列腺液。她呻吟着跳到她的床上，但在你拉近距离之前，她问道：[say:荡妇能向" + get_player().mf("主人","女主人") + "展示她的把戏吗？她有这么多性感的把戏来帮助[master]操她那饥渴、疼痛的肉洞。][pg]");
         ...
         outputText("[say:" + get_player().mf("主人","女主人") + "喜欢荡妇的第一个把戏吗？哦，是的，[he]喜欢！看看那些庞然大物在抽搐！嗯，我知道你会喜欢这个荡妇的下一个把戏，[master]，]她指着远墙上的几十面镜子说。你把你那被乳房迷住的眼睛从她起伏的乳房上移开，顺着她的手指看向那些反光的圆圈。它们闪烁了一下，突然图像和形状取代了倒影，从无数个方向展示了这只淫荡、性痴迷的老鼠。在腰部高度有大量集中的传送门，你意识到它们都是为了让你把你的[cocks]穿过去而放置的。[pg]");
         ...
         outputText("[say:" + get_player().mf("主人","女主人") + "喜欢吗？哦，操这个荡妇[master]……妈的，来操我！那个该死的丰胸法术让我的小穴疼痛，渴望一根又大又硬的鸡巴。塞住我，" + get_player().mf("stud","baby") + "，你能把我填得这么好！做吧！现在就操我！]她尖叫着，摇晃着，在传送门里摩擦，她的舌头狂野地抽打着，而她的嘴唇拱成一个饥渴的“o”形。[pg]");
