   ...
   public class Farm extends BaseContent implements SelfDebug, SelfSaving
   {
      ...
      public function talkWhitney() : void
      {
         ...
         if(Utils.rand(4) == 0 && !get_player().hasKeyItem("Breast Milker - Installed At Whitney\'s Farm"))
         {
            if(get_player().hasKeyItem("Breast Milker"))
            {
               ...
               outputText("[say: 嗯，当然，它需要连接到泵系统、收集水库和电源。碰巧我在谷仓里为我的牛准备了所有这些设备，我想这比一个女孩闻牛头怪的麝香还要容易插上，] 惠特尼解释道，[say: 如果你愿意，我可以为你把这一切都设置好，见鬼，如果你能产出足够的奶，我甚至可能会给你几颗宝石。][pg]");
         ...
         if(Utils.rand(4) == 0 && !get_player().hasKeyItem("Cock Milker - Installed At Whitney\'s Farm") && get_player().hasKeyItem("Cock Milker"))
         {
            ...
            outputText("[say: 那当然，它需要连接到泵系统、收集池和电源。碰巧我在谷仓里为我的牛准备了所有这些设备，而且我估计把它插上去，比一个闻了牛头怪麝香的女孩还要容易。]惠特尼解释道，[say: 如果你愿意，我可以帮你把这一切都弄好，见鬼，如果你能用它收集到足够多的量，我或许能找到一种方法用它给我的牛授精，并付钱给你。你别担心，我知道怎么让这种事情运转起来。][pg]");
      ...
      public function getMilked() : void
      {
         ...
         else if(get_player().lactationQ() < 750)
         {
            ...
            if(_loc2_ == 2)
            {
               outputText("当你的乳房对机械化的吸吮做出反应时，乳汁淹没了挤奶器的杯子。机器发出呻吟声，因为它进入了高速运转状态，努力跟上你惊人的生产速度。你的乳头因快乐的微小快感爆发而刺痛，因为它们继续倾泻出越来越多的乳汁。性唤起涌上心头，让你的身体泛起难以掩饰的红晕。你在束缚带中扭动，大汗淋漓，试图在某物上摩擦，任何东西，只要能让你发泄就行。挤奶拖延了一个小时，但你的乳房在整个过程中不断倾泻出乳汁。当它结束时，你被放回地面并释放。挤奶管弹开，留下你躺在乳汁水坑里，而你漏奶的乳头继续滴落。[pg]");
            }
         }
         else
         {
