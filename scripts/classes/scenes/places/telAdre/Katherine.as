   ...
   public class Katherine extends TelAdreAbstractContent implements TimeAwareInterface
   {
      ...
      public function usePinkEggOnKath() : void
      {
         ...
         if(get_cockNumber() == 1)
         {
            ...
            {
               outputText("凯丝摇了摇头，说道：[say:我真的不想失去这个，" + playerText() + "。我希望你能理解，我的意思是，我生来就是扶她，这算是我的身体的一部分。][pg]");
               outputText("你揉了揉她的耳朵，告诉她你知道这是她从未失去过的东西——但它很容易再长出来。纯净梦魇药剂绝对是特尔阿德雷的商店里卖得最常见的药剂之一。此外，她终于能体会到作为一个女人，仅仅作为一个女人是什么感觉了。你问她，在成长的过程中，她有多少次想过那会是什么感觉？[pg]");
      ...
      public function useIncubiDraftOnKath() : void
      {
         ...
         if(!hasCock())
         {
            outputText("你向凯丝展示了那瓶梦魇药剂，并告诉她它已经被净化过了。凯丝急切地接过它，检查着浑浊的液体。[pg]");
         ...
         else
         {
            ...
            outputText("你向凯丝展示了那瓶梦魇药剂，并告诉她这已经被净化过了。一瓶应该足以让她的" + cockType("犬科肉棒","猫咪肉棒") + "增长一两英寸。[pg]");
      ...
      public function reductoBallSize() : void
      {
         ...
         outputText("你有一瞬间在想，她那" + (get_ballSize() > 3 ? "膨胀的" : "") + "阴囊上的" + catGirl("毛发","皮毛") + "是否会影响这个过程，然后决定试一试也无妨。你有些不确定地打开罐子，开始用手指涂抹药膏，然后开始在凯瑟琳的蛋蛋上涂抹。这个" + (hasCock() ? "双性" : "") + "" + catGirl("猫娘","猫科动物") + "在你的触摸下颤抖着，但咬着嘴唇什么也没说，任由你将缩形膏按摩进她的精液工厂，在你的手掌中滚动着球状的睾丸，以确保涂抹得彻底、均匀。[pg]");
      ...
      public function giveKatherineAnItem(param1:int = 0) : void
      {
         ...
         if(param1 == 1)
         {
            ...
            {
               addNextButtonDisabled("Pink Egg","给她一颗粉蛋，消除她的肉棒。如果她对自己的未来不确定，她是不会接受这种东西的。","Pink Egg");
            }
            ...
            {
               addNextButtonDisabled("Rem Balls","你见过没有蛋蛋的扶她。你很确定粉蛋和缩形膏一起使用能让她变成那样。如果她对自己的未来不确定，她是不会接受这种东西的。","Remove Balls");
            }
            if(get_furry())
            {
      ...
      public function giveKatClothesSilkRobe() : void
      {
         ...
         outputText("你解释说沼泽里的蜘蛛能产出一种极其坚韧的丝，这批丝经过处理后织成了这些长袍。她试了试布料，发现了它惊人的强度。[say: 它太薄了，看起来好像一扯就会碎。]她稍微用力扯了扯。[say: 如果这全是蜘蛛丝，我猜连牛头人都撕不破它。][pg]");
      ...
      public function bathTimePenetrated() : void
      {
         ...
         else
         {
            ...
            outputText("有你的手挡着，她的肉棒无法再深入。你试图通过收缩肌肉来补偿她，轻轻地挤压她" + cockAdj() + "的勃起。凯瑟琳仰起头，开始乞求。[say: 哦，求你了，" + playerText() + "！求你放开我，让我操你。我需要插得更深。] 她的肉棒" + cockMultiple("在","在") + "跳动，并向你的小穴" + cockMultiple("里","和溪流中") + "漏出大团温暖的预精液。");
