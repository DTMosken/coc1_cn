package classes.scenes.places.telAdre
{
   ...
   public class Maddie extends TelAdreAbstractContent
   {
      ...
      public function procMaddieOneIntro() : void
      {
         ...
         {
            outputText("你走进面包店，一只毛茸茸的粗壮手臂抓住了你的肩膀。一个熟悉的牛头人声音吼道：[say:你。你能帮忙。过来。]你转过身，但他已经走向一扇写着“仅限员工”的门了。你要跟上去吗？");
         }
         menu();
      ...
      public function followMinotaurIntoBackroom() : void
      {
         ...
         {
            outputText("你跟着这头粗壮的野兽穿过门，在他带领你穿过酷热的烤箱时转了好几次弯。当你们到达目的地时，牛头人已经大汗淋漓，而你也一样。随着他身上散发出的浓烈麝香，你发现自己开始怀疑他是否只是设下了一个精心设计的圈套，想引诱你进入某种性爱场景。他抓起一顶毛茸茸的白帽子戴在头上，用尽可能简短的话试图解释，从而坚决地打消了你的这个念头：[say:我是厨师。我做很棒的闪电泡芙，但现在在做杰作。需要特殊原料。你可以离开城市。给我带催情剂和蜂蜜来。不要纯的，太强了。去吧。][pg]");
            outputText("你有机会仔细观察他的工作台，注意到许多碗面糊、数百个巨大的闪电泡芙，以及你见过的最大的飞机杯。");
            if(get_player().hasPerk(PerkLib.MinotaurCumAddict))
            {
