package classes.scenes.places.telAdre
{
   ...
   public class Lottie extends TelAdreAbstractContent
   {
      ...
      public function talkToPigSlut() : void
      {
         ...
         {
            outputText("看到你这么想聊天，她的耳朵竖了起来；她似乎对某件事感到非常兴奋。你问她在想什么。[say:这么明显吗？]洛蒂抬头看着你，咧嘴笑了。[say:你看，宝贝，自从我们上次见面以来，我其实——我瘦了！]她站起来，在空中挥舞着拳头，扭动着丰满的屁股。[say:我的意思是，我知道变化不大，但这仍然是个成果！这太棒了！]她显然对自己很满意。你把手放在她的肩膀上，她对你灿烂地笑着。你是鼓励她，还是告诉她坏消息？[pg]");
            menu();
      ...
      public function lottieSuccessOneShot() : void
      {
         ...
         else
         {
            ...
            outputText("[pg]你醒来时头晕目眩，额头隐隐作痛——你全身赤裸，但除此之外没有受伤。然而，当你试图移动时，你发现自己无法动弹——你似乎被绑在椅子上，双手反绑在背后，双腿被绑在椅腿上。你观察了一下周围的环境，注意到了熟悉的砖墙和健身房设备棚里堆满物品的架子。熟悉的环境让你松了一口气——至少你知道自己在哪里。");
            ...
            outputText("[pg]她戴着手套的双手如天鹅绒般柔软，在你的身体里引起一阵阵快感，她的技巧虽然笨拙但很有效。洛蒂开始玩弄她多汁的乳头，扭动揉捏着它们，同时玩弄着你的肉棒。你浑身一颤，低头发现她的嘴离你的" + get_player().cockDescript(_loc1_) + "只有几英寸远，她滚烫的呼吸包围着你的龟头。她舔了一下你的龟头，你已经感觉到了一阵刺痛，你开始高潮了——她是不是吃了什么东西才导致这样的？不管怎样，你盲目地在她的手中抽插，寻找释放的机会，这时洛蒂紧紧抓住你的肉棒，堵住了你的精液，让你发出拒绝的咕哝声。[pg]");
            ...
            {
               outputText("对她来说不幸的是，你积攒了太多，现在停不下来了。伴随着另一次挺进，你的" + get_player().cockDescript(_loc1_) + "在愉悦中跳动，在高潮中爆发，一股股精液溅在洛蒂的脸和奶子上。女孩喘着粗气，大量的精液把她染成了白色。[say:不-不，停下！哦，天哪！]她尖叫着，然后她的嘴里充满了你滚烫的精华。她强迫自己咽下去，咳嗽着，而你则对着这个被击败的荡妇咧嘴笑。[say:好-好吧，你-你赢了，[name]，]她抬头看着你笑了笑，然后解开你的绑带，放你自由。[say:但你必须承认，这很有趣，对吧？]你向她竖起大拇指，然后走出大门，留她清理你浓稠的烂摊子。在出去的路上，一个卖奶昔的小贩向你挥手——是咖啡馆里的那个人。你买了一杯");
            }
            if(get_silly())
            {
               outputText("培根");
      ...
      public function lottieRepeatWalkies() : void
      {
         ...
         outputText("几分钟后，你带着你的婊子走出了健身房，绕到了后面，那里有一个设备棚正在等着你们。你用附近的一根金属杆迅速砸开了锁。你们俩慢慢走进去，洛蒂在你身后停下脚步，凝视着散落在墙上的工具和运动器材。很快，你就找到了你想要的东西。你从来不是一个会评判别人性癖的人，但你在心里默默记下，要感谢那个无法控制自己欲望的人。一条连着皮带的单层皮革项圈静静地挂在棚子墙壁上的钩子上。你咧嘴一笑，把它取下来，调整了一下绳子的长度，然后递给洛蒂。[say: 这、这是干什么用的，[sir]？]她嘟囔着，但你没有理会她的疑问，而是松开项圈，把它套在女孩的脖子上，在她抗议之前收紧。[say: 不、不要！你在干——！]啪！你一巴掌扇在她柔软的脸颊上，导致她猛地扯动绳子，痛苦而可怜地摔倒在地。你的荡妇眼泪汪汪地慢慢抬头看着你，一只手捂着脸以缓解刺痛感。[say: 我……我明白了，]她小声嘀咕着，捡起皮带放在你手里，然后双膝跪地，在你面前摆出乞求的姿势。当女孩伸出她的小舌头，不情愿地舔舐你的腹股沟以满足你衣服下的野兽时，你发出一声闷哼。就像一个婊子一样，以为你来这里就是为了这个。你走开，不理会她试图为你口交的举动，拉着皮带，把你的女孩往前拽。她站起身，开始跟在你身后走到[sun]光下——你想让全世界都知道你把你的胖小猪训练得有多好。[pg]");
         ...
         {
            outputText("在散步时，你发现自己来到了一个熟悉的地方——湿身婊酒馆的后巷。你觉得把你的骚货带进去也没什么坏处；你猛地把手往前一拽，强迫洛蒂走向门口——就在这时，你注意到一个正在疯狂自慰的醉汉。那个男人一边看着你，一边拼命地套弄着他粗壮的肉棒，还对你正用皮带牵着的母猪骚货抛了个媚眼。");
            if(get_silly())
            {
         ...
         {
            outputText("在散步时，你发现自己来到了一个熟悉的地方——湿身婊酒馆的后巷。你觉得带你的荡妇进去也没什么坏处；你猛地把手往前一拉，强迫洛蒂走向门口——这时你认出了一张正在疯狂自慰的双性狐狸兽人的脸。乌尔塔看着你，一边无情地抽插着她粗大的马鸡巴，一边对你现在用皮带拴着的猪荡妇眨眼。她似乎又一次不认识你了，这可能意味着她不知为何得了严重的失忆症，或者她比平时醉得多。");
            if(!get_silly())
            {
      ...
      public function lottieRepeatQuickie() : void
      {
         ...
         outputText("你跟着洛蒂来到泳池区，等她走进更衣室换衣服。然而，当她出来时，你惊讶地发现她什么也没换——事实上，她把所有的衣服都脱光了！[pg]");
      ...
      public function lottieMediumMoraleWeightLossAbuse() : void
      {
         spriteSelect(SpriteDb.get_s_lottie());
         clearOutput();
         outputText("你对洛蒂冷笑，严厉地提醒她，她现在的样子离她的目标还差得远——几磅的重量不会改变任何事情。事实上，她可能只是在早上量了量自己，而且很可能她根本没有减肥，因为她是一头猪。洛蒂似乎无话可说。她盯着你，想知道这一切是从哪里来的。几秒钟的沉默后，她开始抽泣，从椅子上站起来，跑出了健身房。不过你知道她会回来的。决定你在这里的事情已经结束，你返回营地——感到一种奇怪的满足感。[pg]");
         lottieMorale(-10);
         doNext(get_camp().returnToCampUseOneHour);
      }
      ...
      public function lottieHighMoraleWeightLossAbuse() : void
      {
         ...
         outputText("觉得这里的事情办完了，你返回了营地——感到一种莫名的满足。");
         lottieMorale(-10);
         doNext(get_camp().returnToCampUseOneHour);
      }
