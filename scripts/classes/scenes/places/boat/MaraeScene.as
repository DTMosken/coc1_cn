   ...
   public class MaraeScene extends BaseContent implements TimeAwareInterface, SelfDebug, SelfSaving
   {
      ...
      public function MaraeIIStageII() : void
      {
         ...
         if(get_player().get_gender() == 2)
         {
            ...
            outputText("你的心脏在胸腔里狂跳，女神的存在和完美、了然的触摸让你的[skindesc]泛起红晕。在这一点上，你根本无法抗拒她，即使你想抗拒。她光滑无瑕的手抓住你的肩膀，以一种温柔但坚定的压力向下压，不容任何抵抗。在玛莱的引导下，你的[legs]弯曲，让你摆出一个合适的、崇拜的姿势。一个困惑的、半成形的想法从你大脑中游荡的性唤起中挣扎出来，但你烦躁地摇了摇头，开始舔嘴唇，同时呆呆地看着玛莱骄傲的新肉棒。[pg]");
