package classes.scenes.places.boat
{
   ...
   public class Kaiju extends AbstractLakeContent implements Encounter
   {
      ...
      public function urethraFuckDatGiantCock() : void
      {
         ...
         outputText("[pg]维纳斯想了一会儿，随后她那充满欲望的眼睛亮了起来，显然是想到了一个令人愉悦又变态的主意。[say:来点尿道play怎么样？我以前见过一个牛头人把小拇指插进他的鸡巴里，我想你应该能塞进去。]");
         outputText("[pg]等等，她想让你进她的老二里？她到底在偷窥什么样的牛头人啊？");
      ...
      public function repeatKaijuEncounter() : void
      {
         ...
         {
            outputText("[pg]你突然想到，你身上的梦魇药剂足够多，甚至能影响到这个体型庞大的龟女。也许你可以给她长根鸡巴？");
      ...
      public function fuckThisGiantYouDumbCunt() : void
      {
         ...
         if(kaijuCock())
         {
            outputText("你惊讶地发现，在阴蒂本该在的地方，她有一根巨大的鸡巴。它已经因为兴奋而变得坚挺并跳动着，被污染的湖水从上面滴落。");
         }
