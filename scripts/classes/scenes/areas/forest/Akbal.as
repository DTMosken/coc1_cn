package classes.scenes.areas.forest
{
   ...
   public class Akbal extends Monster
   {
      ...
      public function Akbal()
      {
         ...
         {
            set_long("阿克巴尔，“地火之神”，在你周围盘旋。他那光滑而肌肉发达的身体上覆盖着黄褐色的皮毛，当你看着它们时，那些黑色的斑点似乎在跳动。他的嘴里有两颗象牙色的门牙，在稀疏的阳光下闪闪发光，他的嘴唇随着无休止的咆哮声而颤抖。他的每只爪子都隐藏着致命的利爪，能够将人类和恶魔撕成碎片。当你看着他那双巨大而令人作呕的迷人亮绿色眼睛时，它们预示着难以忍受的痛苦。");
