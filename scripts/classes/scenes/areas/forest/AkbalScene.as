package classes.scenes.areas.forest
{
   ...
   public class AkbalScene extends BaseContent implements SelfDebug, SelfSaving, Encounter
   {
      ...
      public function takeAdvantageOfAkbitch() : void
      {
         ...
         {
            outputText("[pg]阿克巴尔突然停止了挣扎，你听到有人在喊你的名字。当你移开视线时，阿克巴尔从你身下滚了出来。一阵地炎点燃了藤蔓，他伸出爪子向你扑来。[pg]");
      ...
      public function rapeAkbalForcedFemaleOral() : void
      {
         ...
         if(get_player().hasTailInsteadOfLegs())
         {
            ...
            outputText("你的气味让阿克巴尔胸腔里发出的低吼声变得颤抖起来。你躺在他面前，伸手将他的脸按进你的[vagina]里。这只恶魔无法摆脱他那令人虚弱的兴奋，开始舔舐你的[vagina]。他把脸贴在你的[vagina]上，扭动着嘴唇，将舌头钻进你的体内，无情地攻击着你的[clit]，让你在狂喜中尖叫、嚎叫和战栗。[pg]");
         ...
         else
         {
            ...
            outputText("你的气味让阿克巴尔的低吼声变得颤抖起来。你躺在他面前，抓住他的头，将他的脸按进你的[vagina]里。这只恶魔无法摆脱他那令人虚弱的兴奋，开始舔舐你的[vagina]。他扭动着嘴唇，将舌头钻进你的体内，无情地攻击着你的[clit]，让你在狂喜中尖叫、嚎叫和战栗。他开始抬起头，可能是想爬到你身上，但你强行把他的脸按回你的[vagina]里。在你放话告诉他，他必须让你高潮，否则就把他的头拧下来之后，阿克巴尔发出了呜咽声，显然因为无法将他那根胀痛的肉棒插进你的[vagina]而感到痛苦。[pg]");
         }
         ...
         outputText("当你离开时，阿克巴尔发出了咆哮，那些曾经惧怕他的生物正利用他发情的状态来报复这位地炎之“神”。即使你已经走到了森林的边缘，依然能听到这只美洲豹恶魔痛苦的嚎叫声，尽管这声音几乎被小恶魔尖锐的笑声和地精的咯咯笑声所淹没。");
      ...
      public function rapeAkbal() : void
      {
         ...
         if(get_player().hasTailInsteadOfLegs())
         {
            ...
            outputText("当你离开时，阿克巴尔发出咆哮，因为那些曾经惧怕他的生物利用他虚弱的状态，向这位地炎之“神”展开报复。即使你已经走到了森林的边缘，美洲豹恶魔痛苦的咆哮声依然隐约可闻，只是勉强盖过了恶魔小鬼尖锐的笑声和雌性地精的咯咯笑声。");
            dynStats(DynStat.Cor(1));
            get_combat().cleanupAfterCombat();
            return;
         }
         if(get_player().isTaur())
         {
            ...
            outputText("当你站起来时，你收集好你的[armor]，转身离开这个虚弱的恶魔。就在你开始走开的时候，你注意到一群小恶魔在看着你和美洲豹，他们的肉棒露在外面，还在滴着液体。混在人群中的还有几个地精，每个人都拿着一瓶液体，脸上带着恶意的笑容。[pg]");
            outputText("当你离开时，阿克巴尔发出了咆哮，因为曾经害怕他的生物利用他虚弱的状态向这个地炎之“神”复仇。即使你已经到达了森林的边缘，美洲豹恶魔痛苦的咆哮声仍然可以听到，但只是勉强盖过了恶魔小鬼尖锐的笑声和雌性地精的咯咯笑声。[pg]");
            dynStats(DynStat.Cor(1));
            get_combat().cleanupAfterCombat();
            return;
         }
         ...
         outputText("当你离开时，阿克巴尔发出了咆哮，那些曾经惧怕他的生物正利用他虚弱的状态，向这位地炎之“神”复仇。即使你已经走到了森林边缘，依然能听到这只美洲豹恶魔痛苦的嚎叫——尽管，那声音勉强盖过了小恶魔们尖锐的笑声和雌性地精们的咯咯笑声。");
         dynStats(DynStat.Cor(1));
         get_combat().cleanupAfterCombat();
      }
      ...
      public function girlsRapeAkbalPart2() : void
      {
         ...
         else if(get_player().vaginalCapacity() < new Akbal().cockArea(0))
         {
            ...
            outputText("当他瘫倒在树干上时，被快感淹没了。带着你自己满意的笑容，你捡起你的[armor]然后离开。也许你有空应该再去找找这位[say: 地炎之神]……");
            get_player().orgasm("Vaginal");
         }
         else
         {
      ...
      public function girlsRapeAkbal() : void
      {
         ...
         FlagDict_Impl_.arrayWriteInt(_loc1_,903,FlagDict_Impl_.arrayReadInt(_loc1_,903) + 1);
         clearOutput();
         outputText("看着这位所谓的“地炎之神”在地上抽搐成一团，你暗自冷笑。脱下你的[armor]，你的手滑向你那女性的缝隙，盘算着该如何利用他。[pg]");
      ...
      public function akbalQuestConclusionWin() : void
      {
         ...
         outputText("[pg]你着迷地看着阿克巴尔眼睛和嘴里的翠绿色火焰开始向菲拉的手飘去。他在她的掌控中尖叫着、虚弱地扭动着，完全无力阻止这一切。越来越多的地炎倾泻而出。阿克巴尔的痛苦似乎难以忍受。不过，这个过程并没有持续太久。");
         ...
         outputText("[pg](<b>获得特质：地炎——你现在可以在营地选择不同类型的魔法了</b>)");
      ...
      public function akbalQuestConclusionWho() : void
      {
         ...
         outputText("[pg][say: 我是谁？我是阿克巴尔，<b>地炎之神</b>，]他一边傲慢地舒展翅膀，一边将柔滑的黑发向后甩过肩膀。[say: 这是我第一次晋升为这种奇妙形态时获得的称号。]他看起来越来越傲慢自恋了。不过，这并没有回答你的问题。恶魔有很多，但似乎没有一个能像他一样散发出如此强烈的奥术狂怒。");
      ...
      {
         clearOutput();
         outputText("当你走在森林里时，头顶上突然传来树枝折断的声音。你迅速抬头看向声音的来源，却只看到一双隐藏在树冠阴影中的闪闪发光的翠绿色眼睛。一股恶魔般的力量席卷了你，让你僵在原地，一只美洲豹的爪子从黑暗中伸出。这只优雅的杀手在树枝上潜行，很快就完全暴露在你的视线中。沐浴在透过头顶树叶过滤的[sun]光下，这只生物将你锁定在它的目光中——这目光太聪明了，不属于一只普通的野生动物。一阵窃窃私语的合唱在你的耳边响起，但声音太小，你听不清在说什么。[pg]");
         ...
         outputText("[say:我是阿克巴尔，地炎之神。你正在侵入圣地……臣服，或者死。][pg]");
