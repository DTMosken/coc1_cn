package classes.scenes.areas.lake
{
   ...
   public class GreenSlimeScene extends AbstractLakeContent
   {
      ...
      public function turnIntoGreenSlime() : void
      {
         ...
         outputText("[pg]当史莱姆开始移动，慢慢地抽插你的[vagina]时，你微微弓起背。随着它速度的加快，少量这种东西的绿色液体在你的下体周围积聚，让你的皮肤感到刺痛，并让你充满了一种不同寻常的性唤起。过了一小会儿，怪物再次完全插入你体内并停了下来，你意识到在某个时刻你已经开始随着它移动你的臀部。你惊讶地喘息着，因为史莱姆的肉棒开始在你体内搅动，以一种独特而令人愉悦的方式从内部按摩着你。");
