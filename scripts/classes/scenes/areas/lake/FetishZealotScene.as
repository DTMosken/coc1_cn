package classes.scenes.areas.lake
{
   ...
   public class FetishZealotScene extends AbstractLakeContent
   {
      ...
      public function religiousRape() : void
      {
         ...
         outputText("[pg][say: 主啊，让这根圣杖被[if (vaginalwetness > 0 || analwetness > 0) {[his]的祭品|你神圣的油脂}]涂抹吧，]他说道，祈祷的话语刚从他唇边升起，[if (!istaur) {他那滑腻的拇指就顺着他的肉棒滑下，留下一道闪闪发光的[if (vaginalwetness > 0 || analwetness > 0) {你的欲望|油脂}]痕迹|你手掌下的祭坛微微变暖，这既是不祥之兆，又令人感到安慰}]。");
      ...
      {
         outputText("[pg]狂热者双手合十，似乎在集中精神，寻找他所需要的决心。他背对着你，手脚并用地趴在地上，将自己献上。[say:我的身体……被失败玷污了，只有屈服才能洗净……]之前改变服装的魔法开始缩短他长袍的裙摆，直到他的屁股暴露在你面前。[say:我们敬爱的主啊，我将为您受苦，]他说道，然后将目光转向你，眼中充满了焦虑。尽管他表面上很克制，但你能感觉到他身上散发出的性唤起，这让你的勃起更加坚挺。");
