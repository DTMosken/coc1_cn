package classes.scenes.areas.mountain
{
   ...
   public class MinotaurScene extends BaseContent
   {
      ...
      public function rapeMinotaurTentacles() : void
      {
         ...
         {
            outputText("在你最后一击之后，牛头怪向后倒下。他疲惫不堪，被击败了，当你靠近时，他几乎站不起来。");
         }
         else
         {
            outputText("牛头怪垂下了手臂");
      ...
      public function minotaurGetsRapedByHerms() : void
      {
         ...
         outputText("你的[cock]因他的紧致而颤抖，他强有力的心脏的每一次跳动都在他的后庭紧紧地挤压着你。透过你模糊的大脑，你开始意识到你的臀部正以令人不安的速度在他身上活塞运动，用白热化的欲望和半人马的精液烧毁了你仅存的理智。你操他的时候拍打他的屁股，羞辱这只野兽，当他绝望地发出牛叫和呻吟时，你色眯眯地低头看着他。最后，快感淹没了你，你像大炮一样将精液射入他体内，你的臀部仍然带着不假思索的决心操着他。每一次抽插，精液都从他的尾巴洞里喷溅出来，溅满他的屁股。当这只野兽开始高潮时，一股突然的非人温暖填满了你，随着怪物肉棒每一次抽插进你的" + get_player().vaginaDescript(0) + "，巨大的喷射直接涌入你的子宫。[pg]");
      ...
      public function minotaurFunWithUnbirthing() : void
      {
         ...
         get_player().slimeFeed();
         minoCumAddiction(5);
         outputText("当你俯视着被击败的半人马时，一种熟悉的酸痛感从你那怪异子宫的深处升起。你那大张着、滴落着淫液的小穴因期待而颤抖，你的史莱姆孩子们蜂拥而出，覆盖住这头巨大的公牛，在你庞大而无法移动的身躯被它们轻轻放到石地上时，它们覆盖住怪物，开始缓慢地将它拖入你的小穴。你咯咯地笑着，看着它挣扎，它的" + get_monster().cockDescriptShort(0) + "在空气中渗出令人陶醉的先列腺液。反正你的[armor]也不足以遮盖你的小穴，你干脆靠在肚子上，抬起双腿把它脱掉，露出你的" + get_player().vaginaDescript(0) + "，空气中的气味已经让它比平时更加湿润了。[pg]");
         ...
         outputText("既然你已经玩够了，寄生虫们恢复了它们的任务，将半人马完全拖入你酸痛的子宫，你陷入了欲望引发的迷雾中，你的肚子向外凸起，显著地变大（尽管大部分是暂时的），以容纳它的新负担。这头野兽肯定会成为一顿不错的盛宴。");
         get_player().cuntChange(get_monster().cockArea(0),true);
         get_player().orgasm("Vaginal");
      ...
      {
         var _g:Combat;
         outputText("半人马对你笑了笑，掀起他的缠腰布，朝你弹了一下。粗大的先列腺液在空中飞舞，");
         if(Utils.rand(3) == 0)
         {
      ...
      public function minoMutual() : void
      {
         ...
         else
         {
            ...
            outputText("[pg]当你告诉他你愿意让他射精时，他的眼中燃起了希望的火花。在他变得过于兴奋之前，你定下了规矩，让他知道他必须先让你高潮，然后你才会尝试让他那根肿胀的大鸡巴喷出浓稠的乳白色精液。当你问他这样是否可以时，他用力地点头，突然变得非常愿意做你要求的任何事，只为从他那牛类生理结构引起的折磨人的性唤起中得到解脱。");
      ...
      public function girlRapeAMinotaur() : void
      {
         ...
         get_player().slimeFeed();
         minoCumAddiction(5);
         outputText("[pg]你猛地一推，将喘着粗气的半人马翻转过来，让他仰面朝天，那根跳动着的" + get_monster().cockDescriptShort(0) + "暴露在空气中。你随手一挥，剥开你的[armor]，露出你的" + get_player().vaginaDescript(0) + "，空气中的气味已经让它比平时更加湿润。你走上前去，跨坐在那只毫无知觉的半人马身上，他正疯狂地自慰，肌肉因用力而隆起，浑身是汗。你的目光锁定在他那根布满棱纹的马状阴茎上溢出的一滴先列腺液，找到了那股气味的源头。[pg]");
         get_images().showImage("minotaur-win-female");
         ...
         outputText("[pg]最后，你感觉到半人马粗壮的手抓住了你的");
         if(get_player().isTaur())
         {
         ...
         outputText("半人马加快了速度，心跳声透过他坚硬的肉棒传来，当他一次又一次地将你砸在上面时，肉棒随之抽搐和震动。你感觉到他的睾丸在你的屁股上抽动，他的肉棒肉眼可见地变粗，根部鼓起，并在你体内慢慢变胖，直到感觉快要撑破了。伴随着一声沙哑的咆哮，他终于射了，将精液直接喷射进你的子宫。当精液填满你时，你翻了翻白眼，感受着那液体的快感渗入体内，令你神魂颠倒。你的" + get_player().vaginaDescript(0) + "紧紧夹住，将他的精液锁在里面，他的高潮持续着，睾丸开始缩小。大量的液体填满了你的子宫，痛苦地撑大了你的肚子。半人马给出了最后一次强有力的喷射，这股力量将你从他的" + get_monster().cockDescriptShort(0) + "上推开，就在你们俩都达到完全的性满足时。[pg]");
         get_player().cuntChange(get_monster().cockArea(0),true);
      ...
      public function getRapedByMinotaur(param1:Boolean = false) : void
      {
         ...
         else
         {
            ...
            {
               outputText("你发现一个影子在移动，转过身去，看到一个牛头怪从洞穴深处笨重地追着你！");
      ...
      public function bumRapeaMinotaur() : void
      {
         ...
         if(get_player().cumQ() > 500)
         {
            ...
            outputText("[pg]你发出一声狂喜的叹息，挣脱开来，踉跄着退开，而那只半人马则在自己射出的一大滩精液中昏了过去。你试图清理自己，舔着手指，那美妙的味道让你的大脑充满了欲望的迷雾，令你神魂颠倒。");
