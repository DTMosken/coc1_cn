package classes.scenes.areas.mountain
{
   ...
   public class NephilaSlimeScene extends BaseContent
   {
                  ...
                  switch(Utils.rand(4))
                  {
                     ...
                     case 2:
                        if(get_player().statusEffectv1(StatusEffects.ParasiteNephila) >= 10)
                        {
                           ...
                           outputText("[pg]那生物瘫倒在地，喘着粗气，满眼不服气地盯着你。你上前，得胜者的姿态，迫不及待地准备收取战利品。你脱去衣物，露出那饥渴的[vagina]，牛头人随之爆发出一股原始的冲动。你一拳将它再度打晕，随即决定用它自己的锁链将它的双臂束在一起。[pg]牛头人仍在试图挣脱，但很快意识到徒劳无功。它平静下来，除了那根因你方才的展示而怒张的阴茎依然猛烈跳动。你笑了，用手指慢慢撩拨它那巨大的肉棒，令先列腺液喷涌成丝。[pg]在它意识到你渴望的远不止它那变异的阴茎之前，一切已经为时已晚。你的小穴淫荡地大张，似乎无穷无尽的络新妇软泥怪从中一个接一个地扑出，将牛头人团团包围。它震惊地嚎叫，奋力甩动身体对抗那黏腻的束缚，却无计可施。你在高潮中失声叫喊，你的孩子们将它拖回你的阴道，让你那已然令你无法行动的巨大肚子再度膨胀到近乎现有体积的两倍。你咧嘴笑着感受它在你体内的挣扎。[say: 嘘，]你说。它那巨大阳具的浮雕轮廓顶着你的子宫外壁，你隔着腹部肉壁握住那根肉棒，以母性的方式替它手淫，同时你的幼群将它躯干上的血肉一片片从骨骼上撕碎。\"没事的，\"你说。[say: 妈妈在这里。去睡吧。]当那生物终于停止动弹，你在自己那臃肿鼓胀的躯体上轻轻摇晃，让它液化的身躯在你体内汩汩流动，令焦躁的孩子们蠕动起来。你催动蜂群向前，开始追猎下一个猎物。");
      ...
      public function loseToNephilaWithCockAnBallsAnCunt() : void
      {
         ...
         outputText("[pg]你被填满你的东西固定在原地。史莱姆娘摩擦得更用力了，注意到你勃起的[oneCock]，她渗出黏液向前移动，用半液态的嘴包裹住你的阴茎。她像荡妇一样吮吸着，嘴里内部类似触手的结构抚摸着你的[cockhead]和尿道");
         outputText("。她看着你的呼吸因为快感而变成喘息，笑了起来。");
      ...
      public function encounterNephila() : void
      {
         ...
         outputText("[pg]你突然听到身后传来一阵刮擦声！你及时转过身，看到一个熟悉的史莱姆娘的身影从一条阴暗的沟壑中剥离出来。她动作缓慢而充满挑逗，让你有些惊讶。但最令人惊讶的是她那巨大的孕肚，以及她背上用来支撑肚子的四根羽毛状的白色触手。");
      ...
      public function dudesLoseToNephila() : void
      {
         ...
         outputText("[pg]史莱姆娘把自己拉起来，让她的性器官悬挂在你的脸前，她巨大、臃肿的肚子让你的整个身体都处于阴影之中。当她调整姿势时，你试图踉跄着躲开她的触及范围，但她用一根触手抓住了你的手腕，强行将它们举过你的头顶按在岩石上，把你的手腕背面在岩石上摩擦作为惩罚。她悬在你身旁的左腿，把你猛地拉回巨石上，让你和石头之间几乎没有移动的空间。你虚弱地试图挣脱，但她的握力惊人地大，像老虎钳一样把你困住了。伴随着一声呻吟，你放松下来，听天由命地接受了这场强暴。");
         ...
         outputText("[pg]她用小穴光滑的褶皱挑逗着你的龟头，一边一点点地把你拉向前，一边在周围打转。现在你的需求已经变得如此强烈，以至于你甚至不在乎自己被强暴，或者她如何进行，只在乎你必须发泄出来。你充满欲望地呻吟着，史莱姆娘绽放出一个灿烂的笑容，顺着你的肉棒滑下，将你");
