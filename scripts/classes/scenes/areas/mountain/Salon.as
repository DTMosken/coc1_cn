package classes.scenes.areas.mountain
{
   ...
   public class Salon extends BaseContent implements TimeAwareInterface
   {
      ...
      public function salonPaymentMenu(param1:Boolean = false) : void
      {
         ...
         addNextButton("牛头人",gloryholeMinotaur).hint("吸吮那根巨大的牛头人肉棒！");
      ...
      public function minotaurCumBukkakeInSalon() : void
      {
         ...
         outputText("你推开几个盯着你看的地精荡妇，一边走一边脱下你的[armor]。你大脑中动物的本能意识到，这种不必要的束缚只会妨碍那些浓稠、滴落的牛头人精液泵入你的体内。另一扇门在你身后关上，那股气味不顾一切地将你拖入沙龙深处，靠近地精们藏在后面的隐蔽的寻欢洞。你一边流着口水，一边沉浸在舌尖上那味道的记忆中，让你的身体在自动驾驶模式下寻找它。");
         ...
         outputText("[pg]");
         outputText("时间缓慢而折磨人地流逝，但你转过拐角，叹了口气。救赎就在眼前——你已经到达了寻欢洞，令你高兴的是，有近十根坚硬、滴落、美味的……嗯……牛头人肉棒塞在洞里，有些在接缝处凸出，渗出渴望的液体。你向前走去，臀部性感地摇摆着，强效牛头人麝香那如毒品般的欲望将你拉得越来越近。你开心地喵喵叫着，把其中一根拿在手里，顺着它的长度抚摸，当它跳动并流出一股天堂般的粘液顺着你的手臂流下时，你咯咯地笑了起来。你用一个长长、慵懒的动作把它从你的手臂上舔掉，然后撅起嘴唇含住牛头人膨胀的龟头，用力吸吮，寻找更多它那令人陶醉的甘露。[pg]");
         outputText("你听到一声深沉、压抑的叹息，越来越多的美味先列腺液涌入你的嘴里，点燃了你的感官，带来一场烟花般的快感");
         if(get_player().get_gender() > 0)
         {
            outputText("并且增加了你在地板上留下的水洼的大小");
         }
         outputText("。在吞咽芳香液体的间隙，你把肿胀的肉棒吸得越来越深，当它推开你的悬雍垂时，你高兴地抑制住你的呕吐反射。你活动着喉咙，狂热地吞咽着把它吸下去。当它被越来越深地吸入你的体内时，龟头冠状沟短暂地撑开了你的脖子，直到你的嘴唇穿过洞口皱起，你闻到了牛头人带有信息素的胯部。[pg]");
      ...
      public function hairDressingMainMenu(param1:Boolean = false) : void
      {
         ...
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,142) > 0)
         {
            outputText("[pg]当然，你也可以花点宝石买点牛头人精液……");
         }
         salonPurchaseMenu();
      }
      ...
      public function gloryholeMinotaur() : void
      {
         ...
         clearOutput();
         get_player().slimeFeed();
         outputText("你的目光被那根巨大的牛头人肉棒吸引，本能地跪在它面前。[pg]");
         outputText("它是这个房间里目前最大的一根肉棒，从你跪着的位置看，它显得更加巨大；它有两英尺多长，长度上分布着三个包皮环。你勉强能用整只手握住它的粗细。你张大嘴巴向前倾身，把粗大、海绵状的龟头含进嘴里。味道非常浓烈，它的麝香味就像牛头人的肉棒一样浓郁。你舒服地呻吟着，开始前后晃动脑袋，把越来越多的肉棒含进嘴里。你配合着吸吮的节奏套弄着剩下的肉棒。你能听到墙的另一边传来沉闷的咕噜声和喷鼻息声，显然是你的伴侣发出的赞许声。[pg]");
         outputText("在牛头人反应的驱使下，你把越来越多的牛头人肉棒含进嘴里。当你用嘴对付第一个环时，你解开了[armor]的上半部分，释放出你的" + get_player().allBreastsDescript() + "。每一次吞吐，你都能把更多的公牛肉棒吞进喉咙。你抚摸着你的" + get_player().biggestBreastSizeDescript() + "，同时含着肉棒呻吟。当你的嘴含住第二个环时，牛头人的肉棒剧烈地跳动了一下，他的精液在你的嘴里爆炸了。你震惊地瞪大了眼睛，尽可能快地拔出肉棒。你吞下了最初几股浓稠、丰富的牛头人精液，而剩下的则射了你一脸和一胸。你");
         ...
         outputText("牛头人的麝香味让你头晕目眩，你漫不经心地擦拭并吞下[face]上的精液。一个地精助手拿着一个碗走进来，用一块光滑平整的石头轻轻刮掉你胸部的精液。等你清理干净并穿好衣服后，助手把你带回了林奈特那里。[pg]");
      ...
      {
         clearOutput();
         outputText("你向林奈特展示了那瓶" + (param1 == 0 ? "牛头人" : "乌尔塔的") + "精液。林奈特小心翼翼地从你手里接过瓶子，说道，[say:我很乐意收下这些，谢谢。现在我能为你做点什么？]");
         if(param1 == 0)
         {
      ...
      public function fuckLynnette() : void
      {
         ...
         outputText("[pg]你点点头，踢上了林奈特房间的门。这间卧室和它的主人一样，是个紧凑的小房间，四面都是近在咫尺的洞穴墙壁，但天花板至少有十英尺高，确保这个空间对从地精到牛头人的任何生物来说都很舒适。林奈特的床大得离谱，几乎占据了整个房间。这位地精主母终于放开了你，跳上她的床，转身面对你。");
         ...
         else if(get_player().cumQ() <= 10000)
         {
            if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,1027) == 1)
            {
               outputText("[say: 哇，[name]。你射得像个牛头人……而且还没有把我迷晕！天哪，我已经能感觉到那些小游侠在寻找我的卵子了。]她咯咯地笑着，拿出一个小瓶，一口吞下。[say: 我最好确保有足够的卵子给它们，对吧？][pg]你带着幸福的微笑离开了。看来林奈特很认可你这个伴侣。");
            }
            else
            {
