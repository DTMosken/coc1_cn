package classes.scenes.areas.plains
{
   ...
   public class BunnyGirl extends BaseContent
   {
      ...
      public function ovipositBunnyEaster() : void
      {
         ...
         outputText("[pg]你爬了下来，产卵管缩回了槽中。这种空虚感对于一直承受着未产卵的沉重负担的你来说，是一种幸福的改变。当你回过神来时，你意识到兔女郎还在高潮。她的阴茎终于从嘴里弹了出来，你看到她用浓稠透明的淫液颜射自己。一个巨大的凸起撑开了她的尿道，被迫穿过她的肉棒，喷射出一颗明亮的粉蛋。蛋弹在她那被药物麻醉、呆滞的脸颊上，她那失去知觉的嘴唇试图呻吟，紧接着第二颗蛋也喷了出来。在这两个惊喜之后，一股精液溅在她的头上，把她的耳朵贴在了头发上。");
