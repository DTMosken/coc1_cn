package classes.scenes.areas.swamp
{
   ...
   public class AlrauneScene extends BaseContent implements TimeAwareInterface, SelfDebug, SelfSaving
   {
      ...
      public function alrauneFlirtSex2() : void
      {
         ...
         outputText("[pg]植物女孩结束了亲吻，让你在凝视她闪闪发光的紫色眼睛时感到一阵晕眩。" + (get_player().cockThatFits(3,"width") < 0 ? "她大腿在你巨大的肉棒" + (int(get_player().cocks.length) > 1 ? "们" : "") + "周围蠕动，突然感觉刺激多了。温暖的花蜜从她的深处流出，当她的骨盆在你的肉棒上前后移动时，留下了一条光滑的痕迹。你开始抽搐和颤抖，现在对这种感觉太敏感了。你怀疑，是因为那个吻吗？你咒骂自己没有一个足够紧凑的工具来插入她。" : "她向后翘起臀部，将你" + get_player().cockDescript(get_player().cockThatFits(3,"width")) + "的尖端对准她的小穴，让你脊背发凉。当她沉下去吞没你的肉棒时，她发出一声满足的叹息。在刺激下，你强迫性地颤抖，感到一种射精的欲望，抽搐着。你怀疑，是因为那个吻吗？撇开沾有药物的嘴唇不谈，她天鹅绒般的肉壁能把任何男人逼到边缘。"));
         ...
         outputText("[pg]当她骑着你时，花蜜顺着你的肉棒滴下。显然，她非常享受这一切。她丝滑的头发[if (tallness < 72) {随着她的动作不断扫过你的脸|在你的注视下摇晃和碰撞}]，让那美丽的花朵阵列来回摆动。专注于她头上那片草地上色彩斑斓的花瓣，是你现在能做的最好抵抗高潮的方法。然而，分心被证明是徒劳的，因为你的肌肉因快感而收缩和颤抖。" + (get_player().ass.analLooseness > 0 ? "在你的[asshole]里进进出出的粗大黑色触手故意压迫着你的前列腺，催促你爆发。" : "") + "出于本能，你挣脱了缠绕在你们俩身上的束缚，设法将手臂向上滑，环绕在她的躯干上。你紧紧拥抱着苍白的爱娜温，呻吟着直到你感到头晕目眩，同时无法控制地将你的[hips]向前猛撞。那一刻终于到来了，你射精了，" + (get_player().cockThatFits(3,"width") < 0 ? "把你身体里所有的东西都喷洒在她的花壁上" : "一滴接一滴地填满她的体内") + "，为你的女主人提供她华丽身姿所需的所有营养。她一边轻笑一边收紧身体。[say: 是的，真是个好[boy]。我要把你每一盎司的种子都榨干，]她保证道。");
         outputText("[pg]植物女孩更多地移动她的臀部，在你的高潮中不给你任何休息。" + (get_player().cockThatFits(3,"width") < 0 ? "她大腿施加的压力" : "她火热深处那黏滑、浸满精液的通道") + "让你颤抖，你的[cock]对于持续的猛攻来说太敏感、太娇嫩了。你的骨盆肌肉紧绷，你不由自主地射得比以前更猛烈。你的女主人托起你的下巴，把她的嘴唇压在你的嘴唇上。这个高潮中的吻让你平静下来。你的肌肉不再紧张，让你在拥抱她时静静地渗出剩余的精液。");
         get_player().orgasm("Dick");
      ...
      public function alrauneCunnilingus3() : void
      {
         ...
         outputText("[pg][say: 刚才不是很棒吗？你应该找个时间再来，我可能会习惯使用你的。] 在她旁边的花瓣上躺了一会儿，你告诉她你也许愿意找个时间再来第二回合。她对你的同意轻笑了一声，然后用比之前更活泼的语气说道。[say: 很高兴看到有人知道[his]位置。] 在她的花瓣上安静地休息了一会儿后，你站起来[if (hasarmor) {重新穿好衣服|收拾好你的东西}]，向你的花朵“女主人”告别，然后返回营地。");
         get_player().orgasm("Vaginal");
         dynStats(DynStat.Cor(1));
         doNext(get_camp().returnToCampUseOneHour);
      }
