package classes.scenes.areas.swamp
{
   ...
   public class FemaleSpiderMorphScene extends BaseContent implements TimeAwareInterface, SelfDebug, SelfSaving
   {
      ...
      public function fSpiderMorphRape() : void
      {
         ...
         outputText("她的阴部和她的乳头一样是深色的，不过她私处的阴唇比那些小凸起暗淡的皮肤更接近纯粹的午夜黑。一层女性的淫液在她的外阴上积聚，使她的大阴唇和皮肤在透入沼泽地面的微弱[sun]光下明显闪闪发光。在她的阴道周围，皮肤迅速从深巧克力色褪回她身体其余部分那种瓷器般的白色。你戳弄并把玩着那湿润的裂隙，感觉柔软的皮肤像柔软的天鹅绒手套一样在你的手指周围分开。作为回应，她变得更湿了，对你的侵入发出哀怨的轻声呻吟");
      ...
      public function defeatFemale() : void
      {
         ...
         outputText("怪物女人把手放在你的阴阜上，感受着你温暖的渴望从她的指缝间溢出，液体的欲望让她光滑的黑色甲壳在昏暗的沼泽[sun]光下闪烁着幽暗的光芒。她喉咙里发出一声呼噜声，宣布道：[say:我想我的玩具已经准备好了。][pg]");
