package classes.scenes.areas.swamp
{
   ...
   public class Rogar extends BaseContent
   {
      ...
      public function rogarBarFlirt() : void
      {
         ...
         outputText("[pg]罗加尴尬地咳了一声。[say: 我真的不感兴趣，[if (isfeminine) {姑娘|小伙}]。]他微微瘫倒，低着头，但随后又把目光转向你。[say: 不-不是你有什么问题——我是说，不是你这个人的问题，只是[b:你]是什么的问题。我……]兽人的声音渐渐变小，他的眼睛转动着，似乎在寻找合适的词语。[say: 我喜欢男人。]");
         addNextButton("放弃",rogarBarFlirtDropIt).hint("没必要强求。");
         addNextButton("欺骗他",rogarBarFlirtTrickHim).hint("不管怎样，他都会把那根鸡巴给你的。").disableIf(!get_player().isCorruptEnough(35),"你需要更加堕落。");
      }
      ...
      public function loseButtGinity() : void
      {
         ...
         else
         {
            ...
            outputText("你的精液滴落在罗加绿色的皮肤上，汇聚在他的肚脐里，同时他的嘴对你的脖子发起了一阵啃咬和舔舐的攻势，每一次轻咬都让他的獠牙摩擦着你敏感的皮肤。他的双手粗暴地抓住你的" + get_player().buttDescript() + "，用手将你的臀瓣掰开，像揉面团一样揉捏着那里的肉。他用臀部霸道地顶弄着你，诱哄你动得更快，他的肉棒在你体内每一次抽插都伴随着低沉的咆哮。滚烫的液体粘在你的内壁上，兴奋让你无助地挺动臀部，随着每一次抽插，你变得越来越敏感。你很快就在罗加的肉棒上上下弹跳起来，为了让你这狂野的骑乘更进一步，罗加开始向上挺动臀部来迎合你的[ass]。[pg]");
      ...
      public function encounterRogarSwamp() : void
      {
         ...
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,407) == 0)
         {
            ...
            unlockCodexEntry(2050,false,true);
            if(get_player().sexOrientation > 20 && (get_player().sexOrientation < 50 ? get_player().lib + get_player().cor < 120 : get_player().lib + get_player().cor < 70))
            {
         ...
         else if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,407) == 1)
         {
            ...
            else
            {
               ...
               outputText("你对着小屋里呼唤了几声，慢慢走进去，并确保关上身后的门。尽管位于沼泽中心，小屋内却有一种家庭般的温暖感。总而言之，很舒适。小屋里配有基本的木制家具，如桌子、椅子和床。虽然这些陈设做工粗糙，但看起来确实很结实。当你把这里当成自己家时，你走过桌子，用手抚摸着它光滑的表面，闻到油灯燃烧的烟味弥漫在空气中，照亮了房间。当你走近查看床铺时，你发现上面铺着粗糙的布。它看起来很舒服，虽然明显很脏。床边散落着精液的污渍，结成了厚厚的干涸精斑。你仍然能闻到最近射出的精液的腥臭味。");
               if(get_player().lib >= 50)
               {
                  outputText("你的下体燃烧起来");
               }
