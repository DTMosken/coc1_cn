package classes.scenes.areas.bog
{
   ...
   public class FrogGirlScene extends BaseContent implements TimeAwareInterface, Encounter, SelfDebug, SelfSaving, AnalPregnancy, VaginalPregnancy
   {
      ...
      public function followDatFrog() : void
      {
         ...
         outputText("[pg]她的皮肤摸起来滑溜溜的，当她把你拉近时，她把她的体液留在了你的手臂和[chest]上。它接触到你的地方会感到刺痛，你周围的阳光似乎变得更亮了一些。她的歌声继续着，你发誓你能看到音乐在空气中飘荡，每一个不同的音符都是在空气中漂浮的不同的霓虹灯。半专注状态下，你的眼睛来回扫视，追踪着微小的光点。");
      ...
      public function carryBeeGirlsEggsVoluntarilyYouButtSlut() : void
      {
         ...
         outputText("[pg]她手臂上的黏液让你感到一阵酥麻，当她为你脱下衣服，剥去你的[armor]时，她在你的手臂、肚子和[chest]上留下了黏糊糊、令人发麻的印记。当你看着她时，她的动作似乎留下了光轨，周围的阳光似乎也变得更亮了一些。她自顾自地哼着歌，你发誓你能看到音乐漂浮在空中，每一个不同的音符都是一道不同的霓虹光芒在空中飘荡。你半梦半醒，眼球来回转动，追踪着那些微小的光点。");
         outputText("[pg]她圆滚滚的肚子摩擦着");
         if(get_player().hasCock())
         {
            outputText("[eachCock]");
