package classes.scenes.areas.glacialRift
{
   ...
   public class MoraScene extends BaseContent implements SelfDebug, SelfSaving
   {
      ...
      public function moraRibjob() : void
      {
         ...
         outputText("[pg]当你如释重负地叹息时，浓雾笼罩了你的脸。虽然她的骨头很坚硬，但挤压那光滑的隆起却令人满足。[if (silly) { 这一定就是他们所说的\"为[his]的快感而生\"的意思。}]当你伸手抚摸她时，她在你身下摇晃，抚摸她的锁骨，顺着她胸骨的沟壑往下摸，然后再次揉捏她的乳房。你的另一只手臂抓着她的手臂，当你前后挺动臀部时，你用力拉扯它，操着她的肋骨[if (hasVagina) { 用你的[pussy][if (isHerm) { 和 }]|，}][if (hasCock) {让你的[cockhead]与你几乎不敢相信没有折断的小树枝碰撞}]。");
