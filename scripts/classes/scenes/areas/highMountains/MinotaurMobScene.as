package classes.scenes.areas.highMountains
{
   ...
   public class MinotaurMobScene extends BaseContent implements TimeAwareInterface
   {
      ...
      public function victoryMinotaurGangTitFuck() : void
      {
         ...
         outputText("你咯咯地笑着，[say: 我要惩罚你们，直到你们哭着求我原谅……把精液哭得妈妈的奶子和嘴上到处都是。]你说完，两只幸运的牛头人对视了一眼，担忧的表情变成了会心的坏笑。他们一起把手放在你的肩膀上，臀部向内移动，让他们的肉棒以更好的角度操弄你的乳房。你看着那两个慢慢膨胀的龟头从你巨大的肉团之间探出头来，将他们麝香般的先列腺液滴进你的乳沟。[pg]");
         ...
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326) >= 10)
         {
            ...
            outputText("你那窝里最弱小的迷你牛头人正在呜咽，[say: 对、对不起，妈妈，但我实在忍不住了。嗯……你的嘴好烫。我控制不住了！]他抓住你的");
            ...
            outputText("你脑中那麻醉般的泥浆变得更加浓稠，让你的思绪变得迟缓，直到它们变成一团充满精液的糊状物。你咯咯地笑着，在迷你牛头人拔出他那根疲软的肉棒后，舔干净了嘴唇，就在几秒钟后，一股新的黏液又浸透了它们。你乳沟里的那些种马——你都把他们忘了！他们正随着喷涌而出的精液，发出愉悦的咕哝声和低沉的牛叫声。精液像泥石流一样流过你已经湿透的身体，让你从头到脚都沾满了散发着香味的牛头人精液。你那心满意足的儿子中，有一个在你滴着精液的乳房下放了一个瓶子，评论道，[saystart]妈妈，你为什么不留点以后用呢，");
            if(get_player().minotaurAddicted())
            {
            ...
            outputText("你呆呆地点点头，倒在身侧，对着那瓶装满精液的瓶子傻笑。真傻！还有那么多肉棒要榨干，可你已经忘了怎么站起来了！一双强壮的大手把你扶起来，把另一根肉棒塞进你的乳房。真好吃！肉棒又快又狠地操着它们，直到你又吃了一大口奶油般的精液。在那之后你就失去了意识，不过你确信你的乳房和喉咙至少被每个兽人填满并操过一次。就连迷你牛头人也用你的乳房来了第二发。[pg]");
         ...
         else
         {
            ...
            if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326) == 3)
            {
               outputText("你抓住迷你牛头人的肉棒，把这个害羞的兽人拉到你沾满精液的乳房上，毫不犹豫地把肉棒埋进妈妈的乳沟里，那里才是它该待的地方。");
            }
            else
            {
               outputText("你抓住迷你牛头人和");
            ...
            outputText("那只迷你牛头人摇摇晃晃的，完全不习惯有如此湿润温柔的包裹挤压着他的肉棒。他呜咽着，[say: 妈，我……我……我要……呃……射了！] 这只顺从的雌性牛头人不顾一切地喷射着，他那较小的肉棒甚至都没能穿过你的乳沟，但他还是设法弄得比以前更乱了。");
            if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326) > 3)
            {
            ...
            {
               outputText("牛头人们让你穿好衣服，同时幸福地叹息着，显然对这个结果很满意。");
            }
            else
            {
      ...
      public function victoryMinotaurGang() : void
      {
         ...
         if(get_monster().get_HP() < 1)
         {
            ...
            outputText("最后一只牛头人跪倒在地，摇摇晃晃地挣扎着想要站稳。他放弃了，瘫倒在背上，痛苦地哞哞叫着。你看着这些被击败的兽人，为自己的胜利感到欢欣鼓舞。虽然他们很强壮，而且有强效的天然催情剂辅助，但他们根本不是你的对手。有趣的是，即使在半昏迷状态下，他们依然硬挺着。像马一样的牛头人肉棒掀起他们的遮羞布，直指天空，滴落着汁液。[pg]");
         }
         else
         {
            get_images().showImage("minomob-fallen-lust");
            outputText("最后一只牛头人跪倒在地，用足以撕裂布料的力量扯开他的遮羞布，将那根跳动着、饥渴的肉棒暴露在空气中。他开始像他的兄弟一样自慰，将他的先列腺液洒在地上，汇聚成一滩越来越大、黏糊糊的水洼。空气中弥漫着浓烈的气味，但你赢了，而且你保持着足够的理智，如果想走的话随时可以离开。[pg]");
         }
      ...
      public function victoryBJNippleFuckMinotaurGang() : void
      {
         ...
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326) == 3)
         {
            outputText("迷你牛头人，这让那个较小的怪物非常懊恼。");
         }
         else
         {
         ...
         outputText("近乎马屌的肉棒消失在你体内。粗壮滚烫的肉棒在你乳房底部跳动，快感几乎让你瘫倒在地。你抓住孩子们的睾丸，轻轻揉捏着，鼓励他们。作为回应，两只牛头人都把肉棒抽了回去，把龟头从你的乳房里拔出来，然后再次狠狠地插进去。[pg]");
         outputText("你像个荡妇一样呻吟着，抚摸着儿子们巨大的睾丸，享受着每一刻。令你惊讶的是，两只正在快乐交配的牛头人被第三个毛茸茸的身影分开了。一只迷你牛头人从他们中间钻了出来");
         ...
         outputText("你那像女孩一样的迷你牛头人儿子一头扎进你诱人的嘴里。他的肉棒滑过你的嘴唇，越过你的舌头，轻松地进入你喉咙深处，留下一道令人酥麻的先列腺液，涂满了它经过的每一个地方。尽管你最小的孩子的突然出现迫使你较大的孩子们改变了姿势，但这只是把你颤抖的、被侵犯的乳房拉向两侧，展示出淫荡的乳交画面。这三个家伙猛烈地操着你，按照他们自己的节奏抽插着，让你无法集中注意力，只能感受到这猛烈的侵犯。");
         if(get_player().hasCock())
         {
         ...
         outputText("。");
         outputText("[pg]两只正在射精的种马从紧致的洞里拔出肉棒，你痉挛的指尖挤奶般地揉捏着他们的睾丸，无法控制地挤压着沉重的阴囊。一串串强效、掺有药物的精液溅在你的[chest]、肩膀和脸上，就在这时，堵住你嘴巴的肉棒像决堤的大坝一样爆发了高潮。你完全被精液浸透了，从里到外——彻头彻尾的乱伦荡妇。两只最大的牛头人终于耗尽了他们的储备，退后一步，边走边击掌。你那较小的、像女孩一样的男孩花了更长的时间才射完，但当他射完时，你感觉自己被完全填满了。要过很长一段时间你才会渴望");
         if(!get_player().minotaurAddicted())
         {
            outputText("“一顿饭”");
         }
      ...
      public function victoryAllThePenetrationsMinotaurGangBang() : void
      {
         ...
         clearOutput();
         spriteSelect(SpriteDb.get_s_minotaurSons());
         outputText("决定了你想要和你的儿子们一样的东西，你脱下你的[armor]，并指示那些发情、被击败的牛头人脱掉他们剩下的遮羞布。他们服从了");
         ...
         outputText("你摇晃了一下，但还是勉强站了起来。战败的牛头人们对他们的杰作窃笑不已，现在你身上的每一个洞都在滴水。你捏得指关节咔咔作响，用绝对残暴的表情瞪着他们，结束了这一切。兽人们吓得转身就跑，不敢冒犯母亲的怒火。等他们走后，你瘫倒在自己身下那个浸满精液的泥坑里，疯狂地咯咯笑起来。你的儿子们真是群愚蠢的傻瓜！[pg]");
      ...
      {
         spriteSelect(SpriteDb.get_s_minotaurSons());
         outputText("牛头人们走近了，他们的蹄子在靠近你俯卧的身体时扬起了一小阵尘土。你抬起头，鼻子抽动着，深深地呼吸着他们的气味，同时向这群人中最近的一个投去娇羞的目光。他微笑着，手指捏住你的下巴，把你的嘴拉成一个撅起的“o”形。他的另一只手握着他那僵硬的男性器官的沉重肿块——一根超过两英尺长、肿胀、末端张开的肉棒，上面有三道突出的脊。你颤抖着，下意识地舔了舔嘴唇，当它慢慢靠近时，你在空气中尝到了他先列腺液的甜美气味。[pg]");
         ...
         outputText("[pg]你" + get_player().assholeDescript() + "上的压力突然减轻，不是因为牛头人在后退，而是因为龟头冠状沟的一部分突然滑过了你那紧绷洞口的括约肌环。你头晕目眩，试图放松，与括约肌对入侵者本能的收紧反应做着抗争。身后传来一声满意的低鸣，插入你[asshole]的牛头人猛力向前推。它的龟头冠状沟伴随着一声清晰可闻、令内脏震荡的\"噗\"声滑入其中。");
         ...
         {
            outputText("迷你牛头人听到这声音咯咯地笑了起来，他抚摸着自己，发出呜呜的声音，等待着加入的许可。");
         }
         outputText("当两根牛头人的肉棒都推得更深，完全、彻底地用他们乱伦的坚硬将你像烤肉一样串起来时，你除了发出咕噜声什么也做不了。[pg]");
         ...
         outputText("你的牛头人主人们开始用长长的、刮擦孔洞的抽插来回拉锯他们跳动的肉棒。这本该是痛苦的，但它只是煽动了你被催情剂点燃的欲火。你的小穴");
         ...
         outputText("然后粗暴地将他的肉棒深深埋入你的嘴里，直达根部。他的先列腺液停止了分泌，随着这只野兽那带有三道肉棱的阴茎开始在你体内膨胀，你下巴上的睾丸也开始跳动。你的下巴被微微撑开，你感觉到一大团精液沿着他阴茎底部的尿道膨胀起来。这团精液向着你的肚子推进，从他的龟头处爆炸性地喷射而出，当你的肠胃接收到第一发牛头人的精液注射时，发出了清晰可闻的咕噜声。[pg]");
         outputText("在达到高潮前夕的快感巅峰时，牛头人的龟头猛然膨胀，将你的食指死死堵住。毛茸茸的阴囊在你的下巴上跳动，里面沉甸甸的睾丸随着它们将催情、夺人心智的货物排空到你最深处而慢慢缩小");
         if(get_player().cor >= 66)
         {
            outputText("。你对此感到无比高兴");
         }
         outputText("。随着精液从你下巴上那可怜的、肿胀的睾丸中不可阻挡地排空，那些挤过你那兴奋地抽动着的舌头的精液团块慢慢变得越来越小。它们微微颤抖了一下，然后停了下来，牛头人终于退了回去，慢慢变软，以便从你那被蹂躏的喉咙里拔出来。[pg]");
         outputText("一旦重获自由，这只野兽便将他粗大肉棒顶端的污物抹在你的嘴唇上。他把你推向那个正在侵犯你[asshole]的家伙，让他支撑着你。你对这种粗暴的对待发出呻吟，同时舔舐着嘴唇上美味的精液。你喉咙和胃里强效的精液已经让你无法进行任何比“找精液”和“操”更复杂的思考。迷你牛头人犹豫地走上前，将他那沾满先列腺液的坚硬肉棒放在你手里让你抚摸，同时他呜咽着，[say: 大哥，求你了，我能操她的逼吗？][pg]");
         get_images().showImage("minomob-gangbang");
         outputText("[say: 今天不行，小矮子。]你身后的牛头人哼了一声。他用沾满汗水的手臂将你举起，转过身来，将你那至今未被玷污的女性私处放在他那膨胀的、准备爆发的肉棒顶端。他得意地笑了笑，把你的脸按在");
         ...
         outputText("同时他笑着说，[say: 你可以操妈妈的后门。我已经帮你开好路了。]迷你牛头人的脸上闪过一丝沮丧，但这并没有阻止他走到你身后，将他较小的肉棒对准你那大张着、湿漉漉的屁眼。[pg]");
         ...
         outputText("我感觉要来了，准备好了吗，妈？[sayend]兽人问道。你热情地点点头，前后摇晃着身体，而迷你牛头人则抓住你的[ass]，操着你静止不动的身体。[pg]");
         outputText("一个巨大、肿胀的肉块撑开了你的阴唇，挤出了一股淫液和爱液。");
         get_player().cuntChange(60,true,false,true);
         outputText("龟头在射入你子宫时猛然膨胀；子宫内精液的沉积绽放出温暖，让你的肌肉变得松弛，并引发了你自己的高潮。你的小穴起伏着，挤压着入侵者，而你那被肉棒塞满的后庭也随着高潮的收缩而配合着。你身后的迷你牛头人呜咽着，用他那相对轻盈的身体所能达到的最大力度将自己完全没入，他的睾丸拍打着他兄弟那慢慢变空的精囊。");
         if(get_player().hasCock())
         {
            outputText("" + get_player().SMultiCockDesc() + " 在牛头人的肚子上爆发，微弱地喷出");
            ...
            {
               outputText("一股源源不断的精液流，用你那浪费的、劣质的种子彻底浸透了牛头人的皮毛和睾丸。");
            }
         }
         ...
         outputText("被快感分散了注意力，你几乎没有意识到肉棒已经从你被捣烂的小穴中拔出。你被扔到泥土上，而仍在射精的迷你牛头人被他那膨胀的肉棒拉倒，重重地压在你身上。他在射精时亲吻和舔舐你，温柔地用爱意沐浴你，同时用你的身体满足自己。对于这样一个野兽般、堕落的生物来说，他真的是一个温柔的情人。[pg]");
         outputText("迷你牛头人留在你体内，伸手揉捏你肿胀、发红的下体嘴唇，同时他在你深处变软。这种犹豫让他的精液有时间通过你的肠道内壁吸收。一旦他拔出，你周围的世界都在旋转，但你试图爬向");
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326) <= 3)
         {
            outputText("那个给了你第一剂药的牛头人。也许他准备好给你更多了？他假笑着，用他柔软的肉棒拍打你的脸。你醉醺醺地咯咯笑着，开始舔他的睾丸——他们一定有更多给你的！");
         }
         else
         {
            outputText("一个还没来得及占有你的牛头人。野兽笑着，把你拉到你的膝盖上。");
            if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326) <= 5)
            {
      ...
      public function negotiate() : void
      {
         ...
         outputText("那个温顺、安静的“迷你牛头人”最后开口了。[say:求、求你了，妈妈？我从来没有在真正的逼里射过……][pg]");
      ...
      public function minotaurGangBadEndPart3A() : void
      {
         ...
         outputText("停下来后，你把头和手臂穿过洞。它们内衬着带垫子的皮革，这让你非常高兴。你诱惑地扭动了一下你的[ass]，但换来的只是一记粗暴的拍打。你在失望和喜悦的混合中呻吟着，转过头看着其他女孩就位。在队伍的最后，迷你牛头人羞愧地红着脸，任由自己被塞进位置。可怜的男孩。只要有机会，你就会尽量照顾他，但其他人对他总是那么粗暴。随着部落里新成员的增加，现在的后宫根本不够满足他们所有人。看来目前，他只能被迫成为女孩中的一员了。[pg]");
      ...
      public function minotaurGangBadEndPart2B() : void
      {
         ...
         outputText("你肉棒周围有节奏的收缩让迷你牛头人兴奋起来。他沉重的睾丸在你的身体上弹跳，翻滚摇晃，通过插在你小穴里的粗大肉棒泵出大量的精液。你能感觉到他的龟头在你的子宫颈处紧绷，尿道泵出如洪流般的精液");
         ...
         outputText("你的儿子叹了口气，瘫倒下来，他的肉棒慢慢地从你被蹂躏的阴户中滑出，伴随着一声湿润的“啵”声拔了出来。一条白色的河流从你的身体里滚落出来，进一步弄脏了房间的陈设。你因这种感觉而颤抖，因为它引发了一系列微小的、迷你高潮。当你沉浸在快感中时，迷你牛头人离开了，他缠腰布里的凸起明显变小了。与此同时，其他女孩挤在你周围，舀起她们能收集到的你男孩的液体爱意，并把它塞进她们贪婪、淫荡的嘴里。牛娘勤奋地开始工作，用她巨大的舌头在你的[vagina]上舔舐，舀出她能得到的每一滴。你高潮在她的脸上，把精液和你女性的淫液溅了她一身。她微笑着亲吻你仍然敏感的阴蒂，让你陷入了令人昏厥的高潮。");
         get_player().orgasm("Vaginal");
      ...
      public function minotaurGangBadEndPart2A() : void
      {
         ...
         outputText("迷你牛头人低头看着你，他那怪物般的口鼻上带着感激的表情。当他骑上你时，他淫荡地让舌头挂在嘴外，几滴唾液滴落，因为他在占有你的激情中忘记了自己，这打破了这幅画面。当他推进时，他不断滴落的先列腺液形成一条小溪，从他的粗壮处流出，最终将他的顶端顶在你的子宫颈上，他包皮松弛的皮肤似乎在抚摸你的阴唇和阴蒂。你幸福地尖叫起来，感觉到温暖从你的小穴向外蔓延，因为他更多的精华滴入你的体内。[pg]");
         outputText("你已经感到一阵愉悦的嗡嗡声和刺痛感，你抓住他的臀部，将自己贴向他，让你们俩在这个铺满枕头的房间里弹跳。当你被她们渴望的人狂野地操弄时，激情的咕哝和呻吟声挑逗着其他女孩。你的[vagina]就像一个欲望的熔炉，里面渴求的火焰随着那根奇妙的牛头人肉棒的每一次抽插而变得越来越热。你那最小的兽人喘着粗气，尽他最大的努力操你，虽然他的阴茎远没有他哥哥肿胀的肉棒那么大，但他滴入你子宫的浓稠、积蓄已久的药物让你一直处于高潮的边缘。[pg]");
      ...
      public function minotaurGangBadEnd() : void
      {
         ...
         outputText("这个地方似乎很舒适，尽管其他女孩似乎用几乎掩饰不住的嫉妒甚至愤怒的眼神看着你。一个苗条的身影从阴影中走出来。你认出他是你孩子中最小的一个，迷你牛头人。他一丝不挂，虽然他的信息素比他体型更大的同类要弱，但仅仅是他的出现就足以让你的小穴湿透。其他女孩向他爬去，抓着他的腿，向他承诺她们小穴的天鹅绒般的紧致。他的鸡巴变得坚硬如石，立刻开始在她们身上滴下液体，他颤抖的睾丸和肿胀的鸡巴里跳动的血液，痛苦地显露出他的需求。[pg]");
         outputText("这个小个子从女孩们中间挤了过去，无视她们失望的撅嘴，来到你面前。[say:嘿……其他人还在庆祝把你加入后宫。我想也许我可以确保你适应了，而且……嗯，如果你不介意的话，我真的憋坏了。他们通常不让我进后宫，]迷你牛头人承认道，回头看着门，眼神中带着一丝担忧。[pg]");
      ...
      public function minotaurDeFeet() : void
      {
         ...
         {
            outputText("你被彻底击败了。你遍体鳞伤，疲惫不堪的身体几乎无法动弹，颓然倒在地上。牛头人们踩着沉重的步伐靠近，微笑着期待着即将发生的事情。你张大嘴巴，盯着他们脱下那浸满先列腺液的微小遮羞布，露出那让他们这个种族如此出名的巨大、独特的阴茎。不知是巧合还是恶意的安排，其中一块破布不偏不倚地落在了你的脸上，你惊讶地倒吸了一口凉气。就像一道闪电劈中你的脊椎，性欲以雷霆万钧之势击中你，当你把那块黏糊糊的布从脸上甩开时，你被震得向后退去。所有抵抗的念头都被你那渴望的潮水彻底冲刷殆尽，你张开[legs]，让自己成为一个更容易的目标。在血管中流淌的性欲赋予了你力量，你撕下你的[armor]，焦急地等待着这些兽人接下来的计划。[pg]");
         }
         else
         {
            ...
            if(get_player().hasCock())
            {
               outputText("" + get_player().SMultiCockDesc() + " 变硬并悬垂在地面上方，与你饥渴的阴户产生共鸣，渗出液体。当然，它很可能会被无视——发情的牛头人对别人的阴茎没什么兴趣。");
            }
         ...
         else
         {
            ...
            else
            {
               if(!get_player().minotaurAddicted())
               {
                  ...
                  outputText("[sayend] 你的脸颊因为这淫荡的暗示而泛红，他的话唤起了你被无数牛头人填满小穴、疯狂配种的愉悦记忆。[pg]");
                  outputText("[say:你这个肌肉长进脑子里的蠢货，妈妈才不是为了那个来的。她可能是来被精液塞满，直到感觉脑浆都要从耳朵里流出来为止，]第二个熟悉的声音嘲讽道。[say:妈妈知道和牛头人做爱有多爽，我们会把她串烤的，对吧男孩们？]这是你第二大的儿子，而且他不是一个人——这里有一整个牛头人部落。你数了数，至少有" + Utils.num2Text(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326)) + "个，在你周围围成了一个由肌肉和皮毛组成的坚不可摧的圆圈。你不可能逃脱，除非先撕开一个缺口。[pg]");
                  outputText("天哪，你湿透了。");
                  if(get_player().wetness() >= 5)
                  {
                  ...
                  outputText("许多缠腰布都湿透了，几乎滴下了牛头人大量的先列腺液。你可以看到他们巨大、肿胀的睾丸的曲线和隆起——看起来这些可怜的家伙为你攒了相当大的一发。一个在牛头人精液的海洋中迷失自我的幻想在你的脑海中闪过……[pg]");
                  outputText("不！");
                  if(get_player().cor < 33)
                  {
                     outputText("你不能这么想！当然，你生下的牛头人足以建立这个庞大的发情怪物部落，但你是个勇者！");
                  }
                  else if(get_player().cor < 66)
                  {
                     outputText("你不该这么想！当然，你体内已经有过足够多的牛头人，足以繁衍出这个肌肉发达的兽人部落，但你还有任务要专心完成。");
                  }
                  else
                  {
               ...
               else
               {
                  ...
                  {
                     outputText("回来要更多精液？我打赌你下一个儿子生出来会是个吸精的迷你牛头人。我们这里正好需要另一个肉便器。");
                  }
                  else
                  {
      ...
      public function loseToMinoMobVeryPregnant() : void
      {
         ...
         outputText("随着一阵强烈的冲击震撼你的身体，疼痛在你的[ass]蔓延开来。你本想回头看一眼，但嘴里的阴茎固定住了你的头，同时开始在你的喉咙里进进出出。又一记响亮的巴掌拍在你的屁股上，这次你清楚地感觉到那只毛茸茸的牛头人大手就是让你不适的源头。嘴里的肉棒向后抽退，虽然没有完全离开你的嘴，但也足以让你通过鼻子吸入甜美、甜美的空气。它再次猛插进来，恰好伴随着又一记把屁股打红的巴掌，将你最后几英寸的距离推向那对汗津津的蛋蛋。[pg]");
         outputText("你抬起头，色眯眯地盯着悬停在离你仅几英寸远的" + Utils.num2Text(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326) - 1) + "根肉棒。甚至连那只迷你牛头人也在那里，看到他那淫荡、彻底堕落的母亲，他那较小的肉棒滴下了渴望的甜美汁液。这让你兴奋极了，甚至比你肚子里的精液还要让你兴奋。你伸出手抓住两根肉棒开始套弄，用湿热的先列腺液润滑着手指。");
         ...
         outputText("[pg][say: 看来妈妈真的很享受呢，是吧？看看她，深喉着还像个瘾君子一样流口水。你有什么想为自己辩解的吗，妈妈？哦？你宁愿继续吸鸡巴也不愿说话？好吧，那行；继续吸吧，我想我兄弟马上就要给你个礼物了，]第二大的牛头人预言道。[pg]");
         outputText("当感觉到那龟头在你的食道中膨胀，将你的喉咙撑到极限时，他预言般的话语应验了。葡萄柚大小的睾丸蹭着你的下巴，紧紧贴着牛头人的身体，在阴囊内脉动收缩。精液在肉柱中泵送，撑胀了牛头人的尿道，直到最后伴随着可听见的咕噜声，从马眼喷射进你的肚子里。兽人向后抽退，粗大的顶端刮过你的喉咙，在腾出的喉咙通道里留下一道精液的痕迹。最后，它挣脱了你饥渴的双唇，在上面涂满了浓稠的精液，并在你的脸上溅满了大团的种子。[pg]");
         ...
         outputText("你哼哼着，[say: 很好，]虽然发出的声音更像是，[say: 嗯嗯嗯嗯嗯。]你被药物麻痹的视线此刻全都是泡泡和联觉的彩虹。当另一只牛头人继续拍打你的屁股时，他恶毒地轻笑起来。那个主导的牛头人抓住你的");
         if(get_player().horns.value > 0)
         {
            outputText("角");
         }
         ...
         outputText("[pg]疯狂的操脸以最后爆发性的射精结束，粘稠的精液喷射进你已经饱满的肚子里。这个兽人冷酷地抽身。他拔出的速度很快，以至于他大部分的精液都喷到了你沾满白浊的脸上和[hair]上。其中很多流下来浸透了你的[chest]和巨大的、怀孕的肚子。你现在看起来更像是一个涂满奶油的甜甜圈，而不是一个人，当你脑海中浮现出自己巨大的、怀孕的身躯躺在牛头人精液水坑里，而兽人们把你的脸当成精液容器的画面时，你几乎要高潮了。[pg]");
         outputText("[say: 你的喉咙真紧，妈妈……对于一个婊子来说，]牛头人一边后退一边说。你从他语气中的赞美之词中高兴地笑了起来，你太嗨了，以至于没有意识到这实际上是一种侮辱。片刻之后，你甚至连这也忘记了，因为下一根肉棒压在了你的嘴唇上。");
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326) < 8)
         {
            outputText("是那个迷你牛头人的！他的肉棒远没有他兄弟们的那么巨大，尽管它仍然大到足以让你感到被撑开。在经历了你不得不忍受的激烈深喉之后，较小的肉棒和它喷出的先列腺液感觉像是一种香脂，舒缓了你酸痛的、涂满精液的喉咙。你急切地吞下它，无视你肚子的饱胀感，试图从你女性化的儿子那里榨取每一滴。迷失在你的口交天堂中，你放松下来，让肉棒将你固定在原地，当你的食道在深深插入的肉棒周围起伏时，睾丸拍打着你的下巴。[pg]");
            outputText("迷你牛头人呻吟着，[say: 谢-谢谢……哦……我嗯——哦——现在射可以吗？][pg]");
            outputText("你抬头看着他，把舌头伸进他的包皮里，舔去他肉棒最深处的汗水，同时微微点头表示同意。他哞哞叫着，不稳地颤抖着，像破布娃娃一样摇晃着你，而你把他在你喉咙里跳动的肉棒含住。他紧绷的、很少使用的阴囊微微跳动了一下，然后他的肉棒将一股稳定的精液射进你充满精液的胃里。你惊叹于他的射精与他兄弟们巨大、脉动的喷发有多么不同。迷你牛头人的高潮不知何故更加柔和，几乎是顺从的，它只是一次慵懒的释放，泄漏并滴落着它的精液之河。[pg]");
         ...
         {
            outputText("这是迄今为止最大的一个！你抬头看看你众多儿子中哪一个天赋异禀。他甚至没那么高。他只是一个看起来很普通的牛头人，但他妈的**巨根**。他龟头的膨大是最糟糕的部分——它太宽了，你担心它会使你的下巴脱臼。当它进入你的喉咙，进一步拉伸你可怜的脖子时，你注意到他也没有像他兄弟那样漏液，尽管他的睾丸看起来大到足以让他在走路时感到极度不适。[pg]");
            ...
            outputText("你伸出手，用手掌抓住那两个出汗的球体，开始抚摸、挤压和揉捏那两个可怜的、憋坏了的精液罐。它们在你的握力下颤抖，牛头人的龟头在你体内膨胀得更宽，牢牢地固定在原位。你觉得即使你想拔也拔不出来了。谢天谢地，你没有这种想法。你继续你的睾丸榨汁，当你感觉到第一股先列腺液滴入你的肚子时，你高兴地“嗯嗯”叫着。[pg]");
            ...
            outputText("天赋异禀的牛头人用他剩下的精液给你洗了个澡，用快速、无情的抽插在他的肉棒上泵动，用精液把你从头到脚浸透，一直流到你下面不断扩大的水坑里。你醉醺醺地咯咯笑着，倒在身侧，你紧绷的肚子从你落入的水坑里溅起一阵波浪。你放声大笑，让你的手在你充满精液——和后代——的身体上游走，特别注意你的[chest]和鼓得像鼓一样的腹部。[pg]");
      ...
      public function forceMinitaurToGiveOral(param1:Number = 0) : void
      {
         ...
         outputText("牛头人看到这一幕精神一振，但你对他们充满希望的表情嗤之以鼻。[say:我希望你们别指望能得到这些。给我滚出去，别让我再抓到你们试图伏击我！]疲惫不堪的他们拖着身子站起来，走的时候还用色眯眯的眼神盯着你的女性特征。不过，你用[foot]踩住了那只迷你牛头人的尾巴。他的嘴巴出奇的可爱，你打算好好利用一下。[pg]");
         ...
         outputText("这个可悲的迷你牛头人已经无可救药地对兄弟们的精液上瘾了。你耸了耸肩，厌倦了他的抱怨，只想得到你极度渴望的满足。[saystart]抱怨你的问题并不能让它们消失。现在把你的嘴用起来，然后");
         if(param1 == 0)
         {
            ...
            outputText("迷你牛头人的舌头防御性地向外伸出，轻松地滑入你的阴道口。它非常非常长，而且异常湿润。他灼热的呼吸拂过你的[clit]，当你把他的牛鼻子压在你的阴唇上时，周围的空气都起雾了。他湿润鼻子的凉意与他呼吸和舌头的热度之间的温差让你发狂。这个女性化的兽人热情地适应了他的任务，饥渴地舔舐和吸吮着你的[vagina]");
            ...
            outputText("[pg]你开始将你的[hips]在迷你牛头人的兽吻上起伏，在这强迫的口交中摩擦并快乐地呻吟。");
         ...
         else
         {
            ...
            outputText("肉棒，最后停在系带处。他舌头湿润的热度似乎渗入了你的阴茎肉里，让你感觉自己都要融化了，但这只迷你牛头人才刚刚开始。他张大嘴巴，将你的" + get_player().cockHead() + "含入口中；它在里面残留的平坦舌头上性感地摩擦着，他熟练地吸吮着它，直到你的先列腺液滴在他的舌头上。他因此颤抖了一下，但这并没有让他");
            if(!get_player().isTaur())
            {
               outputText("移开视线或");
            }
            ...
            if(get_player().hasVagina())
            {
               outputText("迷你牛头人开心地哼着歌，将一根手指滑入你的[vagina]，虽然你没要求，但这额外的刺激只会加剧你的渴望。");
            }
            ...
            outputText("这个迷你牛头人鼻子上积着一滩精液的样子，看起来其实还挺可爱的。[pg]");
         }
         outputText("完事后，你把他推开，让他倒在地上，他的脸上沾满了你的淫水。这个可怜的迷你牛头人勃起得比以往任何时候都要厉害，虽然他的肉棒看起来很诱人，但你已经满足了。你穿好衣服，给这个可怜的男孩飞了一个吻。[say:要乖乖听妈妈的话，好吗？]当你漫步离开时，他呆呆地点了点头。");
      ...
      public function disciplineEldestMinotaurSon() : void
      {
         ...
         clearOutput();
         spriteSelect(SpriteDb.get_s_minotaurSons());
         outputText("你那些任性的儿子以为他们能偷袭你。他们那大男子主义的虚荣心蒙蔽了双眼，没有意识到他们根本不是你的对手。你叹了口气，意识到他们下次可能还会试图哄骗你和他们做爱。作为一个母亲该怎么办呢？当你俯视着他们伤痕累累的身体时，他们抬起头看着你，眼中充满了渴望，肿胀的肉棒还在抽动。你捏得指关节咔咔作响作为回应，让你那粗野的后代吓得瑟瑟发抖。他们挣扎着站起来，开始匆忙撤退。你最大的牛头人儿子在绝望地试图逃离母亲时，被自己的蹄子绊倒了。当他试图重新站起来时，你把重量压在他身上，把他按住。他转过头，看到你踩在他的尾巴上，吓得浑身发抖。[pg]");
         ...
         outputText("对儿子的回答感到不满，你立刻一巴掌扇得他晕头转向，提醒他谁才是真正掌权的人。这一巴掌的力度让他像个迷你牛头人一样傻笑，毫无疑问，他平时经常虐待这种生物。有时候，母亲必须给儿子一些严厉的爱。[pg]");
      ...
      public function analSpearSemiPregMinotaurGangbang() : void
      {
         ...
         outputText("，不是吗？[sayend] 相对较小的迷你牛头人在说完时畏缩了一下，以为会挨他哥哥们的一记耳光。令人惊讶的是，并没有挨打。最大的那个呼出一口气，低沉的声音听起来更像是山体滑坡而不是呼吸。他承认，[saystart]我应该因为你打断我而操烂你的屁股，但你是对的。妈妈的小穴是禁区，兄弟们，我们不会弄坏");
         if(get_player().get_pregnancyType() == 2)
         {
            outputText("我们的小弟弟");
         }
         ...
         outputText("。[sayend]");
         outputText("[pg]其中一个牛头人抓住你的下巴，把它掰开，迅速将他流着口水的肉棒塞进你的嘴里。[say: 好吧，我们还可以堵住她的嘴和她的屁股。我先占她的嘴。][pg]");
         ...
         outputText("[say: 操，妈，你是怎么保持喉咙这么紧，还能像个专家一样吞下肉棒的？]你目前口交对象的那个声音问道，同时他粗重的手指滑过你的[hair]。你正忙着舔舐那根天堂般的肉棒，感受着尿道随着每一滴催情剂释放到你饥饿的胃里而膨胀。那匹种马的手指扭动着你的头发，只是稍微有点痛，把你从寻找药物的恍惚中拉出来，让你发出咕噜咕噜的赞同声。牛头人得意地笑着，大喊道，[saystart]来吧，谁来操她的屁股。");
         if(!get_player().minotaurAddicted())
         {
         ...
         outputText("[say: 应该说别急着吃马屌，]你面前的牛头人开玩笑道。[pg]");
         ...
         if(get_player().hasFuckableNipples())
         {
            ...
            outputText("[say: 哦，哇……]迷你牛头人的声音说道。[say: 我想知道我能不能用这个……][pg]");
            outputText("你向下瞥了一眼，看到你最小的牛头人儿子正鬼鬼祟祟地四处张望，寻找他的兄弟们。他脸上带着心虚的笑容，一只手伸进你的乳头穴里，另一只手抚摸着他那根跳动的肉棒。他跪下来，将肉棒向上指，试图将它引导进你的乳头穴里，尽管你上方那两个巨大的牛头人正前后摇晃着你，让你的身体剧烈起伏。在一个短暂的间隙，他抓住机会，将他那小巧的龟头塞进你的[nipple]里。随着上方两人的动作再次加快，他的龟头在你摇摆的胸部里被旋转和揉捏，他几乎立刻就向后倒在手上。[pg]");
            outputText("[say: 哦……哦哦，]他呻吟着，声音比之前更大了。[say: 太棒了，妈妈……你……真是太棒了。][pg]");
            outputText("不幸的是，现在能听到他狂热赞美的不仅仅是你。操着你嘴巴的野兽低下头，正好对上了迷你牛头人的眼睛，此时他的头正因快感而后仰。当你感觉到他的肉棒因为惊慌而更深地塞进你的乳头时，你翻了个白眼，但他哥哥只是");
            if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,326) < 7)
            {
               outputText("摇了摇头。[say: 你只是在给自己找麻烦，小婊子。记住，妈妈之后就轮到你的洞了。]迷你牛头人恋恋不舍地抽出肉棒，爬开几步，坐在那里生闷气。");
            }
            else
            {
               outputText("朝部落里一个闲着的成员点了点头，那人伴随着“啵”的一声把这个小个子从你的乳头穴里拔了出来，然后把他带走了。发情的牛头人队伍在他经过后分开，然后又重新排好。从他们身后，你可以听到痛苦的尖叫声，然后是狂喜的呻吟，因为你最小的儿子也加入了你这种被过度操弄、被药物迷幻的狂喜状态中。");
            }
            outputText("[pg]");
         }
         else if(get_player().biggestLactation() >= 1)
         {
            ...
            outputText("一个孤单的乳房被一只更柔软、更女性化的手抓住了，这时你才意识到，正在吸吮你的是这窝里最小的那个，你的迷你牛头人儿子。他一边吸吮着你充满乳汁的球体，一边抚摸着它们。当他的哥哥们开始前后摆动臀部时，他把每个乳房都吸空了。他们把你当成家乡伐木工用来砍树的那种奇怪的双人锯一样使用，而你很喜欢这样。饥饿的迷你牛头人吸空了一个乳房，又移到另一个乳房上，吸吮得既强烈又温柔，小心翼翼地不弄疼你，尽管他那些体型更大的亲属似乎一心想要摧毁他们选中的孔洞。[pg]");
         }
         else
         {
            ...
            outputText("一个孤单的乳房被一只更柔软、更女性化的手抓住了，这时你才意识到，正在取悦你乳头的是这窝里最小的那个，迷你牛头人。他充满爱意地抚摸着你的[chest]，手指划过你的[skinfurscales]。与此同时，他的哥哥们开始前后摆动臀部，像家乡的一对伐木工一样前后摇晃，试图用双人锯砍倒一棵树。最小的儿子温柔地吸吮和舔舐着，不想弄疼你，尽管他那些体型更大的亲属似乎一心想要摧毁你身体的两个孔洞。[pg]");
         }
         ...
         {
            outputText("，迷你牛头人的嘴唇也从你的[nipple]上松开");
         }
