package classes.scenes.areas.highMountains
{
   ...
   public class CockatriceScene extends BaseContent
   {
      ...
      {
         clearOutput();
         outputText("当你决定如何处置这只鸡蛇时，你的下半身因兴奋而发热，你意识到你很难做到任何事情，因为你的半人马形态与许多人的装备不太兼容。你简短地环顾四周，注意到山腰上有一个壁龛，这让你产生了一个绝妙的主意。你可以利用岩石把他固定在合适的高度，用他那长满小疙瘩的爬行动物肉棒操你的屁股。这可真是进退两难啊！[pg]");
      ...
      public function cockatriceDriderButtFuck() : void
      {
         ...
         outputText("当你决定如何处置这只鸡蛇时，你的下半身因兴奋而发热，你意识到你很难做到任何事情，因为你的蜘蛛形态与许多人的装备不太兼容。你简短地环顾四周，注意到山腰上有一个壁龛，这让你产生了一个绝妙的主意。你可以把他绑在里面，让他用那根长满小疙瘩的爬行动物肉棒操你的屁股！[pg]");
