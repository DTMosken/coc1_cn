package classes.scenes.areas
{
   ...
   public class GlacialRift extends BaseContent implements IExplorable
   {
      ...
      public function amarokEncounter() : void
      {
         ...
         outputText("当你的双脚穿过贫瘠的苔原时，你无法摆脱被监视的感觉。你的偏执占了上风，你停下来倾听附近是否有动静。你什么也没听到。为了确定，你转过身，什么也没看到。你嘲笑自己的愚蠢，继续走着，现在一只手放在你的" + Utils.cnName(get_player().get_weaponName()) + "上。仿佛是约定好的一样，你听到身后传来一声咆哮。你猛地转过身，用你的[weapon]攻击，勉强阻止了一只巨大的狼将你扑倒。在它黑色的皮毛和金色的眼睛之间，你不太确定你是怎么错过它的。不过这无关紧要——这只狼，绝对是一只阿玛洛克，已经恢复过来，正在准备下一次攻击。是时候战斗了！");
