      ...
      public function wandererDemonEpilogue() : void
      {
         ...
         if(get_player().hasStatusEffect(StatusEffects.WandererDemon))
         {
            if(get_player().statusEffectv1(StatusEffects.WandererDemon) == 0)
            {
               ...
               outputText("[say: 我顺道过来，想为这件事谢谢你，]露西娅发出满足的呼噜声，在指关节上平衡着一块紫色的水晶。她说话时，水晶在[sun]光下闪烁着光芒，[say: 你看，当一个人类或其他凡人生物最终开始渴望堕落和快乐胜过一切时，他们就会变成恶魔。这个过程会留下一块单一的莱希石水晶——就是这块水晶。这是一种你无法理解的能量源，我要感谢你把它给了我。][pg]");
