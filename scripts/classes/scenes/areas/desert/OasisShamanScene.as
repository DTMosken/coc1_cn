package classes.scenes.areas.desert
{
   ...
   public class OasisShamanScene extends BaseContent implements SelfDebug, SelfSaving
   {
      ...
      public function submitOasisShaman() : void
      {
         ...
         clearOutput();
         outputText("抬起头，你看到他眼中充满了好色的饥渴。他以最原始的方式[i:渴望]着你。一阵猛烈的动作将他的嘴唇印在你的嘴唇上；他的味道证明和他的话语一样令人陶醉，你的脸完全红了。他闻起来有大海、沙子和几乎被洗掉的淡淡汗水味。有力的双臂将你紧紧抱在怀里，他的双手抚摸着你的背。当他的嘴唇移动时，你倒吸了一口凉气，当它们顺着你的脸颊啄到你的脖子上时，你尖叫起来。尽管你的鳃通常非常敏感，甚至会感到疼痛，但现在却没有灼烧感。不，你的身体在这种感觉下蜷缩颤抖，而性唤起则飙升到了绝望的高度。而他知道这一点。");
