package classes.scenes.areas.desert
{
   ...
   public class AntsScene extends BaseContent implements TimeAwareInterface
   {
      ...
      {
         clearOutput();
         outputText("你醒了，但不确定自己睡了多久；几个小时或者可能是一天，在这个地方很难说。试图站起来是个错误……你感觉你的大脑刚刚和一个牛头怪进行了三回合的拳击。当你摇摇晃晃地试图保持平衡时，世界在旋转。不管菲拉对你做了什么，似乎都在消退，这让你的大脑感到空虚。");
      ...
      public function keepHidden() : void
      {
         ...
         if(get_player().hasCock())
         {
            ...
            outputText("[pg]就在你快要射精的时候，你目睹其中一个恶魔把她翻了个底朝天。她迅速像蜘蛛一样蜷缩起来，把所有的四肢向内拉，把腹部蜷缩到胸前，徒劳地试图保护她的女性特征。恶魔对他的朋友们说了些你听不太清楚的话；一些完成的参与者跳起来服从的方式给了你第一个线索，这里站着这群人的首领。下属们帮助受惊的蚂蚁“打开”，把她的腹部从胃部拉开，把她的双腿分开；然后，主要恶魔把他巨大的肉枪放在她阴道的嘴唇上。你可以看到她的身体，被麝香的精液和性待遇唤醒，已经给出了独立于她意志的答案；阳光在她双腿之间的湿润处闪烁。");
      ...
      public function firstAntColonyEncounter() : void
      {
         ...
         outputText("[pg]她那沙褐色的短发似乎乱蓬蓬的，纠结在一起，尽管一顶带有悬垂宝石的失去光泽的金色头饰在阳光下闪闪发光，给头发增添了一些风格。你想知道她是在搜查手推车时找到的头饰，还是她以前就有的。");
      ...
      public function birfingSexWithAntsForDasLadies() : void
      {
         ...
         if(get_player().cor < 75)
         {
            ...
            outputText("[pg]几乎立刻就感觉到了连接，它像挥舞着战斧的牛头怪一样重重地击中了你。情感的烟花在你身上绽放；很明显，你的大脑完全没有准备好迎接这阵情感的洪流。");
