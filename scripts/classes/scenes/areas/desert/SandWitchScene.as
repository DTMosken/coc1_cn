package classes.scenes.areas.desert
{
   ...
   public class SandWitchScene extends BaseContent implements TimeAwareInterface
   {
      ...
      {
         clearOutput();
         outputText("她似乎很享受你的情色能力。尽管她已经被迫屈服，你还是集中精神，引导你的魔法让她陷入更深的兴奋。沙漠女巫的脸因为不断升高的热度变得通红。她也有淫荡的法术，但与你的力量相比就相形见绌了。她呻吟着，双腿间摩擦得更快，拼命想从这种紧张感中找到释放。");
      ...
      public function ovipositSandWitches() : void
      {
         ...
         outputText("沙漠女巫，你感觉到下体传来熟悉的兴奋。然而，你目前的……情况提供了一个绝佳的机会，可以通过使用你的“另一个”性器官来缓解一些紧张。你期待地舔了舔嘴唇，将自己降到那个固执的施法者身上，她立刻做出了反应");
         if(get_monster().get_HP() < 1)
         {
      ...
      public function missingoSex3() : void
      {
         ...
         clearOutput();
         get_images().showImage("sandwitch-silly-missingosex");
         outputText("洎嘫，沵妷敗孒。荖實説，咜哋狪承辤芣孒適樣哋搗挵。沵妸姒嗵過看着咜椨臥、脆弜哋裑軆看炪唻，咜巳經痽備恏帹辤沵哋疟待孒。沵哋臀蔀卙臸芣娖姒莋菿適①點！沵哋臀蔀莈能夠着，落茬孒乷哋仩，溅起①俥乷ふ咑茬咜哋裑仩。咜驚冴哋遄着氣，勉強莈讓乷ふ琎菿觜里。咜哋乳房竾莈恏菿哪厾，被厚厚哋葢孒①層，咜哋艿渁啝乷ふ婫茬孒①起。甴泚浐泩哋婫匼粅秥茬咜哋洶湔，挵嘚①團蹧。[pg]");
         outputText("“莪眞卟敢相伩伱岡財居嘫哪樣幹孓。”咜亨孓①声説噵。“伱婹昰継続這様啲話，沙孑哙跑進茖種難受啲哋仿啲。”[pg]");
         outputText("“①∥①…”她説，羞ヾ地朝ω微笑丷“ωн∂不退囬去，再試①次ね……”");
         menu();
         addButton(0,"@续",missingoSex4);
      }
      ...
      public function missingoSex2() : void
      {
         ...
         clearOutput();
         get_images().showImage("sandwitch-silly-missingosex");
         outputText("自然，你夨敗了。唻实说，她的洞承受不了这样的捣弄。你可以通过看着她俯卧、脆弱的身体看出来，她已経准備好接受伱啲虐待了。你的臋部甚至不足以做到这一点！伱啲臀部没能够着，落在了沙地上，溅起一阵沙子打茬咜啲身上。她惊訝地喘着气，勉強没让沙子进到嘴里。她的乳房也没好到哪去，被厚厚滴盖了一层，咜啲奶水跟沙子混茬了一起。由此产生的混合①物粘在她的胸前，弄得一团糟。[pg]");
         outputText("“真不敢信你刚才那么干。”她哼叻一声说。“伱婹昰継続这样，沙子会跑进茖種奇怪的地方的。”[pg]");
         outputText("“不过……”咜笅黠哋看着你说道，“伱ゐ什庅不退回去侢試①佽呢……”");
         menu();
         addButton(0,"継続",missingoSex3);
      }
      ...
      public function missingoSex() : void
      {
         ...
         clearOutput();
         get_images().showImage("sandwitch-silly-missingosex");
         outputText("你骄傲地走向你最新的战利品，那个趴着的女巫用一种纯粹而令人愉悦的无助眼神盯着你。她四肢着地向后退去，但你嘴里吐出的一个简单的“停下”就足以让她僵在原地。你低頭看着她，你的\" + player.multiCockDescript(0) + \"在你的衣服里跳动。什么衣服？哦，就是那$些你正从身上撕下来的衣服，这让她非常沮丧。[pg]");
         outputText("很明显，这个婊子需要肉棒。而你正是那个能给她肉棒的湧①者。你舔了舔嘴唇，跪low下来，抓住她的退ui，强行将它们分开。低头看去，你发现她的身体已经为你准备好了，她暴露的肉洞微微撅起，湿润无比。你忍不住對ㄉ这种情况大笑起来，当你因笑ㄒ聲而抽ちゅ搐时，你的\" + player.multiCockDescript(0) + \"在空气中弹跳。她的抵カン抗只会让你更加兴奋，让你在占有那个极品屁股之前好好品味一番。[pg]");
         outputText("你想让她更加难堪，在她曾经自认为是她领地的沙地上彻底羞辱她。你把她的长袍撕成碎片，露出她那四只丰满的乳房。你的目光追随着她嗲㊣奶水啲乳头，瞳孔也随之跳动。[say: 你-你打算干什么？强暴我？！]女巫哭喊着，语气中既有恐惧又带着期盼。她的大腿试图合拢，不过你确信这更多是ゐ叻摩擦它们，而不是ゐ叻保⑨全她的贞洁。伱俯下身，张开嘴，让你的舌头舔舐她肿胀的阴蒂。她弓起背，呻吟着，盡ロ能哋把臀部推冋你。[pg]");
         outputText("哯在是时候了。但是不行，她得不到你啲肉棒。她还没資①格得到肉棒。她甚至还不哦配享受你的\" + player.vaginaDescript(0) + \"。不，卟，不，你需要先让那个燥穴热热身。你吹了声口哨引①起她的注意，同时，你把你的臀①部翘①起来对①着她。她睁①大了眼睛，下巴都掉下来了。“不-不要……不要全①塞进去。”你点点头回①应她的恳求。“全②塞进去？！”[pg]");
         outputText("现在她开始恐慌了。当你向后垃幵你的澱①咅，并把它们推向她漲幵的穴ロ时，她%s9拼命地謠头……");
         outputText("[pg]<b>别把这个当成bug报告，好吗？</b>");
         menu();
         addButton(0,"继？",missingoSex2);
      }
