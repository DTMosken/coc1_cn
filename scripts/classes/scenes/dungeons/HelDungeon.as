package classes.scenes.dungeons
{
   ...
   public class HelDungeon extends DungeonAbstractContent
   {
      ...
      public function takeGooArmor4Realz() : void
      {
         ...
         outputText("[pg]穿着盔甲的史莱姆娘低声咆哮道，[say: 凡人，你竟敢打扰我的沉睡？准备好迎接我的复仇吧！]");
      ...
      public function gooArmorBeatsUpPC() : void
      {
         ...
         {
            outputText("[pg]她开始用黏液剥开你的[armor]，很快就露出了你毫无防备的[vagina]。她夸张地舔了舔嘴唇，黏液触手渗入你的小穴，将你完全填满。你在黏液的束缚中扭动挣扎，但一切努力都是徒劳的。盔甲里的史莱姆娘只是对你摇了摇头，然后从你的[vagina]里退了出来。");
            ...
            outputText("[pg]你爆发了，淫液从你的[vagina]喷涌而出，射入黏液肉棒中。史莱姆娘大笑着吸收了你的淫水，随着你的喂食，她的体型变得越来越大，直到她高高地俯视着你，她那巨大的肉棒现在已经粗到足以痛苦地撑开你的肉壁。[say: 噢，太棒了。乖，女孩，乖。对，全释放出来，就像这样……就像这样，]她柔声哄着，吸收着你的汁液，直到你的高潮终于过去。心满意足后，她从你体内抽出，让你站起来，你的腹部留下了一种明显的空虚感。");
            outputText("[pg][say: 嗯，真好玩，]史莱姆娘拍着她圆滚滚的肚子说道。你可以看到你的一些淫水");
            if(get_player().biggestTitSize() > 1 && get_player().lactationQ() > 0)
            {
               outputText("和乳汁");
            }
            outputText("在她体内打转。[say: 好吧，既然你把我喂得这么饱，我就放你走吧。就这一次！回见，小美味！]");
            outputText("[pg]还没等你缓过神来说句话，史莱姆娘就大摇大摆地走出了门。令你惊讶的是，战斗结束后你感觉精神焕发，你活动了一下肩膀，将注意力转回前方的地牢。");
         }
         else if(get_player().hasCock())
         {
            ...
            outputText("。她夸张地舔了舔嘴唇，黏液触手像一个温暖湿润的飞机杯一样紧紧包裹住[eachCock]。你在黏糊糊的束缚中扭动挣扎，但你的努力是徒劳的。盔甲里的史莱姆娘只是对你摇了摇头，把[eachCock]挤压得更紧了。");
            outputText("[pg]当她开始抚弄你的" + get_player().multiCockDescriptLight() + "时，你舒服地喘着气，她居高临下地俯视着你，邪恶地笑着为你打飞机。[say: 噢，你喜欢这样，是吗？]盔甲史莱姆问道。[say: 好吧，也许这可以互惠……互利。]她开始加快节奏，当她套弄你的[cocks]时，你扭动着身体，随着先列腺液的小气泡形成，她舔了舔嘴唇。无助的你只能屈服，在穿戴盔甲的史莱姆娘继续榨取你时，试着享受这一切。");
            ...
            outputText("[pg]你高潮了，浓稠的白色精液从[eachCock]喷射而出，射入史莱姆娘等待着的身体里。史莱姆娘笑着吸收了你的精液，随着你的喂食，她的体型越来越大，直到她高高地俯视着你，膨胀的乳房和肚子悬在你的上方。[say: 哦，太棒了。好[boy]，真棒。对，全都射出来，就是这样……就是这样，]她娇嗔着，吸吮着你的精液，直到你的高潮终于过去。心满意足后，她从你身上退开，留下你那明显空虚酸痛的[cocks]。");
            outputText("[pg][say: 嗯，真好玩，]史莱姆娘拍着圆滚滚的肚子说。你可以看到你的一些精液在她的体内打转。[say: 好吧，既然你把我喂得这么饱，我就放你走吧。就这一次！回见，美味的小家伙！]");
            outputText("[pg]还没等你缓过神来说句话，史莱姆娘就大摇大摆地走出了门。令你惊讶的是，战斗结束后你感觉精神焕发，你活动了一下肩膀，将注意力转回前方的地牢。");
         }
         else
         {
            ...
            outputText("[pg]史莱姆娘耸了耸肩，大摇大摆地走出了前门。");
      ...
      public function beatUpGooArmor() : void
      {
         ...
         outputText("[pg]嗯，这确实是个有趣的提议。你要带上这件史莱姆娘盔甲吗？");
         menu();
