package classes.scenes.dungeons.lethicesKeep
{
   ...
   public class DriderIncubusScenes extends BaseContent
   {
      ...
      public function titfuckMitziSlow() : void
      {
         ...
         outputText("[pg]米兹高兴地娇呼道：[say: 噢，你现在肯定会带走米兹的！在这之后你的肉棒会爱上米兹的！]她用那丰满得像枕头一样、甚至能让你躺在上面睡个午觉的嘴唇亲吻着你的[cock biggest]。她涂着厚厚紫色唇彩的嘴唇几乎毫无阻力地上下滑动，在肉棒下方印下一个个湿润、满是口水的吻。你的[legs]发软，更别提抓着她头发的手了。当你试图保持直立时，她从你无力的手指间滑出，获得了取悦你阴茎的全部空间，你感觉到她的舌头伸展开来，在肉棒上涂满了足以稀释一个史莱姆娘的口水。");
      ...
      public function spooderbuttGetsANewCockSleeve(param1:Boolean, param2:Boolean = false) : void
      {
         ...
         outputText("[pg]当你被抬到大厅尽头的王座时，聚集的腐化者和他们的奴隶陷入了死一般的寂静。一个巨大的牛头人和他那大胸的母牛奴隶甚至为基纳里尔让路。");
         menu();
