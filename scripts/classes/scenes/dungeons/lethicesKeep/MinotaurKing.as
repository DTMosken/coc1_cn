package classes.scenes.dungeons.lethicesKeep
{
   ...
   public class MinotaurKing extends Monster
   {
      ...
      {
         outputText("牛头怪对你笑了笑，掀起他的缠腰布，向你弹了一下。粗壮的先列腺液在空中飞舞，");
         if(Utils.rand(3) == 0)
         {
      ...
      {
         _orgasms += 1;
         outputText("这只极度发情的牛头怪踉跄了一下，然后低头看着双腿间那根肿胀的肉柱。它在抽动，随着他心脏的每一次跳动在空中弹跳。硬成那样一定很疼，它充满了欲望，看起来随时都会爆发。他的一只手伸向它，然后单膝跪地。你成功了吗？你彻底击败这个野兽了吗？");
         outputText("[pg]一只巨大的手抓住了艾克塞莉亚的躯干，将她举到半空中。这个曲线丰满的母牛荡妇在这种情况做出了她唯一能做的事——她发出哞哞的叫声，张开双腿，兴奋的脸上挂着欢快的笑容。牛头怪国王一秒钟也没耽搁，当场将她贯穿，将那根看起来有三英尺长的粗壮肉棒深深地插进了他最爱的荡妇体内。当他完全插进去时，他的睾丸拍打着她鼓胀的肚子，沾满了一层淫液。");
         ...
         outputText("[pg]一秒钟后，艾克塞莉亚的主人也和她一起达到了高潮。他粗重的喘息声几乎没有什么变化。如果不是她的肚子突然像气球一样鼓起来，以及双腿间如瀑布般倾泻而出的精液，给主人的双腿镀上了一层充满情欲的白色，你甚至都不会察觉。精液的量绝对令人咋舌。你敬畏地看着艾克塞莉亚原本紧致的肚子被撑成了一个怀孕般的圆顶。她看起来随时都会分娩，但她的子宫里除了几加仑被污染的牛头怪精液外，什么都没有。");
         if(get_player().hasPerk(PerkLib.MinotaurCumAddict))
         {
            outputText("你很嫉妒。那么多精液感觉一定很美妙！");
         }
         outputText("[pg]无论这场强力的交配施加了什么魔法，都在艾克塞莉亚从她主人依然坚挺的肉棒上滑落的那一刻被打破了。你闭上嘴，握紧你的[weapon]，而牛头怪国王直起身子，大口喘着粗气。他看起来因为刚才的努力有些头晕，但依然能继续战斗。也许如果你能让他再次达到高潮，他就会彻底倒下？");
         set_lust(0);
      }
      ...
      public function hpRestore() : void
      {
         ...
         set_lust(get_lust() + 2);
         _milkDrinks += 1;
         outputText("国王踉跄着后退，毫不迟疑地抓起他那顺从的奴隶，把她举到脸前，就像举起一杯刚酿好的啤酒一样轻松。她那巨大的乳房轻松地贴在巨大的牛头怪的嘴唇上，你看到他大声地吞咽着，快速地喝下这乳白色的提神饮料。等他喝完时，他的伤口正在愈合，但他的肉棒却在抽搐，像筛子漏水一样漏出先列腺液。");
      ...
      override public function get_long() : String
      {
         if(_orgasms == 0)
         {
            return "站在你和恶魔女王之间的是一个体型和身材都无与伦比的对手——牛头怪国王。他是一头无法估量的野兽，身上覆盖着蓬松的毛发和几块碎皮革，这些根本无法掩盖他双腿间那根龟头膨大的肉棒。他手里拿着一把巨大的斧头，尽管他似乎不愿意使用它，而是更喜欢依靠双腿间散发出的情色气味。他闻起来充满男子气概、强壮，而且比你想象的更诱人。你最好小心点，不要沉迷其中。";
         }
         var _loc1_:String = "牛头怪国王依然站在你和恶魔女王之间，大口喘着粗气。他的肉棒上涂满了自己强烈高潮后的残留物。他那高达14英尺的巨大身躯微微弯曲，死死盯着你，一只手仍然紧紧抓着他的斧头。再次将他逼向高潮无疑会超出他那惊人的忍耐力。唯一的问题是围绕着他的那种诱人的<i>香气</i>，空气中弥漫着汗水交织的床笫之欢和炽热快感的气息。你最好快点解决他。";
         if(get_lust100() < 40)
         {
      ...
      {
         outputText("牛头怪国王拿着他的斧头，仿佛它轻如鸿毛，他随意地挥舞着，你几乎没有注意到他的挥击");
      ...
      {
         outputText("牛头怪国王用斧头虚晃一枪，朝你的方向猛地挥出一记强有力的反手击打。");
