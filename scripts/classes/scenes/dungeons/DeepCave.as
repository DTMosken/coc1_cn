package classes.scenes.dungeons
{
   ...
   public class DeepCave extends DungeonAbstractContent
   {
      ...
      public function sexualTortureTightenZetaz() : void
      {
         ...
         outputText("当你轻轻拉动隔板时，隔板表面后未完工的木头摩擦着你的指尖，露出一个狭窄的隐藏隔间。里面唯一的物品是一张详细的地图，描绘了这座山及其上部区域。虽然这张秘密图表相当粗糙，但它描绘了一条蜿蜒的小径，绕过了许多鹰身女妖的巢穴、牛头怪的洞穴以及各种无法辨认的陷阱，最终到达云雾缭绕的山峰。一旦到达顶部的恶魔防御工事，这幅画就失去了很多细节，但一旦你进入了莉希丝的权力中心，追踪她应该不会太难，对吧？[pg]");
      ...
      public function roomTunnel() : void
      {
         ...
         outputText("这条洞穴隧道向北倾斜向下，向南倾斜向上。你能从南边看到阳光，感受到清新的微风，尽管你周围的墙壁和空气都因为湿气而显得潮湿。你发现这个洞穴的地面相当平滑均匀，似乎有人试图将其弄平。你能看到隧道北端有一堵用砖砌成的墙。墙的中央有一扇粗制滥造的木门。");
      }
      ...
      public function endZetaz() : void
      {
         ...
         outputText("你手中的椅子碎裂了，被它撞击的书桌也裂开了，你感觉好了一点。一张羊皮纸在这一切的中间飘来飘去，它从某个隐藏的隔间里被释放出来，大部分完好无损。其中一个角被撕掉了，中间有一道裂缝，但仍然完全清晰可辨。这是一张地图！虽然这张秘密图表相当粗糙，但它描绘了一条蜿蜒的小径，绕过了许多鹰身女妖的巢穴、牛头怪的洞穴以及各种无法辨认的陷阱，最终到达云雾缭绕的山峰。一旦到达顶部的恶魔防御工事，这幅画就失去了很多细节，但一旦你进入了莉希丝的权力中心，追踪她应该不会太难，对吧？[pg]");
         outputText("<b>(获得关键物品：泽塔兹的地图！)</b>");
         get_player().createKeyItem("Zetaz\'s Map",0,0,0,0);
         var _loc1_:IMap = KFLAGS.flags;
