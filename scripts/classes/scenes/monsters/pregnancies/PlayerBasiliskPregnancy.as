package classes.scenes.monsters.pregnancies
{
   ...
   public class PlayerBasiliskPregnancy implements VaginalPregnancy
   {
      ...
      public function PlayerBasiliskPregnancy(param1:GuiOutput = undefined)
      {
         ...
         output = param1;
         PregnancyProgression.registerVaginalPregnancyScene(25,14,this);
      }
      
      public function vaginalBirth() : void
      {
         KGAMECLASS.kGAMECLASS.highMountains.basiliskScene.basiliskBirth();
      }
      ...
      public function updateVaginalPregnancy() : Boolean
      {
         ...
         {
            output.text("<b>你的肚子咕咕叫了起来，就好像空了一样，尽管你不久前才吃过东西。也许是因为你运动量太大了，所以你需要多吃一点。</b>[pg]");
            _loc2_ = true;
         }
         if(_loc1_.get_pregnancyIncubation() == 160)
         {
            ...
            output.text("，也许你应该减少最近的进食量了？</b>[pg]");
            _loc2_ = true;
         }
         ...
         if(_loc1_.get_pregnancyIncubation() == 32 || _loc1_.get_pregnancyIncubation() == 64 || _loc1_.get_pregnancyIncubation() == 85 || _loc1_.get_pregnancyIncubation() == 150)
         {
            ...
            {
               output.text("<b>你的乳房已经肿胀到了C罩杯，</b>这是为了你即将到来的怀孕做准备。[pg]");
