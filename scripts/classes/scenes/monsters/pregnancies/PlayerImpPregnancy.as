package classes.scenes.monsters.pregnancies
{
   ...
   public class PlayerImpPregnancy implements VaginalPregnancy
   {
      ...
      public function vaginalBirth() : void
      {
         ...
         output.text("随着分娩的继续，疼痛开始消退……取而代之的是一种不断累积的快感。随着宫缩的加剧，兴奋传遍全身，当你感觉到有什么东西通过时，你经历了一次小小的性高潮。[pg]然而，你感觉到体内还有更多，宫缩再次加剧，当排出了其他东西时，你再次被推向高潮。这重复了一次又一次，你分娩并高潮了近十几次。在经历了漫长的繁衍与快感之后，你感觉到折磨终于结束，随后便失去了意识，瘫倒在地。");
