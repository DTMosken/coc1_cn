   ...
   public class GoblinWarriorScene extends BaseContent
   {
      ...
      public function gobboWarriorBeatYaUp() : void
      {
         ...
         if(get_player().hasCockThatFits(get_monster().vaginalCapacity()) && (!get_player().hasVagina() || Utils.rand(2) == 0))
         {
            ...
            outputText(get_player().mf("强壮的小伙子","性感的母猪") + "应该有足够的精液来偿还[his]冒犯吧？[sayend]");
         ...
         else
         {
            ...
            outputText("[pg]你的另一只手臂传来一阵短暂的刺痛，紧接着是一阵眩晕。随之而来的是，你的兴奋似乎翻了一倍，攀升得如此之高，以至于你之前的性需求水平相比之下显得微不足道。你的[hips]不由自主地从地上抬起，每一丝空气拂过你肿胀的阴阜时带来的电流感都太美妙了，让你无法抗拒。地精显然很享受你的努力，评论道，[say:哦天哪，你在操空气吗？你真的是在享受微风吹过你裸露小穴的感觉吗？而且你下面湿透了！亲爱的，我可是个地精，但你现在让我都自愧不如了。]");
