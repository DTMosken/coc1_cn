package classes.scenes.monsters
{
   ...
   public class GoblinSharpshooter extends Monster
   {
      ...
      public function skeetShot() : void
      {
         ...
         {
            outputText("\n她开火并完全击中了烧瓶，在它到达你之前将其引爆，让你被粉色的薄雾覆盖！尽管你尽了最大努力，你还是不小心吸入了一些，感觉你的身体因为不想要的兴奋而发热。你再次看向地精，她向你飞吻，随后露出了一个恶作剧的微笑。现在看来，放弃抵抗，操她直到那个微笑消失似乎是个好主意……");
         ...
         else
         {
            ...
            {
               outputText("\n手雷在你拉开足够距离之前就爆炸了！尽管你尽了最大努力，你还是不小心吸入了一些，感觉你的身体因为不想要的兴奋而发热。你再次看向地精，她向你飞吻，随后露出了一个恶作剧的微笑。现在看来，放弃抵抗，操她直到那个微笑消失似乎是个好主意……");
