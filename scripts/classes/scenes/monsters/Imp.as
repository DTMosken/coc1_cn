package classes.scenes.monsters
{
   ...
   public class Imp extends Monster
   {
      ...
      public function Imp(param1:Boolean = false, param2:int = 1)
      {
         ...
         set_short("imp");
         imageName = "imp";
         set_long("[Themonster]个子很矮，只有几英尺高。一头蓬乱的黑色长发从他头上垂下，被两根弯曲的短角分开。他的眼睛是纯黑色的，只有微小的红色虹膜闪烁着邪恶的意图。他的皮肤是鲜红色的，除了腰带上的一小块遮阴布外，没有穿任何衣服或盔甲。他的脚上穿着小木凉鞋，手上长着锋利的爪子。一对微小但实用的翅膀偶尔在他的背上拍打着。");
         set_race("Imp");
