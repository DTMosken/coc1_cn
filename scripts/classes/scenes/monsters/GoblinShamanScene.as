   ...
   public class GoblinShamanScene extends BaseContent
   {
      ...
      public function goblinShamanBeatYaUp() : void
      {
         ...
         else
         {
            ...
            outputText("[pg]你的另一只手臂传来一阵短暂的疼痛，紧接着是一阵眩晕。随之而来的是，你的兴奋似乎翻了一倍，攀升得如此之高，以至于你之前的性需求水平相比之下显得微不足道。你的[hips]不由自主地从地上抬起，每一丝气流拂过你肿胀的阴阜带来的电流般的触感，都美妙得让人无法抗拒。地精显然很享受你的努力，评论道，[say: 哦天哪，你在操空气吗？你真的是靠感受微风吹过你赤裸、暴露的小穴来获得快感的吗？而且你下面湿透了！亲爱的，我他妈是个地精，但你现在让我自愧不如。]");
