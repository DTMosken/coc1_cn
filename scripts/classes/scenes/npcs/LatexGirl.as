package classes.scenes.npcs
{
   ...
   public class LatexGirl extends NPCAwareContent
   {
      ...
      public function sendToFarm() : void
      {
         ...
         outputText("[pg][say:如您所愿，[master]，]她叹了口气，然后慢慢地向湖的方向滑去。你觉得，无论是作为工人还是保护者，她都将毫无用处；然而，你怀疑如果惠特尼让她吃得饱饱的，她就能从她身上收获乳胶，这肯定是有价值的，也许一些老式的体力劳动会对这个任性的史莱姆娘有好处。");
      ...
      public function pureGooRecruitmentStart() : void
      {
         ...
         outputText("这场混战的刺激对史莱姆娘来说太过了，她瘫倒在下半身的黏液中，皮肤蠕动着，努力维持着身体的凝聚。她的表情充满失望，用那双充满希望的大眼睛看着你，伸出一只手，似乎在为她的过度兴奋道歉。");
         outputText("[pg]当你俯身看着被击败的史莱姆娘，试图决定该怎么处理她时，她突然向前扑来，用黏糊糊的手臂抱住你，把你的脸拉进她柔软的乳房里。当史莱姆娘试图给你一个顽皮的拥抱时，你扭动着身体，显然她还没玩够，这时你的[inv]突然掉了下来！你在混乱中挣脱，你的物品掉在地上发出叮当声，但你惊讶地盯着你携带的黑蛋正好在史莱姆娘的头上裂开，将其乳胶物质倒进她的头上，同时你的魅魔乳液也爆开了，将奶油般的乳液喷洒在她[monster.skin]的外表上。你微微睁大眼睛，看着这两种黑白相间的物质渗入她吸收性极强的身体，最终滑向她心形的内核。");
         outputText("[pg]突然，她的动作停止了，两种物质在她的核心周围旋转，像种子被吸进饥饿妓女的嘴里一样被吸了进去。当蛋和乳液在她体内混合时，女孩的嘴唇开始变暗，逐渐变得不透明。伴随着一声沮丧的晃动声，史莱姆娘站了起来，转身面对你。她的下唇已经变成了闪亮的缟玛瑙色，撅着嘴，充满恐惧。她把手臂举到脸前，惊恐地看着手臂上慢慢长满黑斑。她开始摇晃，然后倒在地上；她的指尖已经凝固，变成了光滑坚实的物体，有着清晰的指甲，恐惧地抠着海岸。当最后一点乳液旋入她的心脏时，她的乳房变大了，把她脸朝下拖到了地上。");
         outputText("[pg]她扭动着身体，但没能站起来，因为凝固的乳房太重了，无法移动。到目前为止，她的手臂已经凝结成光滑的缟玛瑙色，一直延伸到手肘，她的臀部同样是反光材料制成的深色球体，简直让人忍不住想摸一摸。在下面，她的黏液池正在缩小，向内收缩，同时变得更加不透明。它一分为二，逐渐扭曲缠绕，直到露出两条匀称的小腿，上面是一双娇小的脚。这些几乎瞬间就凝固了——变形正在加速！可渗透的薄膜迅速让位于她颤抖的身体上反光、光滑的乳胶，将史莱姆娘塑造成了一个捆绑荡妇湿梦中的形象。随着她的整个身体从液体变成固体，曾经的史莱姆娘陷入了昏迷，黑色的眼睑盖住了她坚实的[monster.skin]眼睛。");
         outputText("[pg]担心你可能杀了她，你冲上前去检查她的呼吸。呼！她没事，只是像灯一样熄灭了。你把这个可怜的女孩抱在怀里好一会儿，环顾四周，想找个地方安置她，找个人帮你处理……她对自己做的任何事。看起来你给自己找了个乳胶史莱姆娘……或者乳胶女孩……随便啦。把她留在这里似乎很残忍，因为她肯定会被一些可怕的怪物抓走……她回到你的营地会更安全，尽管这可能意味着你要承担一个比你准备好的更长期的项目。");
         menu();
      ...
      {
         clearOutput();
         outputText("你把曾经的史莱姆娘放在营地一个僻静的地方。在某种程度上，她看起来几乎像个外星人……比以前更像，那时她只是一个有乳房和假发的水状斑点。现在，她身体的每一个方面都是闪亮、反光的乳胶。甚至她的阴道分泌物，自由地滴落，也是液体乳胶，光滑的黑色汁液，一旦离开她的身体，就会慢慢硬化成柔韧的固体。");
         if(get_player().cockTotal() > 1)
         {
            outputText("你不禁想知道，让她用她的汁液包裹你的[cocks]会是什么感觉。");
         }
         outputText("[pg]令人惊讶的是，她有头发，或者说对于一个完全由柔软的无机半固体构成的女人来说，可以算是头发的东西。她的长发垂过肩膀，细长的发丝和她的皮肤一样反光。与她的皮肤不同，乳胶史莱姆娘的头发似乎永远是油腻、光滑和润滑的。你犹豫地伸出手去触摸，小心翼翼地抚摸着几根橡胶般的发丝。它们的质地光滑而滑溜，不像你曾经有幸触摸过的任何头发。");
      ...
      public function minotaurCumFeedingGoo(param1:Boolean = false) : void
      {
         ...
         outputText("[pg][latexyname]的眼睛翻白，她平躺着倒下，仍然用拳头和前臂操着自己。就这样，她一次又一次地高潮，屈服于麻痹她理智的麻醉兴奋，让她的身体充满了欲望之火。对她来说，除了不断攀升的快感和随之而来的狂喜释放，一个接一个，别无其他。她身体的颤抖加剧到了让你担心她会伤到自己弹性身体的地步，但幸运的是，她的身体完全瘫软下来，陷入了昏迷。");
      ...
      public function meanGooGirlRecruitment() : void
      {
         ...
         outputText("。史莱姆娘不解地抬头看着你，最后给了你一个充满希望的微笑——可怜的小家伙以为你要操她！你拍了拍她的头，指示她弯下腰。她当然照做了，从她那黏糊糊的底座上抬起一个令人愉悦的女性臀部向你展示。你甚至能看到一对女性的阴唇，完美地塑造成一个激情燃烧的女性的形状。");
         outputText("[pg]好吧，现在是时候了。你拿起黑蛋，开始把它推入她的小穴，心想以她扭曲的解剖结构，从哪个洞塞进去都无所谓。史莱姆娘高兴地颤抖着，当你把黑蛋推入核心时，她的洞在你的手周围发热。她在你周围愉快地扭动着，她的肉壁似乎决心要从你的手臂上榨出幻影般的精液。");
         outputText("[pg]突然，她的动作停止了，你赶在她反应过来之前抽回了手臂，生怕她试图把它囚禁在那个黏糊糊的通道里。当你抽回手时，她的嘴唇开始变暗，逐渐变得不透明。伴随着一阵沮丧的晃动，史莱姆娘站了起来，转过身面对你。她的下唇已经变成了闪亮的缟玛瑙色，撅着嘴，充满恐惧。她愤怒地举起双臂，上面覆盖着慢慢生长的黑斑。你对此早有准备，轻松地滑入她的防线，打开你带来的魅魔乳汁瓶，举到她的唇边。奶油般的液体充满了她的嘴，邪恶的味道很快让她吞咽起来。她把瓶子从你手中拉开，不假思索地把剩下的都喝光了，甚至没有注意到她的指尖已经凝固，变成了光滑坚实的物体，有着清晰的指甲。当她喝完药水时，她的乳房变大了，把她脸朝下拽到了地上。");
         outputText("[pg]她扭动着身体，但没能站起来，因为凝固的乳房太重了，无法移动。到目前为止，她的手臂已经凝结成光滑的缟玛瑙色，一直延伸到手肘，她的臀部同样是反光材料制成的深色球体，简直让人忍不住想摸一摸。在下面，她的黏液池正在缩小，向内收缩，同时变得更加不透明。它一分为二，逐渐扭曲缠绕，直到露出两条匀称的小腿，上面是一双娇小的脚。这些几乎瞬间就凝固了——变形正在加速！可渗透的薄膜迅速让位于她颤抖的身体上反光、光滑的乳胶，将史莱姆娘塑造成了一个捆绑荡妇湿梦中的形象。随着她的整个身体从液体变成固体，曾经的史莱姆娘陷入了昏迷，黑色的眼睑盖住了她坚实的[monster.skin]眼睛。");
         ...
         outputText("[pg]现在，你得到了一个乳胶史莱姆娘……或者一个乳胶女孩……随便吧。怎么把她带回家？");
         if(get_player().get_inte() >= 60)
         {
      ...
      public function maleDirectFeedLatexGooGoneWrong() : void
      {
         ...
         outputText("，同时开心地解释道，[say: 我们史莱姆娘的特点是……我们喜欢喝。嗯……] 她的声音逐渐变成愉悦的哼唱，因为她消化了你最新的供品，最终又回来说，[say: 你尝起来真好，[name]……我停不下来，它太甜了，太美味了。吞下你的精液让我的小穴喷水，让我的肚子发出咕噜声。你不介意我再尝几口吧？]");
      ...
      public function letLatexGooDrainCuntDry() : void
      {
         ...
         outputText("[pg]你一言不发地在[latexyname]身上扭动，直到高潮终于放过你。你的黏液宠物退了回去，甚至把舌头从你汁水四溢的小穴里抽了出来。她的拳头毫不迟疑地取而代之。事实上，当那光滑的肢体滑入时，你能感觉到最粗大的部分变得平滑，塑造成一个圆柱形的物体，在“手腕”上方有一道明显的凸起。[latexyname]咯咯笑着，[say: 天哪，你尝起来真棒，我们史莱姆娘……我们最喜欢喝了。嗯……] 她的声音渐渐变成愉悦的哼哼声，消化着你最新的贡品，最后又说道，[say: 你的小缝隙看起来开心极了，[name]……我不想停下来，它太甜了，太美味了……吞下你的淫水让我的小穴喷水，肚子咕噜咕噜叫。你不介意我再多尝几口吧？]");
         ...
         outputText("她那像假阳具一样的肢体抽插时发出刺耳的吧唧声，轻易地淹没了你更连贯的发声。除了为你的乳胶史莱姆娘高潮，你什么也做不了。除了感受快感和高潮，一次又一次地喂给她每一滴你那充满快感的液体，你别无选择。");
      ...
      public function latexyTalkMenu() : void
      {
         ...
         addNextButton("史莱姆娘",latexyGoos).hint("问更多关于她族人的事。");
      ...
      {
         clearOutput();
         outputText("从一个普通的史莱姆娘变成现在这个样子，肯定需要很大的适应过程，所以你问[latexyname]对自己的转变有何感想。听到你的问题，她不安地扭动了一下，似乎不知道该怎么回答。");
         ...
         outputText("[pg]站在你面前的乳胶史莱姆娘看起来" + (gooHappiness() >= 75 || gooObedience() >= 75 ? "有些矛盾" : "几乎痛苦不堪") + "。你想你当时做这件事的时候并没有完全考虑到她的感受，[if (corruption < 50) {但你会尽力让她新的生活更愉快|虽然你现在也不怎么在乎}]。就在你注视着她的时候，[latexyname]用手指顺着她光滑闪亮的一侧滑下，然后打了个寒颤。");
      ...
      {
         clearOutput();
         outputText("你意识到自己从未真正了解过史莱姆娘。表面上看，她们似乎是头脑简单的宁芙，唯一关心的就是能吞下多少精液，但她说过的一些话让你怀疑她们是否还有更多内涵。考虑到这一切，你让[latexyname]告诉你更多关于她们的事。");
      ...
      {
         clearOutput();
         outputText("站在你面前的是[latexyname]，你的乳胶史莱姆娘。她的整个身体都是由光滑的黑色乳胶组成的，甚至连她的头发也是，从她的头上垂下细细的几缕。她那闪亮的玛瑙光泽中唯一的例外是她明亮的" + FlagDict_Impl_.arrayReadString(KFLAGS.flags,658) + "目光，目前正盯着你，带着一种[if (latexyobedience < 30) {挑衅的|[if (latexyobedience >= 70) {顺从的|难以捉摸的}]}]神情。你的目光甚至向下扫去，掠过她的" + gooTits() + "和" + (FlagDict_Impl_.arrayReadFloat(KFLAGS.flags,667) != 0 ? gooCock() : "滴水的肉褶") + "。盯着那深色、光滑的皮肤，你忍不住想去触摸它，[if (latexyobedience >= 50) {而且你知道她会让你这么做的|虽然你现在不确定她会有什么感觉}]。");
      ...
      public function femalePCDomFucksLatexGooFuta() : void
      {
         ...
         outputText("[pg][say:我控制不住自己，[Master]……你感觉太棒了！就像一个用蜂蜜做成的老虎钳，要把我榨干！][latexyname]脱口而出。好吧，听到这样的宣言，很难生得起气来。她接着说，[say:别担心，我会保持硬度的。我是史莱姆娘，记得吗？转移一点体液根本不算什么。]");
         ...
         outputText("你穿好衣服，大摇大摆地离开了。一个面带微笑、身体结实的史莱姆娘留在你身后。");
         get_player().orgasm("Vaginal");
         dynStats(DynStat.Sens(-2));
      ...
      public function feedLatexyCumDirectly() : void
      {
         var _loc1_:int = 0;
         clearOutput();
         outputText("解开你的[armor]，你让[eachCock]自由地垂下。[latexyname]立刻低头看去，" + FlagDict_Impl_.arrayReadString(KFLAGS.flags,658) + "的眼睛紧紧锁定在[oneCock]上，全神贯注地看着它随着不断上升的欲望而变硬。你把它拿在手里掂量它的重量。你解释说这是她的食物，并给了它一个鼓励性的摇晃。毕竟，如果你不喂你的史莱姆娘，你算什么主人？");
         if(gooFluid() < 33)
         {
         ...
         outputText("[pg]随着[oneCock]深深埋入你的宠物[sheath]深处，你忍不住呻吟起来。片刻之后，你意识到，当她把你拉进去时，她的舌头就解开了，因为你能感觉到乳胶女郎喉咙里湿润、跳动的肉壁在按摩你的长度，用只有史莱姆娘才能提供的半固体压力一丝不苟地刺激着你。她的内脏感觉就像凝胶状的波浪在你身上翻滚，既温暖又黏糊糊的。[latexyname]温柔地挤奶你的[cock biggest]，挤出几股先列腺液进入她的肚子。退后时，她从你的[cockHead biggest]挤出一团精液，她油腻的舌头紧贴着你工具的底部，直到它被暴露在冷空气中。");
      ...
      public function encounterLeftBehindGooSlave() : void
      {
         ...
         {
            outputText("在探索时，你看到湖里有些奇怪的东西。那是一团黑色的黏液，在蔚蓝的波浪中几乎看不见，但它似乎在疯狂地拍打水面，像是在挣扎。你走到湖边，正好看到那团黑色的黏液软绵绵地瘫倒在沙滩上，大口喘气。是那个可怜的被变成乳胶的史莱姆娘！");
            ...
            outputText("[pg][say: 我能感觉到，你知道的。]");
            outputText("[pg]你拼命后退，对这突如其来的话语感到惊讶，以至于你差点一屁股摔在[butt]上。作为回应，咯咯的笑声冒了出来，[say: 抱歉，我不是故意吓你的。]");
            outputText("[pg]你走上前，低头看着这个已经恢复意识的曾经的史莱姆娘。她问道：[say: 真的是你吗？我……在我试图让你舒服之后，还有这个……]她指了指自己乳胶般的身体和巨大无瑕的双乳，[say: 我从没想过还能再见到你。]她移开视线，挣扎着站起来——她有脚了，一双修长的腿，不像湖里那些普通的史莱姆娘。看来她已经失去了很多无定形的特征。");
         ...
         else
         {
            ...
            outputText("[pg]你微笑着解释说，湖里的史莱姆娘一直让你很感兴趣，这似乎是让她们变得更……容易控制的最好方法。她痛苦地呻吟着，双手抱住宽阔的胸部，浑身发抖，她那扭曲的身体在光线下摇晃闪烁，让这个动作显得更加不可思议。你平静地伸出双手，解释道");
            if(get_player().cor < 33)
            {
      ...
      public function changeLatexyTits(param1:int = 0) : void
      {
         ...
         {
            outputText("[latexyname]说：[say: 我看起来会贫血的！其他史莱姆娘会以为我快饿死了！] 你给了她一个居高临下的眼神，她叹了口气。[say: 好吧，好吧。如果我的[master]想要小胸，" + get_player().mf("he\'ll","she\'ll") + "就会得到。] 她抓住自己的" + gooTits() + "，用力挤压。令人惊讶的是，乳胶胸肉随着她的推压而退缩，在你的眼前缩小。当它们缩小到B罩杯时，她呜咽了一声，当它们缩小到A罩杯时，她呻吟了一声。[latexyname]把手拿开，向你展示她努力的成果——两个小乳房，每个只有手掌大小。一条乳胶润滑液的河流从她的股沟流出，违背她的意愿服从你这一行为反而增强了她的兴奋。");
         }
         else
         {
      ...
      public function changeGooDick() : void
      {
         ...
         if(FlagDict_Impl_.arrayReadFloat(KFLAGS.flags,667) > 0)
         {
            ...
            addButton(0,"梦魇药剂",function():void
            {
      ...
      public function assertControlOverCuntDrainingLatexGoo() : void
      {
         ...
         clearOutput();
         outputText("[pg][Latexyname]的脸依然固执地贴在你的下体上。你在她无情的口部攻势下挣扎，直到你终于紧紧抓住了这个叛逆的黏液荡妇。你发挥出惊人的力量，将你和史莱姆娘翻转过来，跨坐在她的肩膀上，用身体压住她。[latexyname]发出一声可怜的吱吱声，你再次夺回了控制权，将她按在身下的地上。她在这里本该是顺从的一方：是时候让这个婊子认清自己的位置了。你抓住她光滑的乳胶头发，把她的脸按进你的小穴，当她的鼻子摩擦你的[clit]时，你浑身一颤。你厉声命令她再让你高潮一次。如果她那么想要你的体液，就让她用正确的方式去争取：像个乖巧的小M一样，温顺地吮吸你的小穴。");
      ...
      public function approachLatexy() : void
      {
         ...
         menu();
         addButton(0,"外貌",latexyAppearance).hint("检查这个乳胶史莱姆娘。");
      ...
      public function PCCarriedGooBackHome() : void
      {
         ...
         outputText("[pg]令人惊讶的是，她有头发，或者说对于一个完全由柔软的无机半固体构成的女人来说，那算是头发。她的长发垂过肩膀，细长的发丝和她的皮肤一样反光。与她的皮肤不同，这个乳胶史莱姆娘的头发似乎永远是油腻、湿滑且润滑的。你犹豫地伸出手去触摸，小心翼翼地抚摸着几根橡胶般的发丝。它们的质地光滑而溜滑，与你有幸触摸过的任何头发都不同。");
         outputText("[pg][say: 我能感觉到，你知道的。]");
         ...
         outputText("[pg]你微笑着解释说，湖里的史莱姆娘一直让你很感兴趣，而这似乎是让其中一个变得更……容易控制的最佳方法。她痛苦地呻吟着，双手抱住宽阔的胸部，浑身发抖，她扭曲的身体在光线下抖动闪耀，让这个动作显得更加奇妙。你平和地伸出双手，解释道");
         if(get_player().cor < 33)
         {
            outputText("你会成为一个好[master]。她永远不会缺少她需要的体液，只要她服从你，你就会满足她的其他需求。");
         }
