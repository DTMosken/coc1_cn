   ...
   public class KihaFollowerScene extends NPCAwareContent implements TimeAwareInterface, SelfDebug, SelfSaving
   {
      ...
      public function pcWinsDomFight(param1:Boolean) : void
      {
         ...
         else if(_loc4_ == 1)
         {
            ...
            outputText("[pg]她的呼吸因强烈的兴奋和过度刺激而变得急促，她终于屈服了，恳求你停止玩弄她的乳房，赶紧做[say:更重要的事情。]");
      ...
      public function lovingHugsGirlFuckSex() : void
      {
         ...
         outputText("[pg]片刻之后，一阵快感击中了你的[vag]。奇哈在你的私处嗡嗡作响，饥渴地舔舐着你的汁液，作为回报。她住所的内部开始散发出兴奋和性液体的气味，充斥着足够的女性荷尔蒙，让你们俩都有些头晕。龙女深色的外阴是如此光滑，如此适合亲吻，如此完美地适合舔舐，以至于你的注意力变得越来越狂热。与你完美同步，奇哈用她长长的爬行动物舌头熟练地舔舐，照顾着你自己的欲望。");
      ...
      public function kihaSexMenu(param1:Boolean = true, param2:Boolean = true) : void
      {
         ...
         if(!followerKiha())
         {
            addButtonDisabled(8,"给梦魇药剂","奇哈现在似乎对阴道交不感兴趣。");
         }
         else if(get_player().hasItem(get_consumables().INCUBID) || get_player().hasItem(get_consumables().P_DRAFT))
         {
            addButton(8,"给梦魇药剂",giveKihaIncubusDraft).hint("你可以偷偷给她喝下梦魇药剂，让她用长出来的鸡巴操你的屁股。");
         }
         else
         {
            addButtonDisabled(8,"给梦魇药剂","这个场景需要你有一剂梦魇药剂。");
         }
         if(!followerKiha())
         {
      ...
      public function kihaChildGraduationTime() : void
      {
         ...
         outputText("[pg]奇哈走到你身边说，[say: 他们现在可是相当出色的小战士了。我甚至看到他们中的几个放倒了一只牛头人，我从未如此骄傲过。这样下去，我们也许真的有机会对抗莉希丝。我想，我们可以再多生几个……] 奇哈克服了羞涩，给了你一个热情的吻，然后飞走去忙她平时的事务了。");
         FlagDict_Impl_.arrayWriteInt(KFLAGS.flags,2198,0);
      }
      ...
      public function giveKihaIncubusDraft() : void
      {
         ...
         outputText("一个特别邪恶的想法闪过你的脑海。你微笑着靠近你的龙族情人，但装出惊恐的样子，指着她的肩膀大喊[say:嘿，那是什么！？！？]奇哈抓起她的斧头，转过身去，给了你足够的时间从你的[inv]里拿出一瓶梦魇药剂并拔掉软木塞。当奇哈气呼呼地转过身来时，你已经准备好了。你抓住她的嘴，把药剂灌进去，捏住她的鼻子，让她别无选择，只能吞下去。");
      ...
      public function fuckKihasVagInCamp() : void
      {
         ...
         outputText("[pg]奇哈以流畅、自信的动作，轻松地把你从[armor]里剥出来，让你像她一样完全暴露。你让她把你的装备扔到一边，然后你再次掌控局面，当你把她放倒在地上时，你用手摸索着她那可以挤压的、柔软的乳房之一。她允许自己被摆弄，对于一个经常专注于身体支配的人来说，她的行为出奇地温顺，你趁机利用了这一点。龙女躺在地上，她的双腿淫荡地张开，露出她永远湿润的女性特征闪闪发光的三角区，因为你点燃的兴奋而满脸通红。");
