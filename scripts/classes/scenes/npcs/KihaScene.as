package classes.scenes.npcs
{
   ...
   public class KihaScene extends NPCAwareContent
   {
      ...
      public function kihaRapesHerms() : void
      {
         ...
         {
            outputText("当你们两人在奇哈沾满淫液的尾巴上纠缠时，她注意到了你们旁边堆着的一堆你的物品。[say: 你给我带了什么狗-狗-狗屎礼物，]她咧开长满利齿的嘴笑着喘息道。她用一只手拨开你的物品，注意到了你那瓶阴茎形状的男魅魔药剂，并用拇指和食指夹住了瓶子。[say: 恶魔的垃圾，果然。你甚至都不知道怎么正确使用它。让我来教教你。]她弹开小瓶的软木塞，将药剂一口吞下。你还没来得及抗议，她阴蒂上的包皮就向后滑开，她充血阴户上方指尖大小的肉珠每秒都在变粗。伴随着一阵剧烈的痉挛，她那带来快乐的肉芽高高翘起，长到三英寸，然后是六英寸，最后停留在九英寸长。她那巨大的阴蒂有着两英寸粗的肉棒，正在不断跳动，底部向外凸起，因为矩形、相互咬合的鳞片硬化成了一个从底部到顶端的阶梯。她那没有特征、圆润的龙根顶端肿胀并淫秽地突出，弯曲成一个倾斜的冠状，随着她新长出的肉棒顶端裂开一条细缝，染上了情欲的红晕。[pg]");
