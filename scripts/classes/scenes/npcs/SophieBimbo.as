package classes.scenes.npcs
{
   ...
   public class SophieBimbo extends NPCAwareContent implements SelfDebug, SelfSaving
   {
      ...
      public function sophieImpregnationSex() : void
      {
         ...
         outputText("[pg]索菲慢慢地把你拉到地上，她那柔软的胸部和如匕首般挺立的乳头在你的身侧摩擦。她那丰满的臀部，被强化成了淫荡的、适合生育的腰线，来回扭动着，她的翘臀在你面前高高拱起，让你大饱眼福，欣赏着她那颤动的臀沟。当你坐在那里看着时，她“头发”上的羽毛散落在她拱起的后背上，她的抚摸、淫荡的舞姿和性感的呼噜声让你陷入了难以置信的兴奋状态。");
      ...
      public function bimbotizeMeCaptainSophie() : void
      {
         ...
         outputText("黏滑的淫水如决堤般倾泻了好一阵子后，索菲颤抖的肉穴猛地一阵痉挛，双腿彻底软了。她瘫倒下去，屁股高高撅在空中，私处门户大开，嘴里咯咯笑着，[say: 哇噻！你把我干得爽翻天了诶，[mister]！我能跟你回家吗？我可不想再跟这帮婊子争了，而且你真的超" + get_player().mf("帅","辣") + "的！我们可以天天疯狂做爱什么的！][pg]");
      ...
      public function beBimboSophiesSugarMommy() : void
      {
         ...
         outputText("你笑着，玩味地耸耸肩。你说，如果她是个乖女孩，你倒是不介意把这个当礼物送给她。索菲用力点头，挺起胸膛，伸展手臂和翅膀，虚荣地展示着她银色的羽毛。[say: 别担心，索菲妈妈这事干过一百回了！] 她弹开瓶盖，将绿色的液体倒入口中，浓稠的液体溅在她舌头上，她的表情充满了强烈的喜悦，满含着希望。她扑腾着飞起来，几乎托不住自己那巨大的奶子，然后用胳膊环住你的肩膀，双腿勾住你的腰。她甜笑着，凑过来吻你，将她闪亮的嘴唇压在你的唇上，掺了催情剂的口红的热度瞬间涌遍你的全身。你张开嘴轻轻喘息，她便趁这空隙加深了亲吻。在被药物点燃的兴奋中，你几乎没有注意到那冰凉的灵药正淌进你的嘴里。你开始往后退，但索菲肌肉发达的舌头强行撑开你的嘴唇，她热切地将更多药水像滚雪球一样从你齿间灌入你的喉咙。然后，她自己吞了一大口，用鼻子蹭着你的鼻子，兴高采烈地。[say: 现在我们都要当妈咪了！][pg]");
         outputText("你恼火地想把这个无脑花瓶甩掉，但腹部传来的一阵颤抖夺走了你的怒气。孵蛋灵药有些不对劲——药效缓慢渐进的过程似乎被疯狂加速了。你不确定是催情口红还是鹰身女妖唾液里的什么东西，但索菲的吻显然影响了药水。至少看来她也在遭受同样的效果：鹰身女妖的肚子每时每刻都在贴着你的皮肤膨胀，这个精瘦骚货的腰身在受孕药剂的作用下像吹气球一样鼓起。你自己的肚子也顶着她的肚子变大，一阵满足感掠过你的[skin]，你膨胀子宫的重量让你的" + get_player().vaginaDescript(0) + "期待得直流淫水。就连你的" + get_player().allBreastsDescript() + "也变得更沉重了，你的身体在短短几分钟内就被推进了怀孕的深处。调皮的鹰身女妖呻吟着，一只手抚摸着自己的肚子，同时将她挺翘的乳头在你的[nipple]上碾磨，靠着你们俩被蛋撑得鼓胀、互相挤压的肚子之间的张力来获得快感。透过她摸索的触碰，你能感觉到你自己撑开的子宫里的东西在你体内渐渐成形、变硬，这突如其来的受孕让你丧失了自制力。不由自主地，你发出一声淫荡的呻吟，你的身体在你鼓胀的生长中夹紧达到了高潮。[pg]");
         outputText("你喘着气，跌坐到你的[ass]上，却发现突如其来的冲击已经触发了分娩！也许是出于交感反应，索菲的躯干猛地一抽，颤抖着开始收缩以逼出蛋来。[say: 哦，还是跟我记得的一样爽，] 她在狂喜中尖叫。[say: 看着索菲妈妈，她给你示范怎么做！] 膨胀的鹰身女妖翻身仰面躺下，双腿踢向半空，涂着粉色指甲的爪子张得大开，她稳住呼吸。在子宫重量的压迫下呻吟着，她把手指抠进地里，紧闭双眼，使出全身力气推时，嘴角淌下了狂喜的口水。你不甘示弱，你自己的骚穴也因激燃的快感而阵阵刺痒，你的肌肉因内部的压力而战栗。你咬住内颊，试着去够你的[clit]来自慰，却发现过度鼓胀的肚子挡住了你的手臂，让你够不到自己的肉穴。无助地，你用手抚过你紧绷的[skin]，你那痉挛的、塞满蛋的深处每一次咕噜的震颤都点燃了轻微的高潮，如同喷涌、蠕动的情欲洪流般冲刷过你的身心。直到第一颗蛋滑出你的身体，你才意识到你已经开始了分娩，最小的蛋随着你内壁的每一阵痉挛从你的" + get_player().vaginaDescript(0) + "中噗噗弹出。[pg]");
         outputText("蛋从你的身体里翻滚而出，又密又快，三三两两地滚出你紧夹的小穴，你的肌肉纯粹凭借本能在运作，你只是仰躺着，在迷糊的极乐中咕噜着，连绵不绝的高潮中喷出润滑的淫液。小蛋还算轻松地清出了你的子宫，但剩下的蛋感觉要大得多。你揉着肚子，透过汗湿的腹部感受到它们的硕大。最大的蛋挤到了你的宫颈口，一阵剧痛像泼冷水一样穿透了令人窒息的狂喜。你挣扎着，喘息着，想把它推出去，可你叛逆的肌肉拒绝放松，尽可能久地将那颗庞然巨蛋困在你的子宫里。随着其余的东西排空，你居然能透过你的[skin]看到那颗超大号蛋的形状了——一个巨大的凸起，死活不肯离开你疼痛的子宫。绝望之下，你尝试索菲的办法，把身体的重量翻到背上，把膝盖举到齐肩高。你咬紧牙关放慢呼吸，双手握拳，把每一寸力量都集中在将蛋推出宫颈上。在痛苦的缓慢中，那颗大蛋挤出你的子宫，进入产道，穿过你颤抖的外阴，终于噗地从你的骚穴里掉了出来。一声粗哑的解脱喘息从你肺中抖出，感觉仿佛一块巨大的石头从胸口卸了下来。生下那颗庞然巨蛋的纯粹快感足以给你最后一次高潮，你的身体虚弱得连头都抬不起来了。[pg]");
         outputText("没过多久你就苏醒过来，整个身体因这场经历而酸涩不堪。索菲正伏在你的腿间，用她纤细的舌头舔舐你的" + get_player().vaginaDescript(0) + "，用她丰满的金色嘴唇吮吸你的[clit]。你正要推开她，却意识到她温柔的侍弄正在带走分娩后残留在你那被蹂躏的骚穴上的余痛。你小心翼翼地察看你那还在渗水的性器，松了口气发现你的身体并没有像你以为的那样被那颗毁灭性的蛋撑得无法复原。[say: 傻姑娘，] 索菲嗔道，[say: 口红对两片唇都好用！不然你以为我们怎么能继续取悦伴侣呀？] 她指了指你俩产下的那一堆堆蛋，你倒吸一口气。这里少说有三打蛋，最小的也有苹果那么大。看到自己子宫结出的果实如此之庞大，你多少有些心悸。[say: 妹妹呀，你改天可得给咱找几个种马来！受精的蛋可比这爽太多了。] 她凑近你，一副密谋的模样。[say: 还会更大哦，] 她咯咯笑道。你真想叫她见鬼去吧，再大点蛋还得了，可是——玛莱在上——你就是改不了这德行。你摇摇头，把这个鹰身女妖无脑花瓶翘嘟嘟的嘴按下去，让她更好地亲亲你的骚穴，然后清理一番，盘点所有的蛋。[pg]");
         get_player().orgasm("Vaginal");
         dynStats(DynStat.Sens(-1));
      ...
      public function beBimboSophiesSugarDaddy() : void
      {
         ...
         outputText("在她身体深处。她同时扑腾着翅膀和双臂，疯狂地扇动，把自己抬起了几英寸，但体内不断膨胀的重量又把她摔回地面，将索菲重新拍落在你的肉棒上。蠢到不会吸取教训的她，一次又一次地尝试飞起来，却每次都被拽回地上，全身每一块肌肉都在你的鸡巴上上下抽送。每一次她撞击到你身上，她那咕啾作响的肚皮就似乎变得更大一圈，直到你能透过她隆起的皮肤清晰看出蛋的轮廓。[pg]");
         outputText("随着你的高潮临近，你对她那徒劳的飞行动作渐渐失去了兴趣——到了这个地步，她不过是贴着你磨蹭罢了，连腿都撑不起自己离开你的鸡巴了。你双手抓住鹰身女妖宽大的臀部，哼了一声承受她怀孕般的重量，将这臃肿的熟女推到仰面朝天，起身俯在她身上把活儿干完。你越来越快地用尽全力操着这个金发无脑花瓶，她的大奶随着每一次猛烈的撞击前后晃动。她用胳膊和翅膀环住你的背，令人眼花缭乱的羽毛帘幕将你笼罩其间，酥痒的触感让你分神得够久，高潮便翻涌而出。浓稠而肥沃的精浆从你的" + get_player().cockDescript(_loc1_) + "中喷涌而出，灌进索菲的最深处，奶油般的种子舔舐着她的宫颈，把这只骚货的子宫涂得像她的羽毛一样白。她无声地咕咕叫着，在你搏动的输精管的刺激下，她的肚子翻涌、咕啾作响。她的腹部已经肿成了正常腰围的好几倍大，怀孕得如此之沉重，看起来像是要生出一窝三只牛头人幼崽似的。[pg]");
         outputText("当你拔出时——珍珠般白浊的精液丝还粘连着你和她那颤抖的肉穴——她的背在狂喜的高潮中弓起，肚子在分娩的痉挛中阵阵收缩。索菲茫然地自言自语，咬住涂满口红的嘴唇，在宫缩加速时把爪子抠进地里。你分开她的膝盖，将手指抵在她肿胀的外阴上，这时一颗表面光滑无痕的蛋挤过她的阴唇，椭圆形的蛋似乎越来越大，直到终于噗地滑出——一颗像葡萄柚那么大的不规则球体滚入你的手中。紧随其后，越来越多的蛋挤向自由，索菲在惊人悦耳的极乐痛楚中尖叫。一堆变成两堆，再变成三堆，你这才意识到她子宫里怕是坏了几十颗蛋，也许是她的身体对产卵灵药 做出了全力以赴的反应。小蛋都排出来后，她的肚子终于平复到一个比较合理的厚度，尽管很明显她还没彻底完完。索菲使尽全力喘息，发出一声巨大的闷哼，双腿尽可能大地分开。在痛苦与狂喜交织的缓慢过程中，她推出了一颗西瓜那么大的蛋，换气过度之后绷紧全身每一块肌肉，紧接着又推出第二颗。她的骚穴在她高潮的蜜液中喷涌，第三颗巨大的蛋滑出后，终于，她看起来排空了。要不是她长着这么宽的生育型髋骨和整整一个青春期的生育经验，你真不确定她能排出这么大号的蛋。即便经历了这一切，她的肉穴似乎还是恢复了平常的大小，那些荒谬的巨大蛋没有留下任何持久性的不良影响。难怪索菲对自己是个妈咪这么自豪——这样一窝蛋换成普通的女人怕是早就毁了。[pg]");
