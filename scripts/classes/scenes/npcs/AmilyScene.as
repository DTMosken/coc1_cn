   ...
   public class AmilyScene extends NPCAwareContent implements TimeAwareInterface, SelfDebug, SelfSaving
   {
      ...
      public function talkWithCuntIMeanAmily(param1:Boolean = false) : void
      {
         ...
         else if(_loc2_ == 1)
         {
            ...
            outputText("[say:你能全身而退真是太幸运了。]艾米莉强调地对你说。[say:牛头人是危险的野兽——它们是周围最大、最强壮、最坚韧的野兽之一。我不敢靠近那座山，因为那里有那些野兽在游荡。有时它们会带着巨大的斧头，但通常它们只用巨大的、骨节分明的拳头就足够了。][pg]");
            outputText("你问她为什么牛头人这么危险；它们看起来并不像恶魔。[pg]");
            ...
            outputText("艾米莉笑了。[say:没有；我只要看到它们就会跑。我本来就不擅长正面战斗，更何况是对付那些野兽？而且不仅仅是它们的力量……我想它们的精液里含有某种让人上瘾的化学物质。仅仅是它们存在的臭味就能让你感到兴奋。有一次，一只牛头人把我逼到了角落；它掏出巨大的马屌开始自慰。]她厌恶地打了个寒颤。[say:我差点被喷到，但那气味……太让人陶醉了，]她承认道，显然很尴尬。[say:我的腿几乎因为兴奋而发软——直接屈服让它操我的诱惑太大了。][pg]");
      ...
      public function talkWithCORRUPTCUNT(param1:Boolean = false) : void
      {
         ...
         if(_loc2_ == 0)
         {
            ...
            {
               outputText("她闻着气味哼哼着。[say: 那是恶魔体液，" + get_player().mf("主人","女主人") + "。喝下去就像喝下液态的腐化。它能把你变成恶魔，或者极大地增强你的女性或男性特征。我听说如果你喝了太多异性的体液，甚至会扰乱你的性别。但这些都不重要，无论你是什么性别，我都乐意喝你的体液，[master]，]她咧嘴笑着说。[pg]");
            }
            else if(get_player().itemSlot(0).itype == get_consumables().SDELITE)
            {
            ...
            {
               outputText("[say: 那是巨蜂的蜂蜜，" + get_player().mf("主人","女主人") + "！]她急切地告诉你，精神振奋起来。[say: 哦，那东西可好吃了！]然后她把目光转向你，半眯着眼睛看着你，漫不经心地吮吸着带爪子的手指。[say: 但我更喜欢吃你的蜂蜜，[master]，]她诱惑地说着，舔了舔手指，一小缕唾液连着她的嘴。[pg]");
            }
            else if(get_player().itemSlot(0).itype == get_consumables().PURHONY)
            {
         ...
         else if(_loc2_ == 1)
         {
            ...
            outputText("[say: 你能毫发无损地逃脱，我一点也不惊讶，[master]，]艾米莉奉承地说。[say: 牛头人是危险的野兽——它们是周围最大、最强壮、最坚韧的野兽之一。我不敢靠近那座山，因为有那些东西在游荡。有时它们会带着巨大的斧头，但大多数只用拳头，]她解释道。[pg]");
            outputText("你问她为什么牛头人这么危险；它们看起来并不像恶魔。[pg]");
         ...
         else if(_loc2_ == 3)
         {
            ...
            outputText("她耸了耸肩，显然也无法解释得更清楚了。你问如何才能避免这种命运。[pg]");
            outputText("[say:嗯，" + get_player().mf("主人","女主人") + "，她们主要利用翅膀发出催眠般的嗡嗡声；但像你这样敏锐又聪明的人，应该很容易就能摆脱它。她们不是那种会使用暴力的人；如果你抵抗了她们的催眠，她们会请求你接受她们的卵，但她们不会试图把你打到屈服再产卵。我绝不会和她们战斗；她们动作很快，而且多亏了那身盔甲，她们相当难对付，而且她们还有一种奇怪的毒液，会削弱你的力量，同时让你发情。但我相信你对付她们肯定没问题，[master]。如果你真的和她们打起来，弄点她们的蜂蜜来；如果你在战斗中弄脏了，我很乐意用舌头给你洗个澡，直到你干干净净为止，]艾米莉说着，慢慢地舔了舔嘴唇。[pg]");
         ...
         else if(_loc2_ == 5)
         {
            ...
            {
               outputText("[say:" + get_player().mf("主人","女主人") + "，你能长出一根更大的鸡巴来操你忠诚的肉便器吗？]");
            }
            else if(get_player().hasCock())
            {
               outputText("[say:" + get_player().mf("主人","女主人") + "，我好发情，你能用你巨大的鸡巴狠狠插进你淫荡的老鼠奴隶体内吗？]");
            }
            else
            {
               outputText("[say:" + get_player().mf("主人","女主人") + "，你能长出一根巨大的鸡巴来操你饥渴的精盆吗？]");
            }
         ...
         else if(_loc2_ == 7)
         {
            ...
            outputText("她恳求地看着你，说道：[saystart]我也喜欢被搞大肚子，" + get_player().mf("主人","女主人") + "。我可以为你生下许多小老鼠，让它们像你应得的那样崇拜你；然后我们就可以一起做爱了。哦，[master]！");
         ...
         else if(_loc2_ == 8)
         {
            ...
            outputText("[say: 我实在不知道您为什么对我的过去感兴趣，" + get_player().mf("主人","女主人") + "。现在最重要的是，我是您淫荡的宠物老鼠，不是吗？]她问道。你说是的，但多了解一下她以前是什么样的人会很有趣。她笑了笑。[say: 很好，[master]。我会尽我所能取悦您。您有什么特别想知道的吗？][pg]");
            outputText("你绞尽脑汁想了一会儿，然后让她讲讲她村子里的生活是什么样的。[pg]");
            outputText("[say: 那真是……相当无聊的话题，" + get_player().mf("主人","女主人") + "。但既然您问了，我就告诉您吧，]她说道；然后停下来想了一会儿。[say: 那是很久以前的事了，但我依然记忆犹新，仿佛就在昨天。在我的记忆中，恶魔们已经出现好几年了……我想我大概是在它们刚出现后不久出生的。事实上，我已经很久没有庆祝过我的初息之日了，连我自己都不知道我到底几岁了。不过这也不重要，我更愿意庆祝我成为您专属精液桶的那一天，[master]。最好还能配上满满一发精液，]她魅惑地笑着说道。接着她继续说，[say: 总之，我们过着那种典型的小村庄生活。我们在湖里捕鱼、游泳、划船，在森林里采集水果、坚果、浆果和蘑菇，我们打猎鸟类和小动物来吃肉。那真的很平静……但也真的很无聊……太无聊了……村里每个人都很保守，在光天化日之下做爱会被当成某种禁忌。这真的很蠢，]艾米莉翻着白眼说道。[pg]");
            outputText("[say: 傻瓜……我们以前就是傻瓜。我们过着傻瓜一样的生活。那时候唯一能进入村子的只有小恶魔，而我们，就像傻瓜一样，还以为自己很安全。哈哈，光是想起这些我就想笑。难怪我的村子会落得那样的下场……而且我一点也不想念它；一刻也不想。作为您忠诚的精盆，我在这里太开心了，" + get_player().mf("主人","女主人") + "。您把我从无聊的村民生活中拯救出来，让我能作为您的肉便器过上光荣的生活……谢谢您，[master]，]艾米莉满眼爱意地看着你，微笑着说道。[pg]");
         ...
         else if(_loc2_ == 9)
         {
            ...
            outputText("[say:我真的不知道您为什么对我的过去感兴趣，" + get_player().mf("主人","女主人") + "。现在重要的是，我是您淫荡的宠物老鼠，不是吗？]她问道。你说是的，但多了解一下她曾经是谁会很有趣。她笑了笑，问道：[say:很好，[master]。我会尽力让您开心的。您有什么特别想知道的吗？][pg]");
            ...
            outputText("你让她讲讲她母亲的事。[pg]");
            outputText("[say:她是个猎人，我想是最出色的猎人之一……她的速度快到能把鹿追到精疲力竭，安静到直到她的刀架在鹿的脖子上，它都不会察觉到她的存在，吹箭的技术更是精湛到能在五十步外把苍蝇钉在树上而不伤其性命，]艾米莉带着一丝骄傲说道。[say:当然，到头来这些都没帮上她什么忙。我是说……她把她知道的一切都教给了我，人们以前常说我长大后会和她一样；然而，我还是被抓住了。谢天谢地，抓住我的是你，" + get_player().mf("主人","女主人") + "。我无法想象自己成为别人性感的宠物鼠肉便器。我爱你，[master]！]她突然大喊，扑向你，抱住你的腰，亲昵地蹭着你的胯部。[pg]");
         ...
         else if(_loc2_ == 10)
         {
            ...
            outputText("[say:当然……那就意味着我不会被这群人里最棒的那个挑中了。]艾米莉抱住你的腰，满眼爱意地抬头看着你。[say:我真高兴得到我的人是你，" + get_player().mf("主人","女主人") + "，]她说着，轻轻蹭了蹭你的胯部。你对她笑了笑，拍了拍她的头。你告诉她，晚点你会考虑重演一次她村庄被入侵的场景，只不过这次她会被抓住。艾米莉眼睛一亮，兴奋地说道，[say:我等不及了，[master]！]你轻笑一声，让她自己去玩了。[pg]");
         }
         else if(_loc2_ == 11)
         {
            outputText("你决定找点乐子，于是问起艾米莉的过去。她翻了个白眼，仿佛光是提起这个话题就让她觉得无聊，但你狠狠瞪了她一眼，立刻让她安分下来。[say: 呃……如您所愿，[master]，]她顺从地回答道。[pg]");
            outputText("[say:我真不知道你为什么对我的过去感兴趣，" + get_player().mf("主人","女主人") + "。现在重要的是，我是你淫荡的宠物老鼠，不是吗？]她问道。你说是的，但多了解一下她以前是什么样的人会很有趣。她笑了笑，[say:很好，[master]。我会尽我所能取悦你。你有什么特别想知道的吗？][pg]");
            outputText("你绞尽脑汁想了一会儿，然后让她告诉你她是如何独自一人在村子里活下来的。[pg]");
            outputText("[say: 嗯，" + get_player().mf("主人","女主人") + "……我拼命跑回了家。我想拿我的猎刀和吹箭。没用的工具……但那时候我也是个傻瓜，]她解释道。[say: 然后我父母出现了，叫我快跑。我不想跑，但我还是听话了……我当时好害怕……不过不知道为什么？那只是性爱而已……美妙、汗水淋漓、黏糊糊、充满精液的性爱，]她如梦似幻地说着，舔了舔嘴唇，冲你抛了个诱惑的笑容。你告诉她，你晚点会想办法奖励她。[say: 我一直拼命跑，直到跑不动为止；然后我躲了起来，躲了整整一夜。直到早上我才醒来，当时饿极了，所以找了点吃的，然后回到了村子。那时我才看到村子已经变成了一片废墟……我很迷茫，生活也支离破碎……谢天谢地，你最终出现救了我，帮我收拾了残局，[master]，]她充满爱意地说。[pg]");
            outputText("你问她平时的日常生活是怎样的？她的作息是什么？[pg]");
            outputText("[say: 很无聊，]她翻了个白眼说道。[say: 我更喜欢现在的生活；我能和我的" + get_player().mf("主人","女主人") + "享受美妙的性爱，还能喝好多精液。这简直是女孩子梦寐以求的，]她微笑着对你说。[say: 总之……我懂足够的知识，知道什么能吃什么不能吃……我还收集了一些炼金材料来制作毒镖，在你给我这具诱人的身体之前，我可是很虚弱的，" + get_player().mf("主人","女主人") + "，]她继续说着，为了配合效果还抚摸着自己的乳房。你责备了她，告诉她没有允许不准自己弄自己。艾米莉赶紧道歉；你摸了摸她的头，告诉她没关系，你晚点会惩罚她的。[say: 谢谢你，[master]，]她咧嘴笑着回答。[say: 除此之外，我也就是躲藏、打猎、觅食、吃饭和睡觉；就这些了。][pg]");
      ...
      public function takeChargeAmilyMouseMilk() : void
      {
         amilySprite(true);
         clearOutput();
         outputText("你思考了一秒钟你想做什么，双手在艾米莉的身体上轻轻游走。在某个时刻，你捏了捏她的一侧乳房——有点太用力了，因为空气中立刻充满了奶香味。你微笑着坐在窝里，哄着困惑的艾米莉也坐下。当你开始脱下她的衬衫时，困惑变成了理解，她高兴地帮助你，让她的" + amilyTits() + "自由地垂下。风很冷，但你确信兴奋也是她" + amilyNipples() + "坚挺勃起的原因，你调皮地依次捏了捏它们，这引起了你鼠娘情人的脸红和有些愤慨的吱吱声。她的双臂轻轻伸出，蛇一般缠绕在你的脖子上，把你拉得更近，你几乎不需要什么鼓励。[pg]");
      ...
      public function rapeCorruptAmily4Male() : void
      {
         ...
         outputText("[say: 求求您，" + get_player().mf("主人","女主人") + "，让我做您的精液桶吧。没有什么比成为您欲望的容器更让我喜欢的了。这就像梦想成真一样！求求您，哦，求求您，[master]！让我怀孕，让我生下更多的老鼠来像您应得的那样崇拜您。][pg]");
      ...
      public function rapeCorruptAmily4Female() : void
      {
         ...
         outputText("[say: 求求您，" + get_player().mf("主人","女主人") + "，让我成为您的精液桶吧。没有什么比成为您欲望的容器更让我渴望的了。这简直就像梦想成真！求求您，哦，求求您，[master]！请允许我让您怀孕，这样您就能生下更多的老鼠来像您应得的那样崇拜您。][pg]");
         outputText("她的话取悦了你，你");
         if(get_player().hasTailInsteadOfLegs())
         {
            outputText("将你的[if (isNaga) {蛇|鱼}]尾巴缠绕在她的头上。");
      ...
      public function giveAmilyAWhiteEgg() : void
      {
         ...
         else
         {
            if(FlagDict_Impl_.arrayReadFloat(KFLAGS.flags,48) < _loc1_)
            {
               outputText("她看着它，会意地笑了。[say:" + get_player().mf("主人","女主人") + "是想把人家的乳头变成淫秽的玩具吗？]她一边接过蛋一边问道。她咬掉顶部，熟练地一口吞下里面的东西。她在手中捏碎蛋壳，拉开上衣，让你看到她的乳头肿胀变大，直到停止生长。她试探性地捏了捏其中一个，被这种感觉震惊得吱吱叫了起来。[say:谢谢[master]给你的荡妇这么棒的乳头玩具。你现在想虐待你荡妇饥渴的小穴吗？][pg]");
            }
            else
            {
               outputText("她看着它，淫荡地呻吟着，[say:我的乳头一定会为你变得超级大的，" + get_player().mf("主人","女主人") + "。不，乳头不对。它们现在是乳房了。你这只鼠辈性奴身上巨大、肿胀的母牛乳房。让我们把它们变得更大吧！]她咬掉顶部，熟练地一口吞下里面的东西。她在手中捏碎蛋壳，拉开上衣，让你看到她的乳头肿胀并垂得更低。她试探性地捏了捏其中一个，被这种感觉震惊得吱吱叫了起来。[say:谢谢[master]让你的荡妇的身体除了做爱什么都干不了。你现在想虐待你荡妇饥渴的小穴吗？][pg]");
            }
            amilyNippleGrow();
         }
         doNext(amilyFollowerEncounter);
      ...
      public function giveAmilyAPinkEgg() : void
      {
         ...
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,43) == 1)
         {
            outputText("你递给她一个粉蛋，解释说这能消除她的阴茎。你话还没说完，她就一把从你手中抢过蛋，狼吞虎咽地咬了下去；她用力咀嚼时，蛋壳发出清脆的响声，她迫不及待地把它整个吞了下去，弄得一团糟。吃完后，她脱下裤子，看着<b>她的阴茎缩小、模糊，最终再次变回了她那娇小的阴蒂</b>。她轻轻地叹了口气。[pg]");
            outputText("[say:谢谢你，这真是让我松了一口气。那么，你还有什么别的想要的吗？]她欢快地吱吱叫着，很明显现在心情非常好。");
         }
         else
         {
            outputText("你递给她一个粉蛋，解释说这能消除她的阴茎。艾米莉看起来完全崩溃了，她说道：[say:是骚货没有把她的肉棒用好吗？精液垃圾桶非常抱歉，[master]，再也不会发生这种事了！]还没等你回答，她就从你手中抢过蛋开始吃了起来，狼吞虎咽地吃着，直到舔干净手指。吃完后，她脱下裤子，看着<b>她的阴茎缩小、模糊，最终再次变回了她那娇小的阴蒂</b>。[pg]");
      ...
      public function corruptAmilysPussyGetsMotherfuckingFucked() : void
      {
         ...
         outputText("[pg]");
         outputText("艾米莉甚至没有翻白眼，她就是这样一个对你无可救药的忠诚荡妇。[saystart]我想要，" + get_player().mf("主人","女主人") + "！我比任何东西都想要！我是一个精液垃圾桶，一个生育机器——我饥渴的小穴需要精液，否则我就会枯萎！求求你，[master]，用你滚烫、咸腥、粘稠的精液填满我！!");
         if(!pregnancy.get_isPregnant())
         {
         ...
         {
            outputText("宝宝们需要精液，" + get_player().mf("主人","女主人") + "。如果你不用你滚烫的造人汁液淹没她们的子宫，她们就不会长得强壮、健康、淫荡！求求你，为了她们，射精填满我好吗？");
         }
         outputText("[sayend][pg]");
         ...
         outputText("艾米莉高兴地尖叫起来，用双腿缠住你的[hips]。她训练有素，不会用它们把你猛拉进她的胯下，但你能感觉到她腿上的肌肉在颤抖，渴望把你拉进合适的插入位置。你邪恶地笑了；虽然你很想深入她的深处，狠狠地操她，但你也想看看在她崩溃之前你能走多远……[say:" + get_player().mf("主人","女主人") + "……求求你……你为什么要折磨自己？把自己交给你充满爱意的小老鼠荡妇吧；在我的双腿间迷失自己，让我饥渴的小穴吞下你的[cock]，像只有我能做到的那样榨干你。任何一个廉价的魅魔婊子都无法带给你我能带给你的快乐……]艾米莉恳求地呻吟着，她的尾巴翘起来抚摸你的" + get_player().assDescript() + "，她的双手玩弄着她的" + amilyTits() + "。[pg]");
         ...
         if(get_player().cockArea(0) >= 61)
         {
            outputText("她紧张得浑身发抖；有那么一瞬间，你以为她会感激地吻你。但紧接着，她想起了自己的身份，向后退去，她的尾巴笨拙地缠绕在你的" + get_player().cockDescript(0) + "上，拉扯着它，试图笨手笨脚地把它弄到位。当龟头擦过阴唇时，你能感觉到她多汁的小穴散发出的热量，但无论她怎么推，似乎就是进不去。她拼尽全力在你的" + get_player().cockDescript(0) + "上推挤摩擦，完全不顾自己是否会因此受伤。你决定在她做出不可挽回的事情之前阻止她。[say:请、请原谅我，" + get_player().mf("主人","女主人") + "。这个荡妇没用的小穴配不上您光荣的" + get_player().cockDescript(0) + "，" + get_player().mf("主人","女主人") + "。]你拍了拍她的头，告诉她也许有一天，她能把你全部吞下，但现在她应该慢慢来。你摩擦着她，尽可能地润滑你的[cock]，一点一点地撑开她。然后，费了一番功夫，你终于把一部分塞了进去。[say:看？这就是你把大肉棒塞进体内的办法，艾米莉，]你告诉她。[say:您真是太聪明了，[master]，]艾米莉评论道。你微笑着说：[say:现在回到你的角色里去，荡妇，]并在她的屁股上狠狠拍了一巴掌。[pg]");
         }
         else
         {
         ...
         outputText("艾米莉在你身上挺动、挣扎；拼尽全力想把自己刺穿在你身上。但在她目前的姿势下，她的尝试充其量只能算是笨拙。你对她未能好好服侍你感到失望，于是把她按在泥土上，痛苦地扭动她的一侧乳头，粗暴地抓住她的头发。[say:这还不够好，精盆。你有什么要为自己辩解的吗？]你平静但充满威胁地问她。[say:原谅我，" + get_player().mf("主人","女主人") + "！但是这个毫无价值的荡妇不知道如何更好地取悦您……求您了！教教我怎么取悦您，[master]！]她乞求着你，听起来一点也不害怕你，也没有因为你的粗暴对待而感到痛苦；你在她眼中看到的只有欲望，以及想要取悦你、被你操的压倒性渴望……[pg]");
         ...
         outputText("等你喘过气来，你站起身，从艾米莉的怀抱中挣脱出来。她自己也站了起来，对刚才的举动感到有些尴尬。[say: 我让您满意了吗，" + get_player().mf("主人","女主人") + "？] 她期待地等待着你的评判。你微笑着摸了摸她的头，告诉她是的；她确实让你很满意。你评价说她的演技还算不错。她微笑着回答，[say: 谢谢您，" + get_player().mf("主人","女主人") + "。我喜欢我们这场小小的戏剧……我最喜欢的部分是当我像一只发情的母狗一样被当作肉便器使用的时候，] 她满怀爱意地说。你揉了揉她的头发，告诉她她还有工作要做。艾米莉喘了口气说，[say: 当然，请原谅我，[master]，]，然后她开始把你的[cock]舔干净。");
         if(get_player().hasVagina())
         {
      ...
      public function amilyPopsOutKidsInCamp() : void
      {
         ...
         else
         {
            ...
            outputText("艾米莉深情地蹭了蹭你的胯部，然后说道，[say:看，" + get_player().mf("主人","女主人") + "，我们的孩子已经迫不及待地想为您服务了。]你低头看着她，她也抬头看着你。最后，艾米莉转过身来对聚集的孩子们说，[say:抱歉，亲爱的，但你们还没准备好为" + get_player().mf("主人","女主人") + "服务。如果你们想要这个……]她说着，再次蹭了蹭你的胯部，[say:你们需要先积累一些经验。]孩子们都低下头，失望地呜咽着，因为他们无法靠近母亲的宝藏而感到难过。[say:好了，好了，别绝望，我美丽的小荡妇们。如果你们去外面的世界，我相信你们很快就能积累到为[master]服务所需的经验。现在给妈妈一个告别吻。][pg]");
            outputText("老鼠们立刻精神振奋，冲向艾米莉，她轮流给他们每个人一个吻；然后调皮地拍拍他们的小屁股，把他们一个个送进丛林。当最后一个离开时，你祝贺艾米莉是个好荡妇，生了这么多可爱有潜力的玩具，[say:谢谢" + get_player().mf("主人","女主人") + "！]她高兴地说。然后她再次蹭了蹭你的胯部，补充道，[say:如果" + get_player().mf("主人","女主人") + "想再次让我怀孕，尽管说。你的老鼠小荡妇随时准备接受并生出更多的荡妇来崇拜你，加入你的后宫，我的[master]。]你拍了拍她的头，离开去处理其他事务。");
            get_player().orgasm("Generic");
            dynStats(DynStat.Cor(3));
         }
      }
      ...
      public function amilyFollowerEncounter() : void
      {
         ...
         switch(pregnancy.get_event())
         {
            case 2:
               ...
               {
                  outputText("你注意到艾米莉似乎生病了。尽管如此，她似乎对某件事感到很高兴。你想知道发生了什么事，决定问问她；艾米莉对你咧嘴一笑。[say:哦，" + get_player().mf("主人","女主人") + "！你做到了！你要当爸爸了……我等不及要为你生更多的小老鼠荡妇了，[master]。][pg]");
               }
               break;
            case 3:
            case 4:
      ...
      public function amilyCorruptSexMenu() : void
      {
         ...
         {
            outputText("你急切地脱下你的[armor]，向你那满眼崇拜的淫荡鼠娘展示自己……但当她的目光落在你光秃秃的胯部时，她发出了一声惊恐的尖叫。[say: 没有！那里什么都没有！" + get_player().mf("主人","女主人") + "，你的生殖器怎么了？]她惊慌失措地尖叫着，手脚并用地冲上前来，把脸狠狠地埋进你的胯部。[pg]");
