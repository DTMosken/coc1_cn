package classes.scenes.npcs
{
   ...
   public class ShouldraScene extends NPCAwareContent implements TimeAwareInterface
   {
      ...
      public function slimeyPenorsAhoy() : void
      {
         ...
         outputText("随着幽灵史莱姆娘的目光转移到你被困住的身体上，她那越来越绿的眼睛里露出疯狂的神色，特别关注着你抽搐、变软的阴茎。虽然你希望这场骑乘能结束，但她近乎歇斯底里的表情向你保证，这不会很快结束。另一个法术开始从她口中念出，让你只能猜测这个法术会做什么。你的阴茎开始发热，很快从“温暖”攀升到“令人不适的滚烫”。违背你的意愿和（大部分）你的愿望，你的阴茎再次勃起，被已经摩擦着它的、对体液疯狂的幽灵黏液所迷惑。她一定是疯了；她现在的身体还能装下多少？当");
         if(get_player().balls > 0)
         {
      ...
      public function slimeGhostGalForHerms(param1:Boolean = false) : void
      {
         ...
         outputText("[pg]在你们之前几次黏糊糊的交欢中，她的自信从来都不是问题。她的言语中似乎没有哪怕一丝一毫的扭曲。她的形态看起来确实比你记忆中她能做到的要令人印象深刻得多。这团被附身的软泥比你见过的任何史莱姆娘都要坚实。它甚至在幽灵女孩原本长雀斑的地方有轻微的酒窝。");
      ...
      public function sharkyEctoginas() : void
      {
         spriteSelect(SpriteDb.get_s_ghostGirl2());
         clearOutput();
         outputText("随着她的招手，你挑起眉毛，走向这个被幽灵附身的鲨鱼女孩。幽灵没有说话，而是指了指她的下半身，那里依然（勉强）被黑色的比基尼包裹着。让她感到困惑的是，灰色的手臂痉挛起来，因为宿主正在反抗这场第三方的强暴。鲨鱼女孩似乎差点就成功了，黄色的眼睛甚至稍微改变了色调，但幽灵女孩又把自己塞回了主导地位。尽管还有持续挣扎的迹象，她还是用那只再次变成琥珀色的眼睛向你眨了眨眼，并满怀期待地用手抚摸着她粗糙的大腿。你把她往后推，直到她被迫用鲨鱼尾巴作为三脚架支撑身体，然后你蹲下身子，与她那海洋生物般的下体平齐，布料上滴落着水、汗水以及偶尔渗出的一小滴淫液的混合物。你轻轻舔了一下，对舌尖传来的咸味并不感到意外，然后开始以越来越大的力度舔弄。她的双腿因初现的兴奋而颤抖，呼吸变得急促，喉咙里逸出短促的呻吟和性感的叹息。你用手指勾住她的比基尼泳裤，准备露出她的私密部位，但当她的臀部突然膨胀，将布料再次紧紧贴在肉上时，你停了下来。你抽出手指，向后靠去，意识到你即将见识到她法术的效果。幽灵女孩发出一声特别充满激情的呻吟，但随后又被一声担忧的喘息打断。鲨鱼女孩的面容在她分心时瞬间重组，显露出附身者特征的痕迹。在注意到并纠正了这一疏忽后，她转向你。[saystart]……我想……我施放了……错误的法术……");
      ...
      public function penisLossThatIsntALoss() : void
      {
         ...
         else
         {
            if(!(get_player().get_inte() < 90 || get_player().cockThatFits(80) == -1))
            {
               ...
               outputText("她气呼呼地转身要走，但你用一个心灵感应命令阻止了她。你提醒她，她现在是你的了，既然她费尽心思试图让你高潮，她不妨把事情做完。尽管她撅起嘴唇，固执地生着闷气，但一股支配性的影响浪潮席卷了她，她不由自主地开始摇摇晃晃地走向你。你决定迎上前去，大步走到她面前，把她按在你的膝盖上。在她的注视下，你脱下你的[armor]，把你的" + get_player().cockDescript(_loc1_) + "举到她的唇边，非常明确地暗示了你的期望。幽灵女孩看到你的男性象征，眼睛睁得大大的，随着新一波的兴奋席卷全身，她畏缩了一下。她因为无法平息自己压倒性的性欲而发出一声小小的呜咽，但你只是嘲弄地笑着，指了指你的男性象征。[say:幽灵口交，]你冷嘲热讽地嘟囔着。[pg]");
