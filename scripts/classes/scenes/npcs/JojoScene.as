package classes.scenes.npcs
{
   ...
   public class JojoScene extends NPCAwareContent implements TimeAwareInterface, SelfDebug, SelfSaving
   {
      ...
      public function jojoMutationOfferYes() : void
      {
         ...
         outputText("你舔着那根尖锐的水晶假阳具，用唾液把它涂满。你不确定，但你似乎无法停下来。就好像某种恶魔的力量在引导着你。除了你自己的兴奋，以及品尝这块女神精华时传遍全身的刺痛感之外，你很难把注意力集中在其他事情上。你的思绪飘向了一个变态的幻想，无法应对完全失控和口交的放荡。");
         outputText("[pg]==========================================");
         outputText("[pg]<i>");
         if(get_player().get_gender() <= 1)
         {
      ...
      public function jojoCamp() : void
      {
         ...
         else
         {
            ...
            else
            {
               ...
               {
                  case 0:
                     outputText("你走向乔乔平时坐的那块巨石，看到他闭着眼睛盘腿坐着" + (get_akky().location == "Jojo" ? "，他的腿上睡着[akky]" : "") + "。起初他似乎正在深度冥想，但当你靠近时，他的嘴角泛起一丝微笑；他站起身，睁开眼睛，用欢迎的神情看着你。[say: 你好，[name]，有什么我可以帮你的吗？][pg]");
                     break;
                  case 1:
      ...
      public function corruptCampJojo() : void
      {
         ...
         else
         {
            ...
            if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,1101) == 1)
            {
               ...
               outputText("[pg]你一言不发地伸出手。乔乔颤抖着，把一瓶梦魇药剂放在上面。");
