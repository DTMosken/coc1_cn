   ...
   public class Valeria extends NPCAwareContent implements TimeAwareInterface
   {
      ...
      public function valeriaSexDominated(param1:Boolean = false) : void
      {
         ...
         if(get_player().hasVagina() && (!get_player().hasCock() || Utils.rand(2) == 0))
         {
            ...
            outputText("。黏液女孩从背后抱住你，抓住你的[chest]，揉捏着你的乳房，掐着你的乳头。[say: 给我叫，婊子，]瓦莱丽娅在你耳边低吼，特别用力地扯了一下你的[nipples]。你发出一声淫荡的呻吟。黏液女孩咧嘴一笑，舌头伸出来舔你的耳朵，同时奖励你一次长长的深入，完全填满并撑开你的[vagina]和[asshole]，然后才拔出来。");
            ...
            outputText("[pg]你在她的命令下高潮了，淫液从你的[vagina]喷涌而出，流进塞在你小穴里的黏液肉棒里。你的两个洞都紧紧地收缩，夹紧了瓦莱丽娅的肉棒。黏液女孩大笑着吸收你的淫液，随着你的喂食，她变得越来越大，直到她高高地耸立在你上方，她巨大的肉棒现在痛苦地撑开你的肉壁。[say: 哦，太棒了。好女孩，真乖。对，全射出来，就像这样……就像这样，]她轻声哄着，吸收着你的汁液，直到你的高潮终于过去。满足后，她从你体内拔出，让你站起来时，你的肚子里留下了一种明显的空虚感。");
         ...
         else
         {
            ...
            outputText("[pg]你高潮了，浓稠白色的精液从你的肉棒喷射而出，射进黏液女孩等待的身体里。黏液女孩大笑着吸收你的精液，随着你的喂食，她变得越来越大，直到她高高地耸立在你上方，她膨胀的乳房和肚子现在悬在你上方。[say: 哦，太棒了。好[boy]，真乖。对，全射出来，就像这样……就像这样，]她轻声哄着，吸收着你的精液，直到你的高潮终于过去。");
            ...
            outputText("[pg]黏液女孩用力地骑着你，在你的肉棒上弹跳，直到你的臀部和大腿上溅满了散落的黏液和精液。你不得不佩服她——在她粗暴的服侍下，你无法保持疲软，没过多久你就又硬如磐石了。瓦莱丽娅回头对你咧嘴一笑，但一刻也没有放松。你可以感觉到你的高潮再次升起，但就在你的肉棒开始跳动时，瓦莱丽娅以一个快速流畅的动作把自己从你身上抬起，留下你在空中无力地挺动臀部。由于你的双手被黏液牢牢束缚，你无法释放自己。");
      ...
      public function valeriaGooRapeII() : void
      {
         ...
         outputText("，这次你眼角余光瞥见了它。那是黏液女孩的核心，被一只深蓝色的拳头紧紧握住。它被举在你面前时，发出微弱的脉动，而微妙的震动和温度变化提醒你，这两个女人之间正在进行某种秘密交流。她们到底在计划什么？");
         ...
         if(!get_player().isPregnant() && get_player().hasVagina())
         {
            ...
            outputText("[pg]在那里，蔚蓝色的柱体用力撞击着你子宫那狭窄的开口，用坚定的压力推挤着，直到一些黏液滚入你空荡荡的孕育室。你忍不住对这种极其彻底的双重填塞感大叫出声。你皱着眉头，忍受着内部通道被缓慢拉伸的感觉，一旦那钻洞的黏液在你子宫里建立了一条足够大的通道，外部就会像你屁股里的那个一样凝固。你的[clit]上开始产生吸力，以分散你对这感觉的注意力，而它的成功证明就是你的[vagina]喂给这些混合黏液女孩的大量淫水。");
         }
         ...
         outputText("，随着瓦莱丽娅的形状逐渐在你周围重新凝聚，你呻吟着。黏液女孩的核心从视线中消失，然后出现在南边，紧贴着你的[asshole]，因为把你填得满满的“管子”融化成了黏液。当它滑过你的括约肌时，你在肛门的狂喜中尖叫，牢牢地卡在你的屁股里，而里面的胶状块在抽搐，以所有正确的方式摩擦着你的肠壁，几乎就像它自己在经历高潮一样。");
      ...
      public function valeriaGetFucked() : void
      {
         ...
         if(!get_player().hasCock() && get_player().hasVagina())
         {
            outputText("[pg]瓦莱丽娅对你微微一笑，仍然抓着她的阴茎，开始把它向下推。她的肉棒顺着她的身体向下滑动，这种方式只有黏液女孩的附肢才能做到，它的根部顺着她的腹股沟向下移动，直到她的肉棒湿漉漉地落在你[vagina]的阴唇上。虽然她的阴茎整齐地停留在你的入口上方，但瓦莱丽娅只是对你微微一笑，再次向下推。她黏糊糊的阴茎向内折叠，用黏液涂满你的阴唇，她实际上把自己倾泻进你的体内，重组她的阴茎，完美地填满你渴望的[vagina]的每一个缝隙。");
            ...
            {
               outputText("黏液女孩仍然微笑着，把脚从你的胸口抬起。你只能眼睁睁地看着她娇小的双脚旋转弯曲，重组成一对巨大的、带有龟头冠状沟的马阴茎。你还没来得及惊呼，她就把两根野兽般的肉棒深深地插入你的[chest]。当黏液女孩对你进行三重插入，将她的三根阴茎猛烈地插入你被撑开的阴户和你胸部的洞里时，你像个荡妇一样呻吟着。");
            }
         ...
         {
            outputText("[pg]随着你的肉棒塞进瓦莱丽娅温暖黏稠的体内，这个黏液女孩开始在你的大腿上前后摇晃，把她的整个下半身当成一个湿透的小穴来骑乘你的肉棒。她手里握着自己的肉棒向下压，让肉棒的根部顺着她的身体向下移动，直到它弯曲绕过你的臀部，并在你的[butt]上方重新成型。你瞪大了眼睛，但当你试图惊呼时，瓦尔粗暴地把她的一只脚塞进了你的嘴里。[say:嘘，搭档，]她笑着，用她柔软、带有柑橘味的脚趾弹着你的舌头，[say:顺其自然吧……会很爽的，我保证。]");
            outputText("[pg]你无可奈何地任由这个黏液女孩为所欲为。当她的黏液肉棒在你的臀瓣间滑动时，你尽力放松自己，她的肉棒保持着刚好足够的硬度，让她能在你的臀瓣间摩擦。但她并没有插入，反而似乎暂时满足于在你的大腿上摇晃臀部，骑乘着你的[cock]，用她自己的肉棒操弄你的臀瓣。当她骑乘你时，瓦莱丽娅把脚往你嘴里塞得更深了些，将她的腿倾注进你嘴里，直到你领会了她的暗示，开始吮吸她娇小的脚趾，轻松地将舌头滑入她柔软的身体，品尝她的内在。");
      ...
      public function valeriaFollowerMenu() : void
      {
         ...
         if(get_player().get_armorName() == "goo armor")
         {
            ...
            outputText("[pg]这个不寻常的史莱姆女孩相当快地从你身上滑落，带走了她的盔甲。她看着你，变成了稍微亮一点的蓝色。");
      ...
      public function valeriaCampLines() : void
      {
         ...
         {
            outputText("黏液女孩瓦莱丽娅目前正在营地里偷懒。当她注意到你看着她时，她从身体里伸出一条新的手臂，高兴地向你挥手。");
         }
         else
         {
      ...
      public function valeriaAppearance() : void
      {
         ...
         outputText("瓦莱丽娅是一个6英尺高的黏液女孩，由粘稠的蓝色黏液组成。她目前穿着一套板甲，挥舞着她的黏液巨剑作为武器。她有一张美丽的女性面孔，五官轮廓分明，留着一头短短的黏液头发，刚好垂过脸颊。她的臀部大小适中，有着肌肉发达、手感极佳的屁股。与大多数黏液生物不同，瓦莱丽娅用她黏糊糊的下半身形成了两条正常的人类腿，末端是正常的人类脚。");
      ...
      public function valeriaAndGooThreeStuff() : void
      {
         ...
         outputText("她出人意料地从一个意想不到的角度施加压力，扭曲了你的身体，让你头朝下，径直摔向那个你刚刚才打败的、睁大眼睛的黏液女孩！");
      ...
      public function talkWithValeria() : void
      {
         ...
         outputText("[pg]你翻了个白眼，在几句客套话之后，试探着问她……嗯，她到底是个什么东西。她一点也不像在玛瑞斯游荡的普通黏液女孩。她会说话，用两条腿走路……");
         ...
         outputText("[pg]改变了？");
         outputText("[pg][say: 嗯，是的。恶魔刚来的时候。其中一个带走了我，然后……改变了我，]她轻声说道，迅速移开视线。[say: 我不知道那时候有没有真正的黏液女孩或史莱姆。我想我算是个实验品——也许是个原型。不过，恶魔用在我身上的魔法和现在创造黏液的魔法不太一样。我的心智能力和以前一样，能说话，能用两条腿走路……一切都一样。最大的变化就是会发生这种破事，]她补充道，捡起附近的一块石头戳进自己的肚子里。石头在她体内无力地漂浮着，透过她黏糊糊的皮肤隐约可见。");
      ...
      public function penetrateValeria() : void
      {
         ...
         outputText("[say: 嗯，这根鸡巴看起来真美味，]当你脱下衣服，让你的[cock]自由垂下时，瓦莱丽娅说道。[say: 我可能得取个样本，]她轻笑着，在你面前蹲下，将你的肉棒握在手中。然而，这位黏液女孩并没有给你一个简单的手淫，而是将她的手掌贴在你的龟头上，向前按压。");
         outputText("[pg]当她黏糊糊的皮肤分开，让你的[cock]滑入她体内时，你倒吸了一口凉气。她的手掌和前臂就像一个紧致、湿润的飞机杯，随着你齐根滑入她体内，它们变移并塑形，完美地贴合你的肉棒。她抬头对你咧嘴一笑，给了你一个只有黏液女孩才能做到的手淫，用她那可穿透的手掌像小穴一样。当她移动手臂，在她体内慢慢抚弄你的鸡巴，偶尔改变动作，在你周围画大圈或左右移动时，你发出呻吟。");
         outputText("[pg]然而，还没等你觉得太舒服，瓦莱丽娅就向前挪动，伴随着一声湿润的“啵”声，将你的[cock]从她的手臂移到了她的乳房上。她挤压着她那盈盈一握的C罩杯，倾身向前，让你的鸡巴滑入它们之间，进入她黏糊糊的肉体中。当黏液女孩开始用乳房操你，将她湿润的乳房沿着你肉棒的长度滑动，龟头在她那像小穴一样的内部进进出出时，你呻吟着，她内部那种令人愉悦的湿润和温暖又回来了。");
         ...
         outputText("[pg]瓦莱丽娅似乎也感觉到了即将到来的高潮；她从你的抓握中融化，滑了回去，刚好在你的触及范围之外。[say: 啧，啧。我还没玩够呢，[name]，]她戏弄道，当你试图抓住她，渴望释放时，她向后滑行。她对你摇了摇手指，拒绝你接触她的身体，但她的脸上却浮现出“过来”的神情。你追逐着她，你那勃起的怒火需要她的安抚，但她巧妙地躲避着你，直到高潮的威胁过去。直到那时，黏液女孩才慢下来，让你粗暴地抓住她的肩膀，把她扔到地上。");
         ...
         outputText("[pg]瓦莱丽娅大笑着，当你被她用双腿缠住背部拉近，将你的脸埋在她的乳房之间，将你的臀部和鸡巴深深地陷入她的胯部时，你大叫起来。她把你拉得更深，强迫你的脸进入并穿过她的皮肤，直到你几乎被黏液女孩吞没，只有你挣扎的[legs]留在她体外。瓦莱丽娅咯咯笑着，拍了拍她的肚子，让你只能透过周围的黏液感觉到她手的触摸。");
      ...
      public function isabellaAndValeriaSpar() : void
      {
         ...
         outputText("[pg][say: 哎哟。]瓦莱丽娅回答道，片刻之后她的头又重新出现在脖子上。当被砍下的头颅分解并被重新吸收到瓦莱丽娅的脚里时，牛娘吓得向后跳去。黏液女孩转动着下巴，夸张地扭了扭脖子。[say: 嘿，挥得不错，伊兹。不过，呃，你可能得看着点你挥剑的方向。]");
      ...
      public function gooFlation(param1:Boolean = true) : void
      {
         ...
         outputText("[pg][say: 嘿，搭档，]你听到从你体内传来一阵笑声。还没等你对体内的黏液女孩说些什么，你的肚子就咕噜作响。你弯下腰，一半是快感一半是痛苦，因为有什么东西在你体内猛烈地倾斜。你感觉到一股急流冲出你的结肠，你刚蹲下，瓦尔就伴随着一次巨大的推力从你的屁股里爆炸般地冲了出来。你高潮了，当瓦莱丽娅从你的屁股里弹出来，从你被撑开的括约肌里倾泻而出时，一次肛门高潮震撼了你的身体。");
         if(param1)
         {
            outputText("[pg]你瘫倒在地，黏液从你被蹂躏的身体里自由地流淌。瓦莱丽娅大笑着从你的大腿上流下，");
            if(get_player().get_gender() > 0)
      ...
      public function declineValeriasNeeds() : void
      {
         spriteSelect(SpriteDb.get_s_valeria());
         clearOutput();
         outputText("你皱起眉头，推开了这个黏液女孩。你对她那堕落的“需求”毫无兴趣，尤其是看到她脸上那副表情。你推她时，她倒吸了一口凉气，差点摔倒；她稳住身子，愤怒地瞪着你。");
      ...
      public function birthOutDatGooSlut() : void
      {
         ...
         outputText("[pg]当你的[asshole]张开，露出黏液女孩光滑的核心时，你得到了答案。当它逐渐滑过你被撑开的肛门并释放出奔流的黏液时，你被迫在狂喜中颤抖。你弯下腰，双手撑地，让它通过，在它离开你的身体时抚摸你的方式让你意外地高潮了，像个");
