package classes.scenes.npcs
{
   ...
   public class CeraphFollowerScene extends NPCAwareContent implements TimeAwareInterface, SelfDebug, SelfSaving
   {
      ...
      public function layEggsInSlaveCeraph() : void
      {
         ...
         outputText("[pg]她做得更好了，但为什么不看看她能把她那堕落的身体发挥到什么程度呢？[say:再张大点！]你吼道。塞拉芙毫不犹豫地将手指滑入她湿透的肉穴里，把它拉开，直到你能看到她的内部。一片由各种深浅不一的紫色和黑色触手和肉瘤组成的森林，在她阴道的每一个内表面上蠕动着。看到它们移动确实让你感到有点恶心，但同时，你也不禁注意到从腹股沟蔓延开来的刺痛的兴奋。");
      ...
      public function getCeraphFollowerPiercing() : void
      {
         ...
         outputText("塞拉芙问道，[say: " + get_player().mf("主人","女主人") + "，在你走之前，你想不想用以前的方式，最后再操一次你的荡妇？]");
         menu();
      ...
      public function fuckFollowerCeraphsVagoo() : void
      {
         ...
         clearOutput();
         ceraphSprite(true);
         outputText("你让塞拉芙知道你要用她的小穴。她叹了口气说，[say:是的，" + get_player().mf("主人","女主人") + "，]无法掩饰她语气中的失望。塞拉芙动了动，她衣服上的内裤褪去，露出她滴水的阴户");
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,288) == 0)
         {
         ...
         if(get_player().cor < 33)
         {
            outputText("她四肢着地，然后把脸颊贴在泥土上。她的双臂在背后交叉，突然被同样凭空出现的内裤绑在那里，打了个结。她只靠膝盖、乳房、肩膀和脸支撑着，问道，[say:抓住我，操我，" + get_player().mf("主人","女主人") + "，请把您奴隶的脸按在泥土里摩擦！][pg]");
         }
         else if(get_player().cor < 66)
         {
      ...
      public function encounterZetsuko() : void
      {
         ...
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,406) == 1)
         {
            ...
            outputText("[say: 绝子想知道" + get_player().mf("主人","女主人") + "是否可以……解开她的外套？]她说着，在拘束服里稍微挣扎了一下。[say: 女主人绑得有点太紧了……][pg]");
            outputText("当她转过身向你展示她的束缚时，你发现她背上别着一张小纸条，于是伸手拿了下来。这似乎是塞拉芙写给你的。[pg]");
            outputText("[saystart]" + get_player().mf("主人","女主人") + "，");
            ...
            outputText("[say: " + get_player().mf("主人","女主人") + "不打算放绝子出来，是吗？呵呵……太聪明了……绝子是个坏女孩，是的……有很多坏习惯，试图欺骗" + get_player().mf("主人","女主人") + "。女主人试图教导她，但绝子觉得做坏事太有趣了。][pg]");
            ...
            outputText("[say: 绝子的小穴合" + get_player().mf("主人","女主人") + "的心意吗？]她说着，躺在背上，进一步张开双腿，骄傲地向你展示她那畸形的附肢，开始用舌头舔自己的阴蒂，轻轻弹动她的阴蒂环。[pg]");
      ...
      public function carryCarephsToken() : void
      {
         ...
         outputText("塞拉芙问道，[say: 那么，在我的" + get_player().mf("主人","女主人") + "离开之前，你想不想用以前的方式，最后再操一次你的新荡妇？][pg]");
      ...
      public function barkOrMeowTwiceToCeraph(param1:Boolean = true) : void
      {
         ...
         if(_loc3_ == 0)
         {
            if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,682) == 0)
            {
               ...
               outputText("了吗？玛莱母亲到底为什么要派我出来感谢像你这样的人？太可悲了！[sayend] 她从树冠上降下来，一排像鸡巴一样的触手向你袭来，而塞拉芙则在一旁饶有兴致地看着。它们开始拍打你的头，用力比必要的稍微大一点，像居高临下的手一样在你的背上摩擦。她笑着抚摸你，很高兴看到你处于这样的境地。这种羞耻感比牛头人的精液还要强烈，当它与你恶魔般的“项圈”的魔法结合时，它在你的脑海中扭曲，与兴奋不可阻挡地交织在一起，让你漏得更厉害了。沉浸在这些令人怜悯、居高临下的抚摸中感觉真是太棒了。");
            }
            else
            {
               ...
               outputText("，[sayend] 她说道，看到你如此堕落，不再关心服从你的事情，她感到非常兴奋。这种羞耻感比牛头人的精液还要强烈，当它与你恶魔“项圈”的魔法结合时，它在你的脑海中扭曲，与性欲不可阻挡地交织在一起，让你流出更多的淫液。沉浸在这些可怜、居高临下的抚摸中感觉真是太棒了。");
