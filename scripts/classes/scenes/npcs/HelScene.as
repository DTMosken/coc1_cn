package classes.scenes.npcs
{
   ...
   public class HelScene extends NPCAwareContent implements TimeAwareInterface
   {
      ...
      public function minosRBadNoFuck() : void
      {
         clearOutput();
         spriteChooser();
         outputText("你想知道她是否只是没有意识到牛头怪精液的危险，或者她只是不在乎。无论哪种方式，你都不会袖手旁观。");
         outputText("[pg]你走近这对男女，试图把他们分开。他们一开始太沉迷于性爱了，并没有真正关心，但当他们注意到你的干预时，他们开始无意识地反抗，像赶走烦人的昆虫一样把你拍开。[if (strength > 90) {你设法把他们推开，你巨大的力量压倒了这两个野兽|这需要你付出巨大的努力，但你设法把这两个野兽推开了}].[pg]牛头怪的阴茎从赫莉娅的阴户中退出，发出一声清晰的“啵”声，他们混合的汁液呈拉丝状涂满了他们的腿和地面。牛头怪本能地对你做出反应，准备攻击，但你设法用迅速的一击击中了他已经受伤的腹部，使他失去了行动能力，这只野兽发出一声长长痛苦的呻吟，然后他决定今天不是他的好日子。你转过身，面对赫莉娅。[pg][say: 怎么了，亲爱的？如果你想操我，我们可以晚点再做！如果你想操他，自己去找一个，好吗？]她说道，明显对在性交中途被打断感到恼火。你叹了口气，告诉她你只是帮了她。她的脸扭曲成轻微的困惑。[say: 亲爱的，我操过的牛头怪几乎和我打成肉酱的一样多。我从来没有费心去数，但有很多。你怎么可能是在帮我？]");
      ...
      public function helMinotaurThreesome() : void
      {
         ...
         outputText("你继续漫无目的地走了几分钟，比平时在平原上走得更靠近山脉。然而，当你继续走的时候，你突然听到一声像牛一样的吼叫！你摆出战斗姿态，举起你的[weapon]，几乎可以肯定这吼声一定是一只游荡的牛头怪发出的，但你什么也看不见。你竖起耳朵，开始追踪那一次又一次重复的声音。你的目光锁定在附近的一座小山上，你迅速跑到山顶，准备干预正在发生的任何袭击。[pg]");
         outputText("好吧，那确实是个牛头怪。但如果说有什么袭击正在发生的话，那就是那个可怜的兽人正在受害。你看到你的火蜥蜴朋友，她的剑和比基尼被随意地扔在一边，正狂热地骑在牛头怪的牛巴上，在他的肉棒上弹跳着，因为他塞进她体内的充实感而大声呻吟着。[pg]");
         outputText("她从肩膀上方注意到了你的靠近，停止了揉捏她丰满的乳房，只为了向你挥手。[say: 嘿，亲爱的！我——呃！——我通常会向你挥剑，但是——哦，是的！——我有点——快点，你这个软蛋混蛋！操我！——现在很忙。][pg]");
         outputText("你忍不住对这荒谬的一幕笑了起来。她转过头对你咧嘴一笑，但当她双腿间的牛头怪挺动臀部，将他的阴茎深深埋入她欢迎的阴户时，她停下来喘息着。[saystart]好吧，别光站在那里，杀手！");
         if(get_player().hasCock())
         {
         ...
         addButton(1,"舔牛头怪",helMinoThreeSomeLickItsDick);
         addButton(2,"牛头怪很坏",minosRBadNoFuck).hint("你不想靠近牛头怪的精液，她也不应该。");
