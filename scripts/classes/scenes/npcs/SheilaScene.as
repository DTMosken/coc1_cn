package classes.scenes.npcs
{
   ...
   public class SheilaScene extends NPCAwareContent implements TimeAwareInterface
   {
      ...
      public function apologySheilaSlapSult() : void
      {
         ...
         outputText("[pg][say: 去你妈的，混蛋！]她打断你，反击道。[say: 我可不会站在这儿，任由某个一冒出来就以为自己遇到的所有人都会被[his]魅力迷得神魂颠倒、把[he]当成故事书里的英雄" + get_player().mf("","ine") + "的蠢货来臭骂！你要是想找个一听你说“你好”就愿意当你灵魂伴侣的姑娘，就去那些地精贱货那儿捡别人玩剩下的吧！]");
