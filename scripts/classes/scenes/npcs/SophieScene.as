package classes.scenes.npcs
{
   ...
   public class SophieScene extends BaseContent implements TimeAwareInterface
   {
      ...
      public function tellSophieYoureForagingForStuff() : void
      {
         ...
         outputText("你花了一点时间才让她明白情况，但在冗长的解释之后，这只鹰身女妖终于明白了。她不理解你的理由，但至少她知道你的任务对你来说有多重要。索菲叹了口气，显然对这个话题感到无聊，她张开粗壮的大腿，开始用手指在她那肿胀的阴户入口处画圈。看到她如此明目张胆地自慰，你微微睁大了眼睛，而你自己的身体也因为性唤起而发热。虽然她的姿势很开放，但这只不知羞耻的鹰身女妖似乎并不想要一个伴侣。你领会了她的暗示，知道她不想再谈了，于是爬了下去。[pg]");
