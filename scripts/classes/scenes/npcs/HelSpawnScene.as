package classes.scenes.npcs
{
   ...
   public class HelSpawnScene extends NPCAwareContent implements SelfDebug, SelfSaving
   {
      ...
      public function snipermanders() : void
      {
         ...
         {
            outputText("你听到营地对面突然传来一声痛苦的尖叫。瓦莱丽娅滑行到你面前，她黏糊糊的脸上带着恼怒的神情，用指责的手指着插在她乳房上的一支箭。[say: 该死，[name]，我是个史莱姆娘，不是针垫！]你挥手打发她走，并告诉[helspawn]再试一次。");
         }
         else if(get_latexGirl().latexGooAtCamp())
         {
            outputText("你听到营地对面突然传来一声痛苦的尖叫。[latexyname]滑行到你面前，她黏糊糊的脸上带着恼怒的神情，用指责的手指着插在她乳房上的一支箭。[say: 该死，[name]，我是个史莱姆娘，不是针垫！]你挥手打发她走，并告诉[helspawn]再试一次。");
         }
