package classes.scenes.npcs
{
   ...
   public class AnemoneScene extends BaseContent implements TimeAwareInterface
   {
      ...
      public function timeChange() : Boolean
      {
         ...
         if(get_player().hasStatusEffect(StatusEffects.AnemoneArousal))
         {
            if(get_player().get_pregnancyIncubation() > 1)
            {
               ...
               outputText("<b>你体内那个像海葵一样的生物强加给你的近乎持续的性唤起终于消退了。你把手指伸进体内，惊奇地发现——它不见了！你不确定它是滑出来了，还是你的身体不知怎么地把它吸收了，但能有一个更清醒的头脑真是太好了。</b>[pg]");
            }
            else if(!get_player().hasVagina())
            {
               get_player().removeStatusEffect(StatusEffects.AnemoneArousal);
               outputText("<b>你体内那个像海葵一样的生物强加给你的近乎持续的性唤起终于消退了。你不确定它是因为你的阴道被移除而被吸收了，还是在这个过程中逃脱了，但能换个清醒的头脑真是太好了。</b>[pg]");
            }
            _loc1_ = true;
         }
         return _loc1_;
      ...
      public function mortalAnemoneeeeee() : void
      {
         ...
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,453) == 0 || get_player().hasItem(get_consumables().MINOCUM))
         {
            ...
            else
            {
               ...
               outputText("最初的惊讶消退后，随之而来的是头晕目眩和轻微的性唤起感，因为她触手上的刺细胞找到了暴露的皮肤。在溺水的恐慌中，你挣脱了那团绳索般的触手，向后划水远离女孩，直到你的[feet]再次令人安心地触及湖底的浅滩，并且你离水面足够高，可以进行战斗。[pg]");
            }
         }
         else
         {
            ...
            {
               outputText("当你解开小船并起航时，你听到船中部传来轻柔的冒泡声。你环顾四周，只看到几根绿色的触手滑过船舷，突然向下拉，使小船倾斜，把你抛出船外，落入一个咧嘴笑的海葵的怀抱！她游在你身边，当你挣扎着游回岸边时，她给了你几次顽皮的爱抚，你已经因为有毒的接触而感到头晕目眩和性唤起了。[pg]");
            }
         }
      ...
      public function minoCumForAnemonieeeeez() : void
      {
         ...
         spriteSelect(SpriteDb.get_s_anemone());
         outputText("最初的惊讶消退为头脑发昏和轻微的性唤起，因为她触手上的刺细胞找到了暴露的肉体。在溺水的恐慌中，你挣脱了那团绳索状的物体，向后划水远离女孩，直到你的[feet]令人安心地触碰到湖底的浅滩。当你摇摇头以清除阴霾时，你注意到你的一些物品从你的袋子里掉了出来，漂浮在水面上。海葵特别捡起了一个正在检查；一瓶牛头人精液。当液体来回晃动时，她的眼睛亮了起来，她恳求地看着你，把它抱在脸颊旁。[say: 给我？]她问道，试图让自己看起来尽可能甜美。[pg]");
