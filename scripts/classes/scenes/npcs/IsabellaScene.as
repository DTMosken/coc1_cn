package classes.scenes.npcs
{
   ...
   public class IsabellaScene extends NPCAwareContent implements TimeAwareInterface
   {
      ...
      public function victoryAgainstIzzzzzySixtyNine() : void
      {
         ...
         {
            outputText("就在你沉浸在胜利的喜悦中时，伊莎贝拉高潮时发出的嗡嗡的愉悦尖叫声穿过她的嘴唇和舌头，顺着你的肉棒蔓延。这种效果是深刻而直接的，就在伊莎贝拉失去对她口腔飞机杯控制的同时，高潮席卷了你的" + get_player().cockDescript(_loc1_) + "。它颤抖并跳动了一秒钟，随后第一股精液从顶端喷出，溅在伊莎贝拉薄薄的白色衬衫上。下一股没有飞那么远，落在了她的领口上。之后，你将几股精液倾泻在她的脸上。");
            if(get_player().cumQ() > 250)
            {
      ...
      public function talkWithIsabella() : void
      {
         ...
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,262) == 1)
         {
            ...
            outputText("她紧张地清了清嗓子，然后开始说道：[say: " + (isabellaAccent() ? "唔在唔的家乡曾是一名冒险者。唔费在荒野中漫游，除了唔的盾牌、唔的技能和唔的智慧，唔什么都没有。那真是太棒了。在做佣兵和探索地牢期间，唔积累了一小笔财富，但有一天唔渗入得太远了。内里有一个闪烁的粉色传送门，唔满脑子想着发财，就介么走了进去" : "我在我的家乡曾是一名冒险者。我会在荒野中漫游，除了我的盾牌、我的技能和我的智慧，我什么都没有。那真是太棒了。在做佣兵和探索地牢期间，我积累了一小笔财富，但有一天我深入得太远了。那里有一个闪烁的粉色传送门，满脑子想着发财的我，就这么走了进去") + "。][pg]");
            outputText("伊莎贝拉看着你，眼眶里盈满了泪水。[say: 那个传送门" + (isabellaAccent() ? "呜让唔回去。唔被困在了这里，远离了唔的朋友和家人，只有一群性变态作伴。谢天谢地，他们大多数人都对付不了唔的" : "不让我回去。我被困在了这里，远离了我的朋友和家人，只有一群性变态作伴。谢天谢地，他们大多数人都对付不了我的") + "盾牌。][pg]");
            outputText("你好奇地看着她，问她是不是一直都是这副……牛的模样。她得意地笑了笑，回答道：[say: 我想我" + (isabellaAccent() ? "系自作自受。不过，唔并不总是你看到的这个样子。唔打败的一些敌人掉落了一些药水。而且……那些牛的药水真是太好喝了。唔忍不住。唔甚至把几种不同的药水混合在一起，想看看会发生什么。它让唔的" : "是自作自受。不过，我并不总是你看到的这个样子。我打败的一些敌人掉落了一些药水。而且……那些牛的药水真是太好喝了。我忍不住。我甚至把几种不同的药水混合在一起，想看看会发生什么。它让我的") + "奶-奶水变得又奇怪又甜。][pg]");
