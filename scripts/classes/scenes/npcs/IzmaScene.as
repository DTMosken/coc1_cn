package classes.scenes.npcs
{
   ...
   public class IzmaScene extends NPCAwareContent implements Encounter, SelfDebug, SelfSaving, TimeAwareInterface
   {
      ...
      public function nonFightIzmaSmexASS() : void
      {
         ...
         outputText("伊兹玛叹了口气，把一只手放到你的肩上。[say: 抱歉……我刚才说得太冲了。听着，这……除非我们有一个人在上面，不然这事真做不成。要不……我也不知道……你去灌点男魅魔药剂或者魅魔乳再回来。或者来挑战我。]你点点头，重新穿好衣服，决定先行离开。[pg]");
      ...
      {
         clearOutput();
         outputText("[say: 哦，你可以问我要不要喂那个蓝色黏液女孩，[name]，]伊兹玛说着，尾巴来回甩动。");
         menu();
      ...
      public function izmaKidsPlaytime() : void
      {
         ...
         else if(_loc3_ == 19)
         {
            ...
            outputText("[pg]你立刻就看出了问题所在，你女儿从你的收藏中“借走”的玩具是你的纯天然名器！你凭经验知道这东西有自己的意识，需要持续供应液体才能保持“存活”，而它目前正试图从你女儿那尺寸可观的勃起物中吸取液体。[say:她跑来找我帮忙时，我试着把它撬下来，但这东西纹丝不动，我也不想弄伤她，]她担忧地看了你女儿一眼说道。[say:既然是你的东西，我就来看看你有没有什么办法能把它弄下来。]事实上，确实有办法，这是你在保养和使用它时学到的。");
            if(get_player().cor > 50)
            {
      ...
      public function izmaKidsLolidom() : void
      {
         ...
         outputText("[pg]伊兹玛在一旁看着，看到女儿展现出阿尔法的一面，她兴奋不已。当然，从她" + (FlagDict_Impl_.arrayReadInt(KFLAGS.flags,439) == 0 ? "坚挺的勃起" : "绯红的脸颊") + "来看，其中也夹杂着相当程度的性唤起。你女儿口中发出的每一声呻吟都会让伊兹玛" + (FlagDict_Impl_.arrayReadInt(KFLAGS.flags,439) == 0 ? "的肉棒明显地跳动，使她" : "") + "焦躁不安地在原地挪动。" + (totalIzmaChildren() == 1 ? "" : "你的其他女儿" + (totalIzmaChildren() > 2 ? "们似乎" : "似乎") + "也有同感，渴望成为跨坐在入侵者身上的那个人。") + "地精尽其所能地前后摇晃，试图挣脱，但这种努力只会让她的嘴更用力地摩擦你女儿的小穴。");
      ...
      public function izmaDomsLatexyPartI() : void
      {
         ...
         outputText("[pg][say: 哦，真的吗？]伊兹玛调笑道，[say: 我早该知道的。]虎鲨女孩皱了皱鼻子，继续说道：[say: 你身上的贝塔味儿简直都能闻出来。我敢打赌，你以前还是个黏液女孩的时候，肯定幻想过自己被困在瓶子里，供扶他和男人随便操，对吧？]伊兹玛用脚趾拨了拨你那黏液荡妇鼓胀的黑色");
         ...
         outputText("[pg][latexyname]伸出双手摸向那滑溜、被鞘膜包裹的四颗睾丸，一边努力榨取它，一边含着那撑开喉咙的鼓胀发出低哼，轻柔地轮流挤压每一座精液工厂。伊兹玛将一条腿勾到[latexyname]肩上，开始粗暴地操弄这位黑玉般的美人。她以粗野的抽插将自己的肉棒一路顶到底，把整整[if (metric) {三十八厘米|十五英寸}]全都捣进黏液女孩的深处；唯一的声音，只有被半堵住的愉悦哼声，以及伊兹玛的胯部顶到伴侣贪婪嘴唇上时发出的炽热水声。");
      ...
      public function izmaDomsLatexy() : void
      {
         if(FlagDict_Impl_.arrayReadInt(KFLAGS.flags,785) == 0)
         {
            outputText("[pg]营地边缘传来熟悉而淫荡的喘息声，你有些不情愿地走过去查看。沉重的喘息中夹杂着几声愉悦的呻吟，一声比一声尖细；等你绕过一块岩石，映入眼帘的是赤裸的伊兹玛，她手里攥着一根绳子，而绳子正套在[latexyname]身上。那个黏液女孩一只手插进自己湿滑的小穴里，正忙着为鲨鱼女孩的取乐而拳交自己。");
            menu();
         ...
         else
         {
            ...
            outputText("[pg]你加快脚步，急着跟上去看这场好戏；等你绕过岩石时，已经看见伊兹玛用绳索套住了黏液女孩的脖子，把她牵得服服帖帖。");
      ...
      public function IzmaBadEnd() : void
      {
         ...
         outputText("你幸福地叹了口气，依偎在沙滩上的伊兹玛身边，一点也不想离开你的首领。伊兹玛抚摸着你的手，但她似乎更在意自己手里那袋宝石。[say: 哼，今天清理那座牛头怪洞穴可真是大有收获。啊，我能买好多好多书了，]她说道，一想到这事就咧嘴笑了起来。[say: 也许我该弄块房产？我是说，我已经有点厌倦住在湖边那个小营地了……或许惠特尼那儿有空房子？自从我们帮她把辣椒地里的那些史莱姆清掉之后，她可一直欠着我们人情呢，]她补充道，站直身子，沿着海滩走去。[pg]");
