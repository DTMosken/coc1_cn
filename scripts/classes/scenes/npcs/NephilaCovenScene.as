package classes.scenes.npcs
{
   ...
   public class NephilaCovenScene extends NPCAwareContent
   {
      ...
      public function winRapeChoices() : void
      {
         ...
         {
            outputText("你的女儿精疲力竭地倒在竞技场中央，粘液从她众多的伤口中滴落。其他史莱姆娘向空中抛洒花瓣，庆祝你的胜利，主母对你微笑着。如果你愿意，你可以利用被击败的络新妇为她的姐妹们表演一场秀。[pg]");
         }
         ...
         {
            outputText("你的女儿倒在地上，伸手去摸她那流着淫液的小穴，用她粗壮的背部触手自慰，而其他史莱姆娘则向空中抛洒花瓣，并对她发出嘘声。在圆形剧场中央的看台上，主母微笑着俯视着你。如果你愿意，你可以利用被击败的络新妇为她的姐妹们表演一场秀。[pg]");
         }
         menu();
      ...
      public function nephilaCovenUnbirth() : void
      {
         ...
         if(get_player().statusEffectv1(StatusEffects.ParasiteNephila) <= 19)
         {
            ...
            outputText("身体也明显变得更加丰腴了。你感觉如此饱足，以至于你觉得你的饥饿感好几天都不会再回来了。那个史莱姆娘体内的某种东西产生了神奇的效果，让你膨胀起来，并大大增强了你作为体内络新妇触手宿主的适应性。[pg]");
            menu();
      ...
      public function nephilaCovenRapesYou() : void
      {
         ...
         outputText("史莱姆娘向前压来，柔软的身体贴着你，一只手依依不舍地抚摸着你巨大的肚子");
         ...
         outputText("天空被你肚子的阴影遮蔽，女孩舔舐着你甜美的花蜜。你那被体液润滑的阴唇一直张开着，但在她的服侍下，它们张得更大了。你呻吟着，体内的触手向外涌出，抓住了史莱姆娘的头。令人惊讶的是，它们似乎只想在她将你推向情欲的狂热巅峰时抚摸她。驱使你孩子们的饥饿感似乎对舔舐你等待着的双唇的黏液毫无兴趣。[pg]");
      ...
      {
         clearOutput();
         outputText("一个白色的、看起来像天使一样的史莱姆娘再次出现。她打量着你。[say:你看起来更强了，母亲大人，]她说。[say:向我证明你已经准备好了！][pg]");
      ...
      public function nephilaCovenCunnilingus() : void
      {
         ...
         {
            outputText("你向欢呼的人群挥手，然后大摇大摆地走向被击败的史莱姆娘。她");
         }
         if(get_monster().get_HP() < 1)
         {
            outputText("被打败，俯卧");
         ...
         outputText("你向下瘫倒，将史莱姆娘那不成形的脸埋在你的臀瓣之间，并在她身上摩擦，让她窒息。[pg]");
         ...
         outputText("上下起伏，同时你骑着你粗壮的触手宝宝们，任由它们蹂躏史莱姆娘的脸。[pg]");
