package classes.scenes.quests.urtaQuest
{
   ...
   public class MinotaurLord extends Monster
   {
      ...
      public function MinotaurLord()
      {
         ...
         {
            set_long("在你面前的是你见过的最大的牛头人。这个毛茸茸的怪物足有十一英尺高，肌肉厚实到即使隔着厚厚的毛发也清晰可见。一个带有标签的皮项圈表明了他作为“宠物”的身份，尽管这在力大无穷的牛头人身上显得格格不入。他的双腿和双臂就像粗壮的树干，令人敬畏且不可阻挡，每一次动作都凶猛地弯曲着。这只能是一个牛头人领主，一个在力量和男子气概上远超他那些低级同类的牛头人。在他的手中，挥舞着一条巨大的链条，连接在他的项圈上，但现在被用作临时武器。一块简单的遮羞布围在他的腹股沟上，但这几乎无法掩盖那巨大、勃起的长度，把它撑得像个帐篷。它看起来更像是一个简单的布制避孕套，而不是任何种类的衣服，长长的、散发着麝香的先列腺液像丝带一样滴落在地上。在下面，沉重的睾丸，每一个都轻易有篮球那么大，在一个紧绷的、晃荡的阴囊里摇摆。你几乎能闻到他为你准备的液体恩赐，他散发出的麝香让你觉得这是个好主意……");
         }
         else
         {
            set_long("在你面前的是你见过的最大的牛头人。这个毛茸茸的怪物足有十一英尺高，肌肉厚实到即使隔着厚厚的毛发也清晰可见。他的双腿和双臂就像粗壮的树干，令人敬畏且不可阻挡，每一次动作都凶猛地弯曲着。这只能是一个牛头人领主，一个在力量和男子气概上远超他那些低级同类的牛头人。在他的手中，挥舞着一条巨大的链条，连接在他的项圈上，但现在被用作临时武器。一块简单的遮羞布围在他的腹股沟上，但这几乎无法掩盖那巨大、勃起的长度，把它撑得像个帐篷。它看起来更像是一个简单的布制避孕套，而不是任何种类的衣服，长长的、散发着麝香的先列腺液像丝带一样滴落在地上。在下面，沉重的睾丸，每一个都轻易有篮球那么大，在一个紧绷的、晃荡的阴囊里摇摆。你几乎能闻到他为你准备的液体恩赐，他散发出的麝香让你觉得这是个好主意……");
         }
         set_race("Minotaur");
