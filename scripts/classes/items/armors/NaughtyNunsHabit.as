package classes.items.armors
{
   ...
   public class NaughtyNunsHabit extends Armor
   {
      ...
      {
         clearOutput();
         outputText("感到压抑，你给自己找了一个舒适的地方[if (corruption < 40) {，避开视线，希望你不会被偶然发现|在显眼的地方，希望有人看着你}]。你掀起修女服的下摆，把它滑到肚子上，这样你的[cock]就暴露出来了。你开始慢慢地抚摸你的肉棒，你的握力松散，你的步伐慵懒。你的拇指滑过顶端，挑逗着你的马眼，你的长度因性唤起而膨胀。一旦先列腺液开始在顶端形成珠子，你就稍微用力地握住自己，停止抚摸，开始说话。");
      ...
      public function naughtyNunCrossAnalMasturbation() : void
      {
         ...
         outputText("[pg]你把十字架对准你的[asshole]，用缓慢但持续的压力把光滑的蘑菇状头部推入体内。当你颤抖和呻吟时，你感觉到头部撑开了你，当你用十字架的顶部作为把手把它推入体内时，静脉状的轴在你的内壁上拖拽。你反射性地紧紧抓住这个肛门入侵者，在它周围弯曲，因为你感觉到钝头刺入你体内更深处。[if (hasCock) {当假阳具在你的屁股里触底时，你感觉到前列腺受到温和的压力，这让你的身体因性唤起而嗡嗡作响。}]");
         outputText("[pg]你把假阳具拔出到顶端，你的通道试图饥渴地抓住粗壮的轴并阻止它的撤退，然后伴随着气喘吁吁的呜咽把它推回去。你很快建立起一种节奏，让你在重新进入时向后摇晃进入十字架肉棒，把它深深地埋在你的屁股里，迫使钝头捣入你的[if (hasCock) {前列腺|敏感的通道壁}]。当你的性唤起迅速积聚时，你高兴地呻吟着，当你的高潮最终到来时，你全身都在颤抖。当你被快感淹没时，你的通道在假阳具周围收缩和抽搐[if (hasCock) {，你沾满先列腺液的[cock]喷出精液，以相当大的力量击中地面[if (hasballs) {，你的蛋蛋紧绷，被拉起贴着你的身体，翻滚着热量}]|[if (hasballs) {，你的[balls]紧绷并颤抖，被拉起贴着你的身体，翻滚着热量}]}]。[if (hasVagina) {你被忽视的[pussy]彻底湿透了，让你的[legs]变得湿滑}]。");
