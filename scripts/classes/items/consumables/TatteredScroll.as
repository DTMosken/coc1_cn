      ...
      override public function useItem() : Boolean
      {
         ...
         if(get_player().hair.color == "sandy blonde")
         {
            ...
            if(get_player().biggestLactation() > 0)
            {
               ...
               {
                  outputText("你跪倒在地，抓住自己的乳头。伴随着一声极具性暗示的呻吟，你开始给自己挤奶，喷出大量的乳汁。你喘息着，咕哝着，尽可能多地奉献你的乳汁。它像小溪一样顺着山坡流下，你忍不住因为自豪……和欲望而脸红。当你尽最大努力用所有的乳汁喂养大地时，色情的快感不断累积。你在高潮的边缘徘徊了仿佛一个世纪，到处都是乳汁。当你回过神来时，你意识到自己正跪在那里，拉扯着干瘪的乳头。你尴尬地停了下来，但你的兴奋依然存在。");
               }
               if(get_player().biggestLactation() < 3)
               {
